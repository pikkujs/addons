...
const ROUTES: Record<string, { path: string[], query: string[], headers: string[], errors?: Record<number, string> }> = {
  ...
  "POST /v2/boardColumnCreate": {
    "path": [],
    "query": [],
    "headers": []
  },
  "POST /v2/boardColumnGetAll": {
    "path": [],
    "query": [],
    "headers": []
  },
  "POST /v2/boardGroupCreate": {
    "path": [],
    "query": [],
    "headers": []
  },
  "POST /v2/boardGroupDelete": {
    "path": [],
    "query": [],
    "headers": []
  },
  "POST /v2/boardGroupGetAll": {
    "path": [],
    "query": [],
    "headers": []
  },
  "POST /v2/boardItemAddUpdate": {
    "path": [],
    "query": [],
    "headers": []
  },
  "POST /v2/boardItemChangeColumnValue": {
    "path": [],
    "query": [],
    "headers": []
  },
  "POST /v2/boardItemChangeMultipleColumnValues": {
    "path": [],
    "query": [],
    "headers": []
  },
  "POST /v2/boardItemCreate": {
    "path": [],
    "query": [],
    "headers": []
  },
  "POST /v2/boardItemDelete": {
    "path": [],
    "query": [],
    "headers": []
  },
  "POST /v2/boardItemGet": {
    "path": [],
    "query": [],
    "headers": []
  },
  "POST /v2/boardItemGetByColumnValue": {
    "path": [],
    "query": [],
    "headers": []
  },
  "POST /v2/boardItemGetAll": {
    "path": [],
    "query": [],
    "headers": []
  },
  "POST /v2/boardItemMove": {
    "path": [],
    "query": [],
    "headers": []
  }
...
export class MondayComService {
  private baseUrl: string

  constructor(private creds: { apiKey: string }, variables: TypedVariablesService) {
    this.baseUrl = variables.get('MONDAY_COM_BASE_URL') as string
  }
  ...
  async call<T>(
    ...
    if (!response.ok) {
      ...
      switch (response.status) {
        ...
        default: throw new Error(`Monday.com API error (${response.status}): ${errorText}`)
      }
    }
