...
const ROUTES: Record<string, { path: string[], query: string[], headers: string[], errors?: Record<number, string> }> = {
  ...
  "GET /boards/{boardId}/lists/{listId}/cards/{cardId}": {
    "path": [
      "boardId",
      "listId",
      "cardId"
  ...
  "GET /boards/{boardId}/cards/{cardId}/comments/{commentId}": {
    "path": [
      "boardId",
      "cardId",
      "commentId"
  ...
  "GET /boards/{boardId}/cards/{cardId}/checklists": {
    "path": [
      "boardId",
      "cardId"
    ],
  ...
  "GET /boards/{boardId}/cards/{cardId}/checklists/{checklistId}": {
    "path": [
      "boardId",
      "cardId",
      "checklistId"
  ...
  "GET /boards/{boardId}/cards/{cardId}/checklists/{checklistId}/items/{itemId}": {
    "path": [
      "boardId",
      "cardId",
      "checklistId",
  ...
  "PUT /boards/{boardId}/cards/{cardId}/checklists/{checklistId}/items/{itemId}": {
    "path": [
      "boardId",
      "cardId",
      "checklistId",
...
export class WekanService {
  ...
  constructor(private creds: { apiKey: string }, variables: TypedVariablesService) {
    this.baseUrl = variables.get('WEKAN_BASE_URL') as string
  }
  ...
  async call<T>(
    ...
    if (!response.ok) {
      ...
      switch (response.status) {
        ...
        default: throw new Error(`Wekan API error (${response.status}): ${errorText}`)
      }
    }
