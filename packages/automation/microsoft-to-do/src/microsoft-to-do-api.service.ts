...
export const MICROSOFT_TO_DO_OAUTH2_CONFIG = {
  tokenSecretId: 'MICROSOFT_TO_DO_TOKENS',
...
const ROUTES: Record<string, { path: string[], query: string[], headers: string[], errors?: Record<number, string> }> = {
  ...
  "GET /todo/lists/{taskListId}/tasks": {
    "path": [
      "taskListId"
    ],
    "query": [
  ...
  "POST /todo/lists/{taskListId}/tasks": {
    "path": [
      "taskListId"
    ],
    "query": [],
  ...
  "GET /todo/lists/{taskListId}/tasks/{taskId}": {
    "path": [
      "taskListId",
      "taskId"
    ],
  ...
  "PATCH /todo/lists/{taskListId}/tasks/{taskId}": {
    "path": [
      "taskListId",
      "taskId"
    ],
  ...
  "DELETE /todo/lists/{taskListId}/tasks/{taskId}": {
    "path": [
      "taskListId",
      "taskId"
    ],
  ...
  "GET /todo/lists/{taskListId}/tasks/{taskId}/linkedResources": {
    "path": [
      "taskListId",
      "taskId"
    ],
  ...
  "POST /todo/lists/{taskListId}/tasks/{taskId}/linkedResources": {
    "path": [
      "taskListId",
      "taskId"
    ],
  ...
  "GET /todo/lists/{taskListId}/tasks/{taskId}/linkedResources/{linkedResourceId}": {
    "path": [
      "taskListId",
      "taskId",
      "linkedResourceId"
  ...
  "PATCH /todo/lists/{taskListId}/tasks/{taskId}/linkedResources/{linkedResourceId}": {
    "path": [
      "taskListId",
      "taskId",
      "linkedResourceId"
  ...
  "DELETE /todo/lists/{taskListId}/tasks/{taskId}/linkedResources/{linkedResourceId}": {
    "path": [
      "taskListId",
      "taskId",
      "linkedResourceId"
...
export class MicrosoftToDoService {
  ...
  constructor(secrets: TypedSecretService, variables: TypedVariablesService) {
    this.baseUrl = variables.get('MICROSOFT_TO_DO_BASE_URL') as string
    this.oauth = new OAuth2Client(
      MICROSOFT_TO_DO_OAUTH2_CONFIG,
      'MICROSOFT_TO_DO_APP_CREDENTIALS',
      secrets
    )
  }
  ...
  async call<T>(
    ...
    if (!response.ok) {
      ...
      switch (response.status) {
        ...
        default: throw new Error(`Microsoft To Do API error (${response.status}): ${errorText}`)
      }
    }
