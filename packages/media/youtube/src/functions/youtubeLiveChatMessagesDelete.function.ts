...
export const YoutubeLiveChatMessagesDeleteInput = z.object({
...
export const youtubeLiveChatMessagesDelete = pikkuSessionlessFunc({
  description: "Deletes a chat message.",
  input: YoutubeLiveChatMessagesDeleteInput,
  func: async ({ youtube }, data) => {
    return youtube.call("DELETE", "/youtube/v3/liveChat/messages", data)
  },
})
