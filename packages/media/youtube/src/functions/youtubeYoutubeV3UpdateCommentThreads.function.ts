...
export const YoutubeYoutubeV3UpdateCommentThreadsInput = z.object({
  ...
  part: z.array(z.string()).optional().describe("The *part* parameter specifies a comma-separated list of commentThread resource properties that the API response will include. You must at least include the snippet part in the parameter value since that part contains all of the properties that the API request can update."),
...
export const YoutubeYoutubeV3UpdateCommentThreadsOutput = z.object({
  etag: z.string().optional().describe("Etag of this resource."),
  id: z.string().optional().describe("The ID that YouTube uses to uniquely identify the comment thread."),
  kind: z.string().optional().default("youtube#commentThread").describe("Identifies what kind of resource this is. Value: the fixed string \"youtube#commentThread\"."),
  replies: z.object({
...
export const youtubeYoutubeV3UpdateCommentThreads = pikkuSessionlessFunc({
  description: "Updates an existing resource.",
  input: YoutubeYoutubeV3UpdateCommentThreadsInput,
  output: YoutubeYoutubeV3UpdateCommentThreadsOutput,
  func: async ({ youtube }, data) => {
    return youtube.call("PUT", "/youtube/v3/commentThreads", data) as any
  },
})
