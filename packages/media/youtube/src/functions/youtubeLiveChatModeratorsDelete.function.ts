...
export const YoutubeLiveChatModeratorsDeleteInput = z.object({
...
export const youtubeLiveChatModeratorsDelete = pikkuSessionlessFunc({
  description: "Deletes a chat moderator.",
  input: YoutubeLiveChatModeratorsDeleteInput,
  func: async ({ youtube }, data) => {
    return youtube.call("DELETE", "/youtube/v3/liveChat/moderators", data)
  },
})
