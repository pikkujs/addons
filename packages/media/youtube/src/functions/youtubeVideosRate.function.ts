...
export const YoutubeVideosRateInput = z.object({
  ...
  id: z.string(),
  rating: z.enum(["none", "like", "dislike"]),
})

export const youtubeVideosRate = pikkuSessionlessFunc({
  description: "Adds a like or dislike rating to a video or removes a rating from a video.",
  input: YoutubeVideosRateInput,
  func: async ({ youtube }, data) => {
    return youtube.call("POST", "/youtube/v3/videos/rate", data)
  },
})
