...
export const YoutubeLiveChatBansDeleteInput = z.object({
...
export const youtubeLiveChatBansDelete = pikkuSessionlessFunc({
  description: "Deletes a chat ban.",
  input: YoutubeLiveChatBansDeleteInput,
  func: async ({ youtube }, data) => {
    return youtube.call("DELETE", "/youtube/v3/liveChat/bans", data)
  },
})
