...
export const YoutubeCommentThreadsListInput = z.object({
  ...
  allThreadsRelatedToChannelId: z.string().optional().describe("Returns the comment threads of all videos of the channel and the channel comments as well."),
  channelId: z.string().optional().describe("Returns the comment threads for all the channel comments (ie does not include comments left on videos)."),
  id: z.array(z.string()).optional().describe("Returns the comment threads with the given IDs for Stubby or Apiary."),
  ...
  moderationStatus: z.enum(["published", "heldForReview", "likelySpam", "rejected"]).optional().describe("Limits the returned comment threads to those with the specified moderation status. Not compatible with the 'id' filter. Valid values: published, heldForReview, likelySpam."),
  ...
  searchTerms: z.string().optional().describe("Limits the returned comment threads to those matching the specified key words. Not compatible with the 'id' filter."),
  ...
  videoId: z.string().optional().describe("Returns the comment threads of the specified video."),
})

export const YoutubeCommentThreadsListOutput = z.object({
  ...
  })).optional().describe("A list of comment threads that match the request criteria."),
  kind: z.string().optional().default("youtube#commentThreadListResponse").describe("Identifies what kind of resource this is. Value: the fixed string \"youtube#commentThreadListResponse\"."),
...
export const youtubeCommentThreadsList = pikkuSessionlessFunc({
  description: "Retrieves a list of resources, possibly filtered.",
  input: YoutubeCommentThreadsListInput,
  output: YoutubeCommentThreadsListOutput,
  func: async ({ youtube }, data) => {
    return youtube.call("GET", "/youtube/v3/commentThreads", data) as any
  },
})
