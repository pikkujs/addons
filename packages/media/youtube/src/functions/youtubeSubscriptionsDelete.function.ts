...
export const YoutubeSubscriptionsDeleteInput = z.object({
...
export const youtubeSubscriptionsDelete = pikkuSessionlessFunc({
  description: "Deletes a resource.",
  input: YoutubeSubscriptionsDeleteInput,
  func: async ({ youtube }, data) => {
    return youtube.call("DELETE", "/youtube/v3/subscriptions", data)
  },
})
