...
export const YoutubeWatermarksUnsetInput = z.object({
...
export const youtubeWatermarksUnset = pikkuSessionlessFunc({
  description: "Allows removal of channel watermark.",
  input: YoutubeWatermarksUnsetInput,
  func: async ({ youtube }, data) => {
    return youtube.call("POST", "/youtube/v3/watermarks/unset", data)
  },
})
