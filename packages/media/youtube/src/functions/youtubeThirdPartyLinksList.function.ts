...
export const YoutubeThirdPartyLinksListInput = z.object({
  ...
  linkingToken: z.string().optional().describe("Get a third party link with the given linking token."),
  type: z.enum(["linkUnspecified", "channelToStoreLink"]).optional().describe("Get a third party link of the given type."),
})

export const YoutubeThirdPartyLinksListOutput = z.object({
  ...
  kind: z.string().optional().default("youtube#thirdPartyLinkListResponse").describe("Identifies what kind of resource this is. Value: the fixed string \"youtube#thirdPartyLinkListResponse\"."),
})

export const youtubeThirdPartyLinksList = pikkuSessionlessFunc({
  description: "Retrieves a list of resources, possibly filtered.",
  input: YoutubeThirdPartyLinksListInput,
  output: YoutubeThirdPartyLinksListOutput,
  func: async ({ youtube }, data) => {
    return youtube.call("GET", "/youtube/v3/thirdPartyLinks", data) as any
  },
})
