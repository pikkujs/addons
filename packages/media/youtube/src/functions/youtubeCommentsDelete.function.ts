...
export const YoutubeCommentsDeleteInput = z.object({
...
export const youtubeCommentsDelete = pikkuSessionlessFunc({
  description: "Deletes a resource.",
  input: YoutubeCommentsDeleteInput,
  func: async ({ youtube }, data) => {
    return youtube.call("DELETE", "/youtube/v3/comments", data)
  },
})
