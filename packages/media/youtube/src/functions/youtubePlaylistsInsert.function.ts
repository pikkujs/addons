...
export const YoutubePlaylistsInsertInput = z.object({
...
export const YoutubePlaylistsInsertOutput = z.object({
  contentDetails: z.object({
    itemCount: z.number().int().optional().describe("The number of videos in the playlist."),
  }).optional().describe("The contentDetails object contains information like video count."),
  etag: z.string().optional().describe("Etag of this resource."),
...
export const youtubePlaylistsInsert = pikkuSessionlessFunc({
  description: "Inserts a new resource into this collection.",
  input: YoutubePlaylistsInsertInput,
  output: YoutubePlaylistsInsertOutput,
  func: async ({ youtube }, data) => {
    return youtube.call("POST", "/youtube/v3/playlists", data) as any
  },
})
