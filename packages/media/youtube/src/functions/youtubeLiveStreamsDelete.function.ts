...
export const YoutubeLiveStreamsDeleteInput = z.object({
...
export const youtubeLiveStreamsDelete = pikkuSessionlessFunc({
  description: "Deletes an existing stream for the authenticated user.",
  input: YoutubeLiveStreamsDeleteInput,
  func: async ({ youtube }, data) => {
    return youtube.call("DELETE", "/youtube/v3/liveStreams", data)
  },
})
