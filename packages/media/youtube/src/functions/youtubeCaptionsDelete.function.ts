...
export const YoutubeCaptionsDeleteInput = z.object({
...
export const youtubeCaptionsDelete = pikkuSessionlessFunc({
  description: "Deletes a resource.",
  input: YoutubeCaptionsDeleteInput,
  func: async ({ youtube }, data) => {
    return youtube.call("DELETE", "/youtube/v3/captions", data)
  },
})
