...
export const YoutubeLiveBroadcastsDeleteInput = z.object({
  ...
  id: z.string().describe("Broadcast to delete."),
...
export const youtubeLiveBroadcastsDelete = pikkuSessionlessFunc({
  description: "Delete a given broadcast.",
  input: YoutubeLiveBroadcastsDeleteInput,
  func: async ({ youtube }, data) => {
    return youtube.call("DELETE", "/youtube/v3/liveBroadcasts", data)
  },
})
