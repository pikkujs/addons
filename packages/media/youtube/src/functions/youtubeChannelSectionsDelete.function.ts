...
export const YoutubeChannelSectionsDeleteInput = z.object({
...
export const youtubeChannelSectionsDelete = pikkuSessionlessFunc({
  description: "Deletes a resource.",
  input: YoutubeChannelSectionsDeleteInput,
  func: async ({ youtube }, data) => {
    return youtube.call("DELETE", "/youtube/v3/channelSections", data)
  },
})
