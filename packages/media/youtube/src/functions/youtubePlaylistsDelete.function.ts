...
export const YoutubePlaylistsDeleteInput = z.object({
...
export const youtubePlaylistsDelete = pikkuSessionlessFunc({
  description: "Deletes a resource.",
  input: YoutubePlaylistsDeleteInput,
  func: async ({ youtube }, data) => {
    return youtube.call("DELETE", "/youtube/v3/playlists", data)
  },
})
