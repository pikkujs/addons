...
export const YoutubeLiveBroadcastsTransitionInput = z.object({
  ...
  broadcastStatus: z.enum(["statusUnspecified", "testing", "live", "complete"]).describe("The status to which the broadcast is going to transition."),
  id: z.string().describe("Broadcast to transition."),
...
export const YoutubeLiveBroadcastsTransitionOutput = z.object({
...
export const youtubeLiveBroadcastsTransition = pikkuSessionlessFunc({
  description: "Transition a broadcast to a given status.",
  input: YoutubeLiveBroadcastsTransitionInput,
  output: YoutubeLiveBroadcastsTransitionOutput,
  func: async ({ youtube }, data) => {
    return youtube.call("POST", "/youtube/v3/liveBroadcasts/transition", data) as any
  },
})
