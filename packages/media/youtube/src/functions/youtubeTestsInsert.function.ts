...
export const YoutubeTestsInsertInput = z.object({
...
export const YoutubeTestsInsertOutput = z.object({
  featuredPart: z.boolean().optional(),
  gaia: z.string().optional(),
  id: z.string().optional(),
  snippet: z.record(z.string(), z.unknown()).optional(),
...
export const youtubeTestsInsert = pikkuSessionlessFunc({
  description: "POST method.",
  input: YoutubeTestsInsertInput,
  output: YoutubeTestsInsertOutput,
  func: async ({ youtube }, data) => {
    return youtube.call("POST", "/youtube/v3/tests", data) as any
  },
})
