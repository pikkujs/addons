...
export const YoutubePlaylistItemsDeleteInput = z.object({
...
export const youtubePlaylistItemsDelete = pikkuSessionlessFunc({
  description: "Deletes a resource.",
  input: YoutubePlaylistItemsDeleteInput,
  func: async ({ youtube }, data) => {
    return youtube.call("DELETE", "/youtube/v3/playlistItems", data)
  },
})
