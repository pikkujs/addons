...
export const GetListUsersPlaylistsInput = z.object({
...
export const GetListUsersPlaylistsOutput = z.object({
...
export const getListUsersPlaylists = pikkuSessionlessFunc({
  description: "Get a list of the playlists owned or followed by a Spotify user.",
  input: GetListUsersPlaylistsInput,
  output: GetListUsersPlaylistsOutput,
  errors: [UnauthorizedError, ForbiddenError, TooManyRequestsError],
  func: async ({ spotify }, data) => {
    return spotify.call("GET", "/users/{user_id}/playlists", data) as any
  },
})
