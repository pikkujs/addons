...
export const GetSeveralAudioFeaturesInput = z.object({
  ids: z.string().describe("A comma-separated list of the [Spotify IDs](/documentation/web-api/#spotify-uris-and-ids)\nfor the tracks. Maximum: 100 IDs.\n"),
})

export const GetSeveralAudioFeaturesOutput = z.object({
  audio_features: z.array(z.object({
...
export const getSeveralAudioFeatures = pikkuSessionlessFunc({
  description: "Get audio features for multiple tracks based on their Spotify IDs.",
  input: GetSeveralAudioFeaturesInput,
  output: GetSeveralAudioFeaturesOutput,
  errors: [UnauthorizedError, ForbiddenError, TooManyRequestsError],
  func: async ({ spotify }, data) => {
    return spotify.call("GET", "/audio-features", data) as any
  },
})
