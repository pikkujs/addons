...
export const GetAnAudiobookInput = z.object({
...
export const GetAnAudiobookOutput = z.object({
...
export const getAnAudiobook = pikkuSessionlessFunc({
  description: "Get Spotify catalog information for a single audiobook.<br />\n**Note: Audiobooks are only available for the US, UK, Ireland, New Zealand and Australia markets.**",
  input: GetAnAudiobookInput,
  output: GetAnAudiobookOutput,
  errors: [UnauthorizedError, ForbiddenError, TooManyRequestsError],
  func: async ({ spotify }, data) => {
    return spotify.call("GET", "/audiobooks/{id}", data) as any
  },
})
