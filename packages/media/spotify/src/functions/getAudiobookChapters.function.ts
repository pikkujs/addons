...
export const GetAudiobookChaptersInput = z.object({
...
export const GetAudiobookChaptersOutput = z.object({
...
export const getAudiobookChapters = pikkuSessionlessFunc({
  description: "Get Spotify catalog information about an audiobook's chapters.<br />\n**Note: Audiobooks are only available for the US, UK, Ireland, New Zealand and Australia markets.**",
  input: GetAudiobookChaptersInput,
  output: GetAudiobookChaptersOutput,
  errors: [UnauthorizedError, ForbiddenError, TooManyRequestsError],
  func: async ({ spotify }, data) => {
    return spotify.call("GET", "/audiobooks/{id}/chapters", data) as any
  },
})
