...
export const GetSeveralTracksInput = z.object({
...
export const GetSeveralTracksOutput = z.object({
...
export const getSeveralTracks = pikkuSessionlessFunc({
  description: "Get Spotify catalog information for multiple tracks based on their Spotify IDs.",
  input: GetSeveralTracksInput,
  output: GetSeveralTracksOutput,
  errors: [UnauthorizedError, ForbiddenError, TooManyRequestsError],
  func: async ({ spotify }, data) => {
    return spotify.call("GET", "/tracks", data) as any
  },
})
