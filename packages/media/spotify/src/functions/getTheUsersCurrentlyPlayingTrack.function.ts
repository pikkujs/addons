...
export const GetTheUsersCurrentlyPlayingTrackInput = z.object({
...
export const GetTheUsersCurrentlyPlayingTrackOutput = z.object({
  context: z.object({
...
export const getTheUsersCurrentlyPlayingTrack = pikkuSessionlessFunc({
  description: "Get the object currently being played on the user's Spotify account.",
  input: GetTheUsersCurrentlyPlayingTrackInput,
  output: GetTheUsersCurrentlyPlayingTrackOutput,
  errors: [UnauthorizedError, ForbiddenError, TooManyRequestsError],
  func: async ({ spotify }, data) => {
    return spotify.call("GET", "/me/player/currently-playing", data) as any
  },
})
