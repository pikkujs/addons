...
export const GetAChapterInput = z.object({
...
export const GetAChapterOutput = z.object({
...
export const getAChapter = pikkuSessionlessFunc({
  description: "Get Spotify catalog information for a single chapter.<br />\n**Note: Chapters are only available for the US, UK, Ireland, New Zealand and Australia markets.**",
  input: GetAChapterInput,
  output: GetAChapterOutput,
  errors: [UnauthorizedError, ForbiddenError, TooManyRequestsError],
  func: async ({ spotify }, data) => {
    return spotify.call("GET", "/chapters/{id}", data) as any
  },
})
