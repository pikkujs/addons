...
export const GetMultipleArtistsInput = z.object({
  ids: z.string().describe("A comma-separated list of the [Spotify IDs](/documentation/web-api/#spotify-uris-and-ids) for the artists. Maximum: 50 IDs.\n"),
})

export const GetMultipleArtistsOutput = z.object({
...
export const getMultipleArtists = pikkuSessionlessFunc({
  description: "Get Spotify catalog information for several artists based on their Spotify IDs.",
  input: GetMultipleArtistsInput,
  output: GetMultipleArtistsOutput,
  errors: [UnauthorizedError, ForbiddenError, TooManyRequestsError],
  func: async ({ spotify }, data) => {
    return spotify.call("GET", "/artists", data) as any
  },
})
