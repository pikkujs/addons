...
export const GetMultipleAlbumsInput = z.object({
...
export const GetMultipleAlbumsOutput = z.object({
...
export const getMultipleAlbums = pikkuSessionlessFunc({
  description: "Get Spotify catalog information for multiple albums identified by their Spotify IDs.",
  input: GetMultipleAlbumsInput,
  output: GetMultipleAlbumsOutput,
  errors: [UnauthorizedError, ForbiddenError, TooManyRequestsError],
  func: async ({ spotify }, data) => {
    return spotify.call("GET", "/albums", data) as any
  },
})
