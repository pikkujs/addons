...
export const GetUsersTopTracksInput = z.object({
...
export const GetUsersTopTracksOutput = z.object({
...
export const getUsersTopTracks = pikkuSessionlessFunc({
  description: "Get the current user's top tracks based on calculated affinity.",
  input: GetUsersTopTracksInput,
  output: GetUsersTopTracksOutput,
  errors: [UnauthorizedError, ForbiddenError, TooManyRequestsError],
  func: async ({ spotify }, data) => {
    return spotify.call("GET", "/me/top/tracks", data) as any
  },
})
