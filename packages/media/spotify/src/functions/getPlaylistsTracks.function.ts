...
export const GetPlaylistsTracksInput = z.object({
  ...
  limit: z.number().int().min(1).max(100).optional().default(20).describe("The maximum number of items to return. Default: 20. Minimum: 1. Maximum: 100.\n"),
...
export const GetPlaylistsTracksOutput = z.object({
  ...
  items: z.array(z.object({
    added_at: z.string().datetime().optional().describe("The date and time the track or episode was added. _**Note**: some very old playlists may return `null` in this field._\n"),
    added_by: z.object({
    ...
    }).optional().describe("The Spotify user who added the track or episode. _**Note**: some very old playlists may return `null` in this field._\n"),
    is_local: z.boolean().optional().describe("Whether this track or episode is a [local file](https://developer.spotify.com/web-api/local-files-spotify-playlists/) or not.\n"),
    track: z.union([z.object({
    ...
    })]).optional().describe("Information about the track or episode."),
  })),
})

export const getPlaylistsTracks = pikkuSessionlessFunc({
  description: "Get full details of the items of a playlist owned by a Spotify user.",
  input: GetPlaylistsTracksInput,
  output: GetPlaylistsTracksOutput,
  errors: [UnauthorizedError, ForbiddenError, TooManyRequestsError],
  func: async ({ spotify }, data) => {
    return spotify.call("GET", "/playlists/{playlist_id}/tracks", data) as any
  },
})
