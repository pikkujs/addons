...
export const GetNewReleasesInput = z.object({
...
export const GetNewReleasesOutput = z.object({
  albums: z.object({
...
export const getNewReleases = pikkuSessionlessFunc({
  description: "Get a list of new album releases featured in Spotify (shown, for example, on a Spotify player’s “Browse” tab).",
  input: GetNewReleasesInput,
  output: GetNewReleasesOutput,
  errors: [UnauthorizedError, ForbiddenError, TooManyRequestsError],
  func: async ({ spotify }, data) => {
    return spotify.call("GET", "/browse/new-releases", data) as any
  },
})
