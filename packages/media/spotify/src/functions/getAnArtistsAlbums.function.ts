...
export const GetAnArtistsAlbumsInput = z.object({
  id: z.string().describe("The [Spotify ID](/documentation/web-api/#spotify-uris-and-ids) of the artist.\n"),
  include_groups: z.string().optional().describe("A comma-separated list of keywords that will be used to filter the response. If not supplied, all album types will be returned. <br/>\nValid values are:<br/>- `album`<br/>- `single`<br/>- `appears_on`<br/>- `compilation`<br/>For example: `include_groups=album,single`.\n"),
...
export const GetAnArtistsAlbumsOutput = z.object({
...
export const getAnArtistsAlbums = pikkuSessionlessFunc({
  description: "Get Spotify catalog information about an artist's albums.",
  input: GetAnArtistsAlbumsInput,
  output: GetAnArtistsAlbumsOutput,
  errors: [UnauthorizedError, ForbiddenError, TooManyRequestsError],
  func: async ({ spotify }, data) => {
    return spotify.call("GET", "/artists/{id}/albums", data) as any
  },
})
