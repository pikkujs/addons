...
export const GetAnEpisodeInput = z.object({
...
export const GetAnEpisodeOutput = z.object({
...
export const getAnEpisode = pikkuSessionlessFunc({
  description: "Get Spotify catalog information for a single episode identified by its\nunique Spotify ID.",
  input: GetAnEpisodeInput,
  output: GetAnEpisodeOutput,
  errors: [UnauthorizedError, ForbiddenError, TooManyRequestsError],
  func: async ({ spotify }, data) => {
    return spotify.call("GET", "/episodes/{id}", data) as any
  },
})
