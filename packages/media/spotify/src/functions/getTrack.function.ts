...
export const GetTrackInput = z.object({
...
export const GetTrackOutput = z.object({
...
export const getTrack = pikkuSessionlessFunc({
  ...
  func: async ({ spotify }, data) => {
    return spotify.call("GET", "/tracks/{id}", data) as any
  },
})
