...
export const GetAShowInput = z.object({
...
export const GetAShowOutput = z.object({
  ...
  episodes: z.unknown().describe("The episodes of the show.\n"),
})

export const getAShow = pikkuSessionlessFunc({
  description: "Get Spotify catalog information for a single show identified by its\nunique Spotify ID.",
  input: GetAShowInput,
  output: GetAShowOutput,
  errors: [UnauthorizedError, ForbiddenError, TooManyRequestsError],
  func: async ({ spotify }, data) => {
    return spotify.call("GET", "/shows/{id}", data) as any
  },
})
