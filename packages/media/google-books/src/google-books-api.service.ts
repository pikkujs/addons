...
export const GOOGLE_BOOKS_OAUTH2_CONFIG = {
  tokenSecretId: 'GOOGLE_BOOKS_TOKENS',
...
const ROUTES: Record<string, { path: string[], query: string[], headers: string[], errors?: Record<number, string> }> = {
  "GET /v1/users/{userId}/bookshelves/{shelfId}": {
    "path": [
      "userId",
      "shelfId"
    ],
  ...
  "GET /v1/users/{userId}/bookshelves": {
    "path": [
      "userId"
    ],
    "query": [
  ...
  "POST /v1/mylibrary/bookshelves/{shelfId}/clearVolumes": {
    "path": [
      "shelfId"
    ],
    "query": [],
  ...
  "GET /v1/users/{userId}/bookshelves/{shelfId}/volumes": {
    "path": [
      "userId",
      "shelfId"
    ],
  ...
  "POST /v1/mylibrary/bookshelves/{shelfId}/moveVolume": {
    "path": [
      "shelfId"
    ],
    "query": [],
...
export class GoogleBooksService {
  ...
  constructor(secrets: TypedSecretService, variables: TypedVariablesService) {
    this.baseUrl = variables.get('GOOGLE_BOOKS_BASE_URL') as string
    this.oauth = new OAuth2Client(
      GOOGLE_BOOKS_OAUTH2_CONFIG,
      'GOOGLE_BOOKS_APP_CREDENTIALS',
      secrets
    )
  }
  ...
  async call<T>(
    ...
    if (!response.ok) {
      ...
      switch (response.status) {
        ...
        default: throw new Error(`Google Books API error (${response.status}): ${errorText}`)
      }
    }
