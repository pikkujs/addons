...
export const MachinesListInput = z.object({
  ...
  summary: z.boolean().optional().describe("Only return summary info about machines (omit config, checks, events, host_status, nonce, etc.)"),
})

export const MachinesListOutput = z.array(z.object({
...
export const machinesList = pikkuSessionlessFunc({
  ...
  input: MachinesListInput,
  output: MachinesListOutput,
  func: async ({ flyio }, data) => {
    return flyio.call('GET', '/apps/{app_name}/machines', data) as any
  },
})
