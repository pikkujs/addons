...
export const AppCertificatesShowInput = z.object({
  app_name: z.string().describe("Fly App Name"),
  hostname: z.string().describe("Certificate Hostname"),
})

export const AppCertificatesShowOutput = z.object({
...
export const appCertificatesShow = pikkuSessionlessFunc({
  input: AppCertificatesShowInput,
  output: AppCertificatesShowOutput,
  func: async ({ flyio }, data) => {
    return flyio.call('GET', '/apps/{app_name}/certificates/{hostname}', data) as any
  },
})
