...
export const MachinesUpdateInput = z.object({
...
export const MachinesUpdateOutput = z.object({
  checks: z.array(z.object({
    name: z.string().optional(),
...
export const machinesUpdate = pikkuSessionlessFunc({
  description: "Update a Machine's configuration using the details provided in the request body.",
  input: MachinesUpdateInput,
  output: MachinesUpdateOutput,
  errors: [BadRequestError],
  func: async ({ flyio }, data) => {
    return flyio.call('POST', '/apps/{app_name}/machines/{machine_id}', data) as any
  },
})
