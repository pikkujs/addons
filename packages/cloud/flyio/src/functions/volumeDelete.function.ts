...
export const VolumeDeleteInput = z.object({
  app_name: z.string().describe("Fly App Name"),
  volume_id: z.string().describe("Volume ID"),
})

export const VolumeDeleteOutput = z.object({
...
export const volumeDelete = pikkuSessionlessFunc({
  description: "Delete a specific volume within an app by volume ID.",
  input: VolumeDeleteInput,
  output: VolumeDeleteOutput,
  func: async ({ flyio }, data) => {
    return flyio.call('DELETE', '/apps/{app_name}/volumes/{volume_id}', data) as any
  },
})
