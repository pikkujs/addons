...
export const MachinesShowInput = z.object({
  app_name: z.string().describe("Fly App Name"),
  machine_id: z.string().describe("Machine ID"),
})

export const MachinesShowOutput = z.object({
...
export const machinesShow = pikkuSessionlessFunc({
  description: "Get details of a specific Machine within an app by the Machine ID.",
  input: MachinesShowInput,
  output: MachinesShowOutput,
  func: async ({ flyio }, data) => {
    return flyio.call('GET', '/apps/{app_name}/machines/{machine_id}', data) as any
  },
})
