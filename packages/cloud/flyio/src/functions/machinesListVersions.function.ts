...
export const MachinesListVersionsInput = z.object({
  app_name: z.string().describe("Fly App Name"),
  machine_id: z.string().describe("Machine ID"),
})

export const MachinesListVersionsOutput = z.array(z.object({
...
export const machinesListVersions = pikkuSessionlessFunc({
  description: "List all versions of the configuration for a specific Machine within an app.",
  input: MachinesListVersionsInput,
  output: MachinesListVersionsOutput,
  func: async ({ flyio }, data) => {
    return flyio.call('GET', '/apps/{app_name}/machines/{machine_id}/versions', data) as any
  },
})
