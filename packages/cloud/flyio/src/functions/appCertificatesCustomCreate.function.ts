...
export const AppCertificatesCustomCreateOutput = z.object({
...
export const appCertificatesCustomCreate = pikkuSessionlessFunc({
  input: AppCertificatesCustomCreateInput,
  output: AppCertificatesCustomCreateOutput,
  errors: [UnprocessableContentError],
  func: async ({ flyio }, data) => {
    return flyio.call('POST', '/apps/{app_name}/certificates/custom', data) as any
  },
})
