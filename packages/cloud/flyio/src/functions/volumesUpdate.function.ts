...
export const VolumesUpdateInput = z.object({
...
export const VolumesUpdateOutput = z.object({
...
export const volumesUpdate = pikkuSessionlessFunc({
  description: "Update a volume's configuration using the details provided in the request body.",
  input: VolumesUpdateInput,
  output: VolumesUpdateOutput,
  errors: [BadRequestError],
  func: async ({ flyio }, data) => {
    return flyio.call('PUT', '/apps/{app_name}/volumes/{volume_id}', data) as any
  },
})
