...
export const AppCertificatesAcmeDeleteInput = z.object({
  app_name: z.string().describe("Fly App Name"),
  hostname: z.string().describe("Certificate Hostname"),
})

export const AppCertificatesAcmeDeleteOutput = z.object({
...
export const appCertificatesAcmeDelete = pikkuSessionlessFunc({
  input: AppCertificatesAcmeDeleteInput,
  output: AppCertificatesAcmeDeleteOutput,
  func: async ({ flyio }, data) => {
    return flyio.call('DELETE', '/apps/{app_name}/certificates/{hostname}/acme', data) as any
  },
})
