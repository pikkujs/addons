...
export const AppCertificatesAcmeCreateInput = z.object({
  app_name: z.string().describe("Fly App Name"),
  hostname: z.string().optional(),
})

export const AppCertificatesAcmeCreateOutput = z.object({
...
export const appCertificatesAcmeCreate = pikkuSessionlessFunc({
  input: AppCertificatesAcmeCreateInput,
  output: AppCertificatesAcmeCreateOutput,
  errors: [UnprocessableContentError],
  func: async ({ flyio }, data) => {
    return flyio.call('POST', '/apps/{app_name}/certificates/acme', data) as any
  },
})
