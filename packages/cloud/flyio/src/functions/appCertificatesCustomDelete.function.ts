...
export const AppCertificatesCustomDeleteInput = z.object({
  app_name: z.string().describe("Fly App Name"),
  hostname: z.string().describe("Certificate Hostname"),
})

export const AppCertificatesCustomDeleteOutput = z.object({
...
export const appCertificatesCustomDelete = pikkuSessionlessFunc({
  input: AppCertificatesCustomDeleteInput,
  output: AppCertificatesCustomDeleteOutput,
  func: async ({ flyio }, data) => {
    return flyio.call('DELETE', '/apps/{app_name}/certificates/{hostname}/custom', data) as any
  },
})
