...
export const G_SUITE_ADMIN_OAUTH2_CONFIG = {
  tokenSecretId: 'G_SUITE_ADMIN_TOKENS',
...
const ROUTES: Record<string, { path: string[], query: string[], headers: string[], errors?: Record<number, string> }> = {
  ...
  "DELETE /directory/v1/users/{userId}": {
    "path": [
      "userId"
    ],
    "query": [],
  ...
  "POST /directory/v1/groups/{groupId}/members": {
    "path": [
      "groupId"
    ],
    "query": [],
  ...
  "DELETE /directory/v1/groups/{groupId}/members/{userId}": {
    "path": [
      "groupId",
      "userId"
    ],
  ...
  "GET /directory/v1/groups/{groupId}": {
    "path": [
      "groupId"
    ],
    "query": [],
  ...
  "PUT /directory/v1/groups/{groupId}": {
    "path": [
      "groupId"
    ],
    "query": [],
  ...
  "DELETE /directory/v1/groups/{groupId}": {
    "path": [
      "groupId"
    ],
    "query": [],
...
export class GSuiteAdminService {
  private baseUrl: string
  private oauth: OAuth2Client

  constructor(secrets: TypedSecretService, variables: TypedVariablesService) {
    this.baseUrl = variables.get('G_SUITE_ADMIN_BASE_URL') as string
    this.oauth = new OAuth2Client(
      G_SUITE_ADMIN_OAUTH2_CONFIG,
      'G_SUITE_ADMIN_APP_CREDENTIALS',
      secrets
    )
  }
  ...
  async call<T>(
    ...
    if (!response.ok) {
      ...
      switch (response.status) {
        ...
        default: throw new Error(`Google Workspace Admin API error (${response.status}): ${errorText}`)
      }
    }
