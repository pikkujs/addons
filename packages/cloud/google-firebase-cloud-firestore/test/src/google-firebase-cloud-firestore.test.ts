...
test('google-firebase-cloud-firestore addon', async () => {
  const secrets = new LocalSecretService()
  // Set up secrets for the service
  // await secrets.setSecret('GOOGLE_FIREBASE_CLOUD_FIRESTORE_CREDENTIALS', { ... })
  ...
  try {
    const { passed, failed } = await rpc.invoke('testGoogleFirebaseCloudFirestore', {})
