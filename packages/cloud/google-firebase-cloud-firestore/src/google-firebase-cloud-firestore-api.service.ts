...
export const GOOGLE_FIREBASE_CLOUD_FIRESTORE_OAUTH2_CONFIG = {
  tokenSecretId: 'GOOGLE_FIREBASE_CLOUD_FIRESTORE_TOKENS',
...
const ROUTES: Record<string, { path: string[], query: string[], headers: string[], errors?: Record<number, string> }> = {
  "POST /{projectId}/databases/{database}/documents:batchGet": {
    "path": [
      "projectId",
      "database"
    ],
  ...
  "GET /{projectId}/databases/{database}/documents/{collection}": {
    "path": [
      "projectId",
      "database",
      "collection"
  ...
  "POST /{projectId}/databases/{database}/documents/{collection}": {
    "path": [
      "projectId",
      "database",
      "collection"
  ...
  "DELETE /{projectId}/databases/{database}/documents/{collection}/{documentId}": {
    "path": [
      "projectId",
      "database",
      "collection",
  ...
  "POST /{projectId}/databases/{database}/documents:batchWrite": {
    "path": [
      "projectId",
      "database"
    ],
  ...
  "POST /{projectId}/databases/{database}/documents:runQuery": {
    "path": [
      "projectId",
      "database"
    ],
  ...
  "POST /{projectId}/databases/{database}/documents:listCollectionIds": {
    "path": [
      "projectId",
      "database"
    ],
...
export class GoogleFirebaseCloudFirestoreService {
  private baseUrl: string
  private oauth: OAuth2Client

  constructor(secrets: TypedSecretService, variables: TypedVariablesService) {
    this.baseUrl = variables.get('GOOGLE_FIREBASE_CLOUD_FIRESTORE_BASE_URL') as string
    this.oauth = new OAuth2Client(
      GOOGLE_FIREBASE_CLOUD_FIRESTORE_OAUTH2_CONFIG,
      'GOOGLE_FIREBASE_CLOUD_FIRESTORE_APP_CREDENTIALS',
      secrets
    )
  }
  ...
  async call<T>(
    ...
    if (!response.ok) {
      ...
      switch (response.status) {
        ...
        default: throw new Error(`Google Cloud Firestore API error (${response.status}): ${errorText}`)
      }
    }
