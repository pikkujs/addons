...
const ROUTES: Record<string, { path: string[], query: string[], headers: string[], errors?: Record<number, string> }> = {
  ...
  "GET /drive/items/{fileId}/content": {
    "path": [
      "fileId"
    ],
    "query": [],
  ...
  "POST /drive/items/{fileId}/createLink": {
    "path": [
      "fileId"
    ],
    "query": [],
  ...
  "PUT /drive/items/{parentId}/content": {
    "path": [
      "parentId"
    ],
    "query": [
  ...
  "PATCH /drive/folders/{folderId}/move": {
    "path": [
      "folderId"
    ],
    "query": [],
  ...
  "POST /drive/folders/{folderId}/createLink": {
    "path": [
      "folderId"
    ],
    "query": [],
...
export class MicrosoftOneDriveService {
  ...
  constructor(secrets: TypedSecretService, variables: TypedVariablesService) {
    this.baseUrl = variables.get('MICROSOFT_ONE_DRIVE_BASE_URL') as string
    this.oauth = new OAuth2Client(
      MICROSOFT_ONE_DRIVE_OAUTH2_CONFIG,
      'MICROSOFT_ONE_DRIVE_APP_CREDENTIALS',
      secrets
    )
  }
  ...
  async call<T>(
    ...
    if (!response.ok) {
      ...
      switch (response.status) {
        ...
        default: throw new Error(`Microsoft OneDrive API error (${response.status}): ${errorText}`)
      }
    }
