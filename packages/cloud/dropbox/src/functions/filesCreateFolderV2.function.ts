...
export const FilesCreateFolderV2Input = z.object({
...
export const FilesCreateFolderV2Output = z.object({
  metadata: z.object({
...
}).describe("metadata: Metadata of the created folder.\n")

export const filesCreateFolderV2 = pikkuSessionlessFunc({
  description: "Create a folder at a given path.",
  input: FilesCreateFolderV2Input,
  output: FilesCreateFolderV2Output,
  func: async ({ dropbox }, data) => {
    return dropbox.call("POST", "/files/create_folder_v2", data) as any
  },
})
