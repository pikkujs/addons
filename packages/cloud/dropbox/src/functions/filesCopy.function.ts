...
export const FilesCopyInput = z.object({
...
export const FilesCopyOutput = z.object({
...
export const filesCopy = pikkuSessionlessFunc({
  description: "Copy a file or folder to a different location in the user's Dropbox.\nIf the source path is a folder all its contents will be copied.",
  input: FilesCopyInput,
  output: FilesCopyOutput,
  func: async ({ dropbox }, data) => {
    return dropbox.call("POST", "/files/copy", data) as any
  },
})
