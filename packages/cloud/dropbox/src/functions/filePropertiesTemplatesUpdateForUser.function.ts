...
export const FilePropertiesTemplatesUpdateForUserInput = z.object({
...
export const FilePropertiesTemplatesUpdateForUserOutput = z.object({
...
export const filePropertiesTemplatesUpdateForUser = pikkuSessionlessFunc({
  ...
  input: FilePropertiesTemplatesUpdateForUserInput,
  output: FilePropertiesTemplatesUpdateForUserOutput,
  func: async ({ dropbox }, data) => {
    return dropbox.call("POST", "/file_properties/templates/update_for_user", data) as any
  },
})
