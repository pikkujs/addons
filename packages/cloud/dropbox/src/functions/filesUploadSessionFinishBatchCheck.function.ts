...
export const FilesUploadSessionFinishBatchCheckOutput = z.object({
  ".tag": z.enum(["in_progress", "complete"]).optional(),
  complete: z.object({
...
export const filesUploadSessionFinishBatchCheck = pikkuSessionlessFunc({
  ...
  input: FilesUploadSessionFinishBatchCheckInput,
  output: FilesUploadSessionFinishBatchCheckOutput,
  func: async ({ dropbox }, data) => {
    return dropbox.call("POST", "/files/upload_session/finish_batch/check", data) as any
  },
})
