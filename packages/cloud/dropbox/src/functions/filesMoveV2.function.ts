...
export const FilesMoveV2Input = z.object({
...
export const FilesMoveV2Output = z.object({
  metadata: z.object({
...
export const filesMoveV2 = pikkuSessionlessFunc({
  description: "Move a file or folder to a different location in the user's Dropbox.\nIf the source path is a folder all its contents will be moved.",
  input: FilesMoveV2Input,
  output: FilesMoveV2Output,
  func: async ({ dropbox }, data) => {
    return dropbox.call("POST", "/files/move_v2", data) as any
  },
})
