...
export const FilesGetPreviewInput = z.object({
  path: z.string().optional().describe("The path of the file to preview."),
  rev: z.string().optional().describe("Please specify revision in :field:`path` instead."),
})

export const FilesGetPreviewOutput = z.object({
...
export const filesGetPreview = pikkuSessionlessFunc({
  ...
  input: FilesGetPreviewInput,
  output: FilesGetPreviewOutput,
  func: async ({ dropbox }, data) => {
    return dropbox.call("POST", "/files/get_preview", data) as any
  },
})
