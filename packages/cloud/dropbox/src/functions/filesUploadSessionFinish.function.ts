...
export const FilesUploadSessionFinishInput = z.object({
  cursor: z.object({
...
export const FilesUploadSessionFinishOutput = z.object({
...
export const filesUploadSessionFinish = pikkuSessionlessFunc({
  ...
  input: FilesUploadSessionFinishInput,
  output: FilesUploadSessionFinishOutput,
  func: async ({ dropbox }, data) => {
    return dropbox.call("POST", "/files/upload_session/finish", data) as any
  },
})
