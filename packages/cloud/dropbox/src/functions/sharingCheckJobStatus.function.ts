...
export const SharingCheckJobStatusInput = z.object({
...
export const SharingCheckJobStatusOutput = z.object({
  failed: z.object({
    remove_folder_member_error: z.object({
    ...
    unshare_folder_error: z.object({
      access_error: z.object({
        ".tag": z.enum(["invalid_id", "not_a_member", "email_unverified", "unmounted", "other"]).optional(),
      }).optional().describe("There is an error accessing the shared folder.\ninvalid_id: This shared folder ID is invalid.\nnot_a_member: The user is not a member of the shared folder thus cannot access it.\nemail_unverified: Never set.\nunmounted: The shared folder is unmounted.\nother: None\n"),
      ".tag": z.enum(["access_error", "team_folder", "no_permission", "too_many_files", "other"]).optional(),
    }).optional().describe("access_error: None\nteam_folder: This action cannot be performed on a team shared folder.\nno_permission: The current user does not have permission to perform this action.\ntoo_many_files: This shared folder has too many files to be unshared.\nother: None\n"),
    ".tag": z.enum(["unshare_folder_error", "remove_folder_member_error", "relinquish_folder_membership_error", "other"]).optional(),
    relinquish_folder_membership_error: z.object({
      access_error: z.object({
        ".tag": z.enum(["invalid_id", "not_a_member", "email_unverified", "unmounted", "other"]).optional(),
      }).optional().describe("There is an error accessing the shared folder.\ninvalid_id: This shared folder ID is invalid.\nnot_a_member: The user is not a member of the shared folder thus cannot access it.\nemail_unverified: Never set.\nunmounted: The shared folder is unmounted.\nother: None\n"),
      ".tag": z.enum(["access_error", "folder_owner", "mounted", "group_access", "team_folder", "no_permission", "no_explicit_access", "other"]).optional(),
...
export const sharingCheckJobStatus = pikkuSessionlessFunc({
  description: "Returns the status of an asynchronous job.\nApps must have full Dropbox access to use this endpoint.",
  input: SharingCheckJobStatusInput,
  output: SharingCheckJobStatusOutput,
  func: async ({ dropbox }, data) => {
    return dropbox.call("POST", "/sharing/check_job_status", data) as any
  },
})
