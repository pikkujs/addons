...
export const SharingListMountableFoldersContinueInput = z.object({
  cursor: z.string().optional().describe("The cursor returned by the previous API call specified in the endpoint description."),
})

export const SharingListMountableFoldersContinueOutput = z.object({
...
export const sharingListMountableFoldersContinue = pikkuSessionlessFunc({
  ...
  input: SharingListMountableFoldersContinueInput,
  output: SharingListMountableFoldersContinueOutput,
  func: async ({ dropbox }, data) => {
    return dropbox.call("POST", "/sharing/list_mountable_folders/continue", data) as any
  },
})
