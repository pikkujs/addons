...
export const SharingListFileMembersContinueOutput = z.object({
...
export const sharingListFileMembersContinue = pikkuSessionlessFunc({
  ...
  input: SharingListFileMembersContinueInput,
  output: SharingListFileMembersContinueOutput,
  func: async ({ dropbox }, data) => {
    return dropbox.call("POST", "/sharing/list_file_members/continue", data) as any
  },
})
