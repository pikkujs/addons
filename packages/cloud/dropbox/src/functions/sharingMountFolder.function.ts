...
export const SharingMountFolderInput = z.object({
  shared_folder_id: z.string().optional().describe("The ID of the shared folder to mount."),
})

export const SharingMountFolderOutput = z.object({
  owner_team: z.object({
...
export const sharingMountFolder = pikkuSessionlessFunc({
  ...
  input: SharingMountFolderInput,
  output: SharingMountFolderOutput,
  func: async ({ dropbox }, data) => {
    return dropbox.call("POST", "/sharing/mount_folder", data) as any
  },
})
