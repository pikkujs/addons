...
export const SharingGetFolderMetadataInput = z.object({
...
export const SharingGetFolderMetadataOutput = z.object({
  owner_team: z.object({
...
export const sharingGetFolderMetadata = pikkuSessionlessFunc({
  description: "Returns shared folder metadata by its folder ID.\nApps must have full Dropbox access to use this endpoint.",
  input: SharingGetFolderMetadataInput,
  output: SharingGetFolderMetadataOutput,
  func: async ({ dropbox }, data) => {
    return dropbox.call("POST", "/sharing/get_folder_metadata", data) as any
  },
})
