...
export const SharingListFolderMembersContinueInput = z.object({
  cursor: z.string().optional().describe("The cursor returned by your last call to :route:`list_folder_members` or :route:`list_folder_members/continue`."),
})

export const SharingListFolderMembersContinueOutput = z.object({
...
export const sharingListFolderMembersContinue = pikkuSessionlessFunc({
  ...
  input: SharingListFolderMembersContinueInput,
  output: SharingListFolderMembersContinueOutput,
  func: async ({ dropbox }, data) => {
    return dropbox.call("POST", "/sharing/list_folder_members/continue", data) as any
  },
})
