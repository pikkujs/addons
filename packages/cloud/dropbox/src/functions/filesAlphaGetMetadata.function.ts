...
export const FilesAlphaGetMetadataInput = z.object({
  ...
  include_property_templates: z.array(z.string()).optional().describe("If set to a valid list of template IDs, :field:`FileMetadata.property_groups` is set for files with custom properties."),
...
export const FilesAlphaGetMetadataOutput = z.object({
...
export const filesAlphaGetMetadata = pikkuSessionlessFunc({
  ...
  input: FilesAlphaGetMetadataInput,
  output: FilesAlphaGetMetadataOutput,
  func: async ({ dropbox }, data) => {
    return dropbox.call("POST", "/files/alpha/get_metadata", data) as any
  },
})
