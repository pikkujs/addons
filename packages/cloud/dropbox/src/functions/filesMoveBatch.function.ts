...
export const FilesMoveBatchInput = z.object({
...
export const FilesMoveBatchOutput = z.object({
...
export const filesMoveBatch = pikkuSessionlessFunc({
  ...
  input: FilesMoveBatchInput,
  output: FilesMoveBatchOutput,
  func: async ({ dropbox }, data) => {
    return dropbox.call("POST", "/files/move_batch", data) as any
  },
})
