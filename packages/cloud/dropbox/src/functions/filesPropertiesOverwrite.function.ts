...
export const FilesPropertiesOverwriteInput = z.object({
...
export const FilesPropertiesOverwriteOutput = z.unknown()

export const filesPropertiesOverwrite = pikkuSessionlessFunc({
  input: FilesPropertiesOverwriteInput,
  output: FilesPropertiesOverwriteOutput,
  func: async ({ dropbox }, data) => {
    return dropbox.call("POST", "/files/properties/overwrite", data) as any
  },
})
