...
export const sharingListFoldersContinue = pikkuSessionlessFunc({
  ...
  input: SharingListFoldersContinueInput,
  output: SharingListFoldersContinueOutput,
  func: async ({ dropbox }, data) => {
    return dropbox.call("POST", "/sharing/list_folders/continue", data) as any
  },
})
