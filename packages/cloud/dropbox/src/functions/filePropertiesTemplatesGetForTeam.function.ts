...
export const FilePropertiesTemplatesGetForTeamInput = z.object({
...
export const FilePropertiesTemplatesGetForTeamOutput = z.object({
...
export const filePropertiesTemplatesGetForTeam = pikkuSessionlessFunc({
  description: "Get the schema for a specified template.",
  input: FilePropertiesTemplatesGetForTeamInput,
  output: FilePropertiesTemplatesGetForTeamOutput,
  func: async ({ dropbox }, data) => {
    return dropbox.call("POST", "/file_properties/templates/get_for_team", data) as any
  },
})
