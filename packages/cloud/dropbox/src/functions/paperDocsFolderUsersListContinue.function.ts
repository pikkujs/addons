...
export const PaperDocsFolderUsersListContinueOutput = z.object({
  cursor: z.object({
...
export const paperDocsFolderUsersListContinue = pikkuSessionlessFunc({
  ...
  input: PaperDocsFolderUsersListContinueInput,
  output: PaperDocsFolderUsersListContinueOutput,
  func: async ({ dropbox }, data) => {
    return dropbox.call("POST", "/paper/docs/folder_users/list/continue", data) as any
  },
})
