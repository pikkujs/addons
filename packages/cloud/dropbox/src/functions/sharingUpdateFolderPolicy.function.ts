...
export const SharingUpdateFolderPolicyInput = z.object({
...
export const SharingUpdateFolderPolicyOutput = z.object({
  owner_team: z.object({
...
export const sharingUpdateFolderPolicy = pikkuSessionlessFunc({
  ...
  input: SharingUpdateFolderPolicyInput,
  output: SharingUpdateFolderPolicyOutput,
  func: async ({ dropbox }, data) => {
    return dropbox.call("POST", "/sharing/update_folder_policy", data) as any
  },
})
