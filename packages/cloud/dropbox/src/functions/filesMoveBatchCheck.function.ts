...
export const FilesMoveBatchCheckInput = z.object({
...
export const FilesMoveBatchCheckOutput = z.object({
  failed: z.object({
    to: z.object({
...
export const filesMoveBatchCheck = pikkuSessionlessFunc({
  ...
  input: FilesMoveBatchCheckInput,
  output: FilesMoveBatchCheckOutput,
  func: async ({ dropbox }, data) => {
    return dropbox.call("POST", "/files/move_batch/check", data) as any
  },
})
