...
export const SharingCreateSharedLinkWithSettingsInput = z.object({
  path: z.string().optional().describe("The path to be shared by the shared link."),
  settings: z.object({
  ...
  link_password: z.string().optional().describe("If :field:`requested_visibility` is :field:`RequestedVisibility.password` this is needed to specify the password to access the link."),
  expires: z.string().optional().describe("Expiration time of the shared link. By default the link won't expire."),
}).optional().describe("requested_visibility: The requested access for this shared link.\nlink_password: If :field:`requested_visibility` is :field:`RequestedVisibility.password` this is needed to specify the password to access the link.\nexpires: Expiration time of the shared link. By default the link won't expire.\n"),
})

export const SharingCreateSharedLinkWithSettingsOutput = z.object({
...
export const sharingCreateSharedLinkWithSettings = pikkuSessionlessFunc({
  ...
  input: SharingCreateSharedLinkWithSettingsInput,
  output: SharingCreateSharedLinkWithSettingsOutput,
  func: async ({ dropbox }, data) => {
    return dropbox.call("POST", "/sharing/create_shared_link_with_settings", data) as any
  },
})
