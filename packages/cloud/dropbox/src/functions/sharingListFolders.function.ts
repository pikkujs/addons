...
export const SharingListFoldersInput = z.object({
...
export const SharingListFoldersOutput = z.object({
...
export const sharingListFolders = pikkuSessionlessFunc({
  description: "Return the list of all shared folders the current user has access to.\nApps must have full Dropbox access to use this endpoint.",
  input: SharingListFoldersInput,
  output: SharingListFoldersOutput,
  func: async ({ dropbox }, data) => {
    return dropbox.call("POST", "/sharing/list_folders", data) as any
  },
})
