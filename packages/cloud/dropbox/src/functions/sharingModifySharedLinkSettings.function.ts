...
export const SharingModifySharedLinkSettingsOutput = z.object({
...
export const sharingModifySharedLinkSettings = pikkuSessionlessFunc({
  ...
  input: SharingModifySharedLinkSettingsInput,
  output: SharingModifySharedLinkSettingsOutput,
  func: async ({ dropbox }, data) => {
    return dropbox.call("POST", "/sharing/modify_shared_link_settings", data) as any
  },
})
