...
export const SharingGetFileMetadataInput = z.object({
  ...
  file: z.string().optional().describe("The file to query."),
})

export const SharingGetFileMetadataOutput = z.object({
  owner_team: z.object({
