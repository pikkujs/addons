...
export const SharingListReceivedFilesOutput = z.object({
...
export const sharingListReceivedFiles = pikkuSessionlessFunc({
  ...
  input: SharingListReceivedFilesInput,
  output: SharingListReceivedFilesOutput,
  func: async ({ dropbox }, data) => {
    return dropbox.call("POST", "/sharing/list_received_files", data) as any
  },
})
