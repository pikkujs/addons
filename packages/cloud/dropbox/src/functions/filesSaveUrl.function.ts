...
export const FilesSaveUrlInput = z.object({
  url: z.string().optional().describe("The URL to be saved."),
  path: z.string().optional().describe("The path in Dropbox where the URL will be saved to."),
})

export const FilesSaveUrlOutput = z.object({
...
export const filesSaveUrl = pikkuSessionlessFunc({
  ...
  input: FilesSaveUrlInput,
  output: FilesSaveUrlOutput,
  func: async ({ dropbox }, data) => {
    return dropbox.call("POST", "/files/save_url", data) as any
  },
})
