...
export const FilesDeleteV2Output = z.object({
  metadata: z.object({
...
}).describe("metadata: Metadata of the deleted object.\n")

export const filesDeleteV2 = pikkuSessionlessFunc({
  ...
  input: FilesDeleteV2Input,
  output: FilesDeleteV2Output,
  func: async ({ dropbox }, data) => {
    return dropbox.call("POST", "/files/delete_v2", data) as any
  },
})
