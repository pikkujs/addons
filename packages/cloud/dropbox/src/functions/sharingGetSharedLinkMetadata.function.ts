...
export const SharingGetSharedLinkMetadataInput = z.object({
...
export const SharingGetSharedLinkMetadataOutput = z.object({
...
export const sharingGetSharedLinkMetadata = pikkuSessionlessFunc({
  description: "Get the shared link's metadata.",
  input: SharingGetSharedLinkMetadataInput,
  output: SharingGetSharedLinkMetadataOutput,
  func: async ({ dropbox }, data) => {
    return dropbox.call("POST", "/sharing/get_shared_link_metadata", data) as any
  },
})
