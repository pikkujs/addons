...
export const SharingCheckShareJobStatusInput = z.object({
...
export const SharingCheckShareJobStatusOutput = z.object({
  failed: z.object({
    bad_path: z.object({
      ".tag": z.enum(["is_file", "inside_shared_folder", "contains_shared_folder", "contains_app_folder", "contains_team_folder", "is_app_folder", "inside_app_folder", "is_public_folder", "inside_public_folder", "already_shared", "invalid_path", "is_osx_package", "inside_osx_package", "other"]).optional(),
      already_shared: z.object({
        owner_team: z.object({
...
export const sharingCheckShareJobStatus = pikkuSessionlessFunc({
  description: "Returns the status of an asynchronous job for sharing a folder.\nApps must have full Dropbox access to use this endpoint.",
  input: SharingCheckShareJobStatusInput,
  output: SharingCheckShareJobStatusOutput,
  func: async ({ dropbox }, data) => {
    return dropbox.call("POST", "/sharing/check_share_job_status", data) as any
  },
})
