...
export const PublicSharedViewMetaGetOutput = z.object({
  ...
  relatedMetas: z.unknown().optional(),
  ...
  }).optional().describe("Model for Table"),
})

export const publicSharedViewMetaGet = pikkuSessionlessFunc({
  description: "Get Share View Meta",
  input: PublicSharedViewMetaGetInput,
  output: PublicSharedViewMetaGetOutput,
  errors: [BadRequestError],
  func: async ({ nocodb }, data) => {
    return nocodb.call("GET", "/api/v1/db/public/shared-view/{sharedViewUuid}/meta", data) as any
  },
})
