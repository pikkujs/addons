...
export const DbViewUpdateInput = z.object({
  viewId: z.string().min(0).max(20).describe("Model for ID").describe("Unique View ID"),
  "xc-auth": z.string().describe("Auth Token is a JWT Token generated based on the logged-in user. By default, the token is only valid for 10 hours. However, you can change the value by defining it using environment variable NC_JWT_EXPIRES_IN."),
  title: z.string().max(255).optional().describe("View Title"),
  description: z.union([z.string(), z.unknown()]).optional().describe("Description of the view."),
  uuid: z.string().max(255).optional().describe("View UUID. Used in Shared View."),
  password: z.string().max(255).optional().describe("View Password. Used in Shared View."),
  lock_type: z.enum(["collaborative", "locked", "personal"]).optional().describe("Lock type of View."),
  meta: z.union([z.unknown(), z.record(z.string(), z.unknown()), z.string()]).optional().describe("Meta info used in View."),
  order: z.number().min(0).optional().describe("The order of the list of views."),
  show_system_fields: z.union([z.number().int(), z.boolean(), z.unknown()]).optional().describe("Should this view show system fields?"),
  owned_by: z.string().min(0).max(20).optional().describe("ID of view owner user"),
})

export const DbViewUpdateOutput = z.object({
...
export const dbViewUpdate = pikkuSessionlessFunc({
  description: "Update the view with the given view Id.",
  input: DbViewUpdateInput,
  output: DbViewUpdateOutput,
  errors: [BadRequestError],
  func: async ({ nocodb }, data) => {
    return nocodb.call("PATCH", "/api/v1/db/meta/views/{viewId}", data) as any
  },
})
