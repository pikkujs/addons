...
export const DbViewGridCreateInput = z.object({
...
export const DbViewGridCreateOutput = z.object({
...
export const dbViewGridCreate = pikkuSessionlessFunc({
  description: "Create a new grid view in a given Table",
  input: DbViewGridCreateInput,
  output: DbViewGridCreateOutput,
  errors: [BadRequestError],
  func: async ({ nocodb }, data) => {
    return nocodb.call("POST", "/api/v1/db/meta/tables/{tableId}/grids", data) as any
  },
})
