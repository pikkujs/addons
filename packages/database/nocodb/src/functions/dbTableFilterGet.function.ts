...
export const DbTableFilterGetInput = z.object({
...
export const DbTableFilterGetOutput = z.object({
...
export const dbTableFilterGet = pikkuSessionlessFunc({
  description: "Get the filter data with a given Filter ID",
  input: DbTableFilterGetInput,
  output: DbTableFilterGetOutput,
  errors: [BadRequestError],
  func: async ({ nocodb }, data) => {
    return nocodb.call("GET", "/api/v1/db/meta/filters/{filterId}", data) as any
  },
})
