...
export const DbViewFormUpdateInput = z.object({
  ...
  heading: z.string().max(255).optional().describe("The heading of the form"),
...
export const DbViewFormUpdateOutput = z.object({
...
export const dbViewFormUpdate = pikkuSessionlessFunc({
  description: "Update the form data by Form ID",
  input: DbViewFormUpdateInput,
  output: DbViewFormUpdateOutput,
  errors: [BadRequestError],
  func: async ({ nocodb }, data) => {
    return nocodb.call("PATCH", "/api/v1/db/meta/forms/{formViewId}", data) as any
  },
})
