...
export const DbLinksTableReadInput = z.object({
  linkColumnId: z.string().min(0).max(20).describe("Model for ID").describe("Unique Link Columns ID"),
...
export const DbLinksTableReadOutput = z.object({
...
export const dbLinksTableRead = pikkuSessionlessFunc({
  description: "Read the table metadata by linked column ID and  table ID",
  input: DbLinksTableReadInput,
  output: DbLinksTableReadOutput,
  errors: [BadRequestError],
  func: async ({ nocodb }, data) => {
    return nocodb.call("GET", "/api/v1/db/internal/links/{linkColumnId}/tables/{tableId}", data) as any
  },
})
