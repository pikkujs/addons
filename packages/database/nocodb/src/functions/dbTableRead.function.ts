...
export const DbTableReadInput = z.object({
...
export const DbTableReadOutput = z.object({
...
export const dbTableRead = pikkuSessionlessFunc({
  description: "Read the table meta data by the given table ID",
  input: DbTableReadInput,
  output: DbTableReadOutput,
  errors: [BadRequestError],
  func: async ({ nocodb }, data) => {
    return nocodb.call("GET", "/api/v1/db/meta/tables/{tableId}", data) as any
  },
})
