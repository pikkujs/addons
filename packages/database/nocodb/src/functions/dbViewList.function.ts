...
export const DbViewListInput = z.object({
...
export const DbViewListOutput = z.object({
...
}).describe("Model for View List")

export const dbViewList = pikkuSessionlessFunc({
  description: "List all views in a given Table.",
  input: DbViewListInput,
  output: DbViewListOutput,
  errors: [BadRequestError],
  func: async ({ nocodb }, data) => {
    return nocodb.call("GET", "/api/v1/db/meta/tables/{tableId}/views", data) as any
  },
})
