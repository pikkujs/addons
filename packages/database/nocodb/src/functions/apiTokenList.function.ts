...
export const apiTokenList = pikkuSessionlessFunc({
  description: "List API Tokens in the given base",
  input: ApiTokenListInput,
  output: ApiTokenListOutput,
  errors: [BadRequestError],
  func: async ({ nocodb }, data) => {
    return nocodb.call("GET", "/api/v1/db/meta/projects/{baseId}/api-tokens", data) as any
  },
})
