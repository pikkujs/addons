...
export const DbViewGridUpdateInput = z.object({
  ...
  meta: z.union([z.unknown(), z.record(z.string(), z.unknown()), z.string()]).optional().describe("Meta Info for grid view"),
})

export const DbViewGridUpdateOutput = z.object({
...
export const dbViewGridUpdate = pikkuSessionlessFunc({
  description: "Update Grid View",
  input: DbViewGridUpdateInput,
  output: DbViewGridUpdateOutput,
  errors: [BadRequestError],
  func: async ({ nocodb }, data) => {
    return nocodb.call("PATCH", "/api/v1/db/meta/grids/{viewId}", data) as any
  },
})
