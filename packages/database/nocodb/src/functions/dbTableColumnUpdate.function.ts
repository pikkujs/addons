...
export const DbTableColumnUpdateInput = z.object({
  columnId: z.string(),
...
export const DbTableColumnUpdateOutput = z.object({
...
export const dbTableColumnUpdate = pikkuSessionlessFunc({
  description: "Update the existing column by the given column ID",
  input: DbTableColumnUpdateInput,
  output: DbTableColumnUpdateOutput,
  errors: [BadRequestError],
  func: async ({ nocodb }, data) => {
    return nocodb.call("PATCH", "/api/v1/db/meta/columns/{columnId}", data) as any
  },
})
