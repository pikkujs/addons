...
export const InternalGetOperationInput = z.object({
...
export const InternalGetOperationOutput = z.record(z.string(), z.unknown())

export const internalGetOperation = pikkuSessionlessFunc({
  description: "Trigger an internal operation",
  input: InternalGetOperationInput,
  output: InternalGetOperationOutput,
  func: async ({ nocodb }, data) => {
    return nocodb.call("GET", "/api/v2/internal/:workspaceId/:baseId", data) as any
  },
})
