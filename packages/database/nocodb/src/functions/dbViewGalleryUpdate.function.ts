...
export const DbViewGalleryUpdateInput = z.object({
  galleryViewId: z.string().describe("Unique Gallery View ID"),
  "xc-auth": z.string().describe("Auth Token is a JWT Token generated based on the logged-in user. By default, the token is only valid for 10 hours. However, you can change the value by defining it using environment variable NC_JWT_EXPIRES_IN."),
  fk_cover_image_col_id: z.union([z.string(), z.unknown()]).optional().describe("The id of the column that contains the cover image"),
  meta: z.union([z.unknown(), z.record(z.string(), z.unknown()), z.string()]).optional().describe("Meta Info"),
})

export const DbViewGalleryUpdateOutput = z.object({
...
export const dbViewGalleryUpdate = pikkuSessionlessFunc({
  description: "Update the Gallery View data with Gallery ID",
  input: DbViewGalleryUpdateInput,
  output: DbViewGalleryUpdateOutput,
  errors: [BadRequestError],
  func: async ({ nocodb }, data) => {
    return nocodb.call("PATCH", "/api/v1/db/meta/galleries/{galleryViewId}", data) as any
  },
})
