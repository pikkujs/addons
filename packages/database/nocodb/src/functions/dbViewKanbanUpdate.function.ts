...
export const DbViewKanbanUpdateInput = z.object({
  kanbanViewId: z.string().describe("Unique Kanban View ID"),
  "xc-auth": z.string().describe("Auth Token is a JWT Token generated based on the logged-in user. By default, the token is only valid for 10 hours. However, you can change the value by defining it using environment variable NC_JWT_EXPIRES_IN."),
  fk_grp_col_id: z.union([z.string(), z.unknown()]).optional().describe("Foreign Key to Grouping Field Column"),
...
export const DbViewKanbanUpdateOutput = z.object({
...
export const dbViewKanbanUpdate = pikkuSessionlessFunc({
  description: "Update the Kanban View data with Kanban ID",
  input: DbViewKanbanUpdateInput,
  output: DbViewKanbanUpdateOutput,
  errors: [BadRequestError],
  func: async ({ nocodb }, data) => {
    return nocodb.call("PATCH", "/api/v1/db/meta/kanbans/{kanbanViewId}", data) as any
  },
})
