...
export const DbTableListInput = z.object({
...
export const DbTableListOutput = z.object({
...
export const dbTableList = pikkuSessionlessFunc({
  description: "List all tables in a given base",
  input: DbTableListInput,
  output: DbTableListOutput,
  errors: [BadRequestError],
  func: async ({ nocodb }, data) => {
    return nocodb.call("GET", "/api/v1/db/meta/projects/{baseId}/tables", data) as any
  },
})
