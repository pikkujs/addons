...
export const DbTableCreateInput = z.object({
  ...
  ai: z.union([z.number().int(), z.boolean(), z.unknown()]).optional().describe("Is this column auto-incremented?"),
  au: z.union([z.number().int(), z.boolean(), z.unknown()]).optional().describe("Is this column auto-updated datetime field?"),
  cc: z.union([z.string(), z.unknown()]).optional().describe("Column Comment"),
  cdf: z.union([z.string(), z.unknown(), z.boolean(), z.number()]).optional().describe("Column Default Value"),
  column_name: z.string().min(1).max(255).optional().describe("Column Name"),
  csn: z.union([z.string(), z.unknown()]).optional().describe("Model for StringOrNull"),
  dt: z.string().optional().describe("Data Type"),
  dtx: z.union([z.string(), z.unknown()]).optional().describe("Data Type Extra"),
  dtxp: z.union([z.string(), z.number(), z.unknown()]).optional().describe("Data Type Extra Precision"),
  dtxs: z.union([z.union([z.string(), z.unknown()]), z.number()]).optional().describe("Data Type Extra Scale"),
  np: z.union([z.union([z.string(), z.unknown()]), z.number().int()]).optional().describe("Numeric Precision"),
  ns: z.union([z.union([z.string(), z.unknown()]), z.number().int()]).optional().describe("Numeric Scale"),
  pk: z.union([z.number().int(), z.boolean(), z.unknown()]).optional().describe("Is this column a primary key?"),
  pv: z.union([z.number().int(), z.boolean(), z.unknown()]).optional().describe("Is this column a primary value?"),
  rqd: z.union([z.number().int(), z.boolean(), z.unknown()]).optional().describe("Is this column required?"),
  title: z.string().max(255).describe("Column Title"),
  uidt: z.enum(["Attachment", "AutoNumber", "Barcode", "Button", "Checkbox", "Collaborator", "Count", "CreatedTime", "Currency", "Date", "DateTime", "Decimal", "Duration", "Email", "Formula", "ForeignKey", "GeoData", "Geometry", "ID", "JSON", "LastModifiedTime", "LongText", "LinkToAnotherRecord", "Lookup", "MultiSelect", "Number", "Percent", "PhoneNumber", "Rating", "Rollup", "SingleLineText", "SingleSelect", "SpecificDBType", "Time", "URL", "Year", "QrCode", "Links", "User", "CreatedBy", "LastModifiedBy", "AI", "Order", "Meta", "Colour", "UUID"]).optional().describe("UI Data Type"),
  un: z.union([z.number().int(), z.boolean(), z.unknown()]).optional().describe("Is this column unique?"),
  unique: z.union([z.number().int(), z.boolean(), z.unknown()]).optional().describe("Is this column unique?"),
  readonly: z.union([z.number().int(), z.boolean(), z.unknown()]).optional().describe("Is this column readonly?"),
})).describe("The column models in this table"),
  description: z.union([z.string(), z.unknown()]).optional().describe("Table description"),
  meta: z.union([z.unknown(), z.record(z.string(), z.unknown()), z.string()]).optional().describe("the meta data for this table"),
  order: z.number().optional().describe("The order of table list"),
  table_name: z.string().min(1).max(255).optional().describe("Table name"),
  title: z.string().min(0).max(255).describe("Table title"),
})

export const DbTableCreateOutput = z.object({
...
export const dbTableCreate = pikkuSessionlessFunc({
  description: "Create a new table in a given base",
  input: DbTableCreateInput,
  output: DbTableCreateOutput,
  errors: [BadRequestError],
  func: async ({ nocodb }, data) => {
    return nocodb.call("POST", "/api/v1/db/meta/projects/{baseId}/tables", data) as any
  },
})
