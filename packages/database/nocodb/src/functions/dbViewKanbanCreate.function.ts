...
export const DbViewKanbanCreateInput = z.object({
...
export const DbViewKanbanCreateOutput = z.object({
...
export const dbViewKanbanCreate = pikkuSessionlessFunc({
  description: "Create a new Kanban View",
  input: DbViewKanbanCreateInput,
  output: DbViewKanbanCreateOutput,
  errors: [BadRequestError],
  func: async ({ nocodb }, data) => {
    return nocodb.call("POST", "/api/v1/db/meta/tables/{tableId}/kanbans", data) as any
  },
})
