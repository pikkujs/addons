...
export const PublicDataGroupByInput = z.object({
...
export const PublicDataGroupByOutput = z.object({
  ...
  })).min(1).describe("List of shared view objects"),
  pageInfo: z.object({
...
}).describe("Model for Shared View List")

export const publicDataGroupBy = pikkuSessionlessFunc({
  description: "List all shared view rows grouped by a column",
  input: PublicDataGroupByInput,
  output: PublicDataGroupByOutput,
  errors: [BadRequestError],
  func: async ({ nocodb }, data) => {
    return nocodb.call("GET", "/api/v1/db/public/shared-view/{sharedViewUuid}/groupby", data) as any
  },
})
