...
export const DbViewCalendarCreateInput = z.object({
...
export const DbViewCalendarCreateOutput = z.object({
...
export const dbViewCalendarCreate = pikkuSessionlessFunc({
  description: "Create a new Calendar View",
  input: DbViewCalendarCreateInput,
  output: DbViewCalendarCreateOutput,
  errors: [BadRequestError],
  func: async ({ nocodb }, data) => {
    return nocodb.call("POST", "/api/v1/db/meta/tables/{tableId}/calendars", data) as any
  },
})
