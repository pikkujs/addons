...
export const DbViewShareUpdateInput = z.object({
...
export const DbViewShareUpdateOutput = ViewSchema.describe("Model for Shared View")

export const dbViewShareUpdate = pikkuSessionlessFunc({
  description: "Update a shared view in a given View..",
  input: DbViewShareUpdateInput,
  output: DbViewShareUpdateOutput,
  errors: [BadRequestError],
  func: async ({ nocodb }, data) => {
    return nocodb.call("PATCH", "/api/v1/db/meta/views/{viewId}/share", data) as any
  },
})
