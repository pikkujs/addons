...
export const OrgUsersProfileUpdateInput = z.object({
  userId: z.string(),
...
export const orgUsersProfileUpdate = pikkuSessionlessFunc({
  description: "Update Organisation User Profile",
  input: OrgUsersProfileUpdateInput,
  func: async ({ nocodb }, data) => {
    return nocodb.call("PATCH", "/api/v1/users/{userId}/profile", data)
  },
})
