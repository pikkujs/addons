...
export const DbViewMapCreateInput = z.object({
...
export const DbViewMapCreateOutput = z.object({
...
export const dbViewMapCreate = pikkuSessionlessFunc({
  description: "Create a new Map View",
  input: DbViewMapCreateInput,
  output: DbViewMapCreateOutput,
  errors: [BadRequestError],
  func: async ({ nocodb }, data) => {
    return nocodb.call("POST", "/api/v1/db/meta/tables/{tableId}/maps", data) as any
  },
})
