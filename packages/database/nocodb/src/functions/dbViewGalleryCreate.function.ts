...
export const DbViewGalleryCreateInput = z.object({
...
export const DbViewGalleryCreateOutput = z.object({
...
export const dbViewGalleryCreate = pikkuSessionlessFunc({
  input: DbViewGalleryCreateInput,
  output: DbViewGalleryCreateOutput,
  errors: [BadRequestError],
  func: async ({ nocodb }, data) => {
    return nocodb.call("POST", "/api/v1/db/meta/tables/{tableId}/galleries", data) as any
  },
})
