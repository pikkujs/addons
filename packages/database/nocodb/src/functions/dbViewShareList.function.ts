...
export const DbViewShareListInput = z.object({
...
export const DbViewShareListOutput = z.object({
...
export const dbViewShareList = pikkuSessionlessFunc({
  description: "List all shared views in a given Table",
  input: DbViewShareListInput,
  output: DbViewShareListOutput,
  errors: [BadRequestError],
  func: async ({ nocodb }, data) => {
    return nocodb.call("GET", "/api/v1/db/meta/tables/{tableId}/share", data) as any
  },
})
