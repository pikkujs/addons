...
export const dbTableWebhookFilterRead = pikkuSessionlessFunc({
  description: "Get the filter data in a given Hook",
  input: DbTableWebhookFilterReadInput,
  output: DbTableWebhookFilterReadOutput,
  errors: [BadRequestError],
  func: async ({ nocodb }, data) => {
    return nocodb.call("GET", "/api/v1/db/meta/hooks/{hookId}/filters", data) as any
  },
})
