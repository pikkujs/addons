...
export const DbTableFilterCreateInput = z.object({
...
export const DbTableFilterCreateOutput = z.object({
...
export const dbTableFilterCreate = pikkuSessionlessFunc({
  description: "Update the filter data in a given View",
  input: DbTableFilterCreateInput,
  output: DbTableFilterCreateOutput,
  errors: [BadRequestError],
  func: async ({ nocodb }, data) => {
    return nocodb.call("POST", "/api/v1/db/meta/views/{viewId}/filters", data) as any
  },
})
