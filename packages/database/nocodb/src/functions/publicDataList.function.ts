...
export const PublicDataListInput = z.object({
...
export const PublicDataListOutput = z.object({
...
export const publicDataList = pikkuSessionlessFunc({
  description: "List all shared view rows",
  input: PublicDataListInput,
  output: PublicDataListOutput,
  errors: [BadRequestError],
  func: async ({ nocodb }, data) => {
    return nocodb.call("GET", "/api/v1/db/public/shared-view/{sharedViewUuid}/rows", data) as any
  },
})
