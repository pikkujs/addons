...
export const OrgUsersProfileCreateInput = z.object({
  userId: z.string(),
...
export const orgUsersProfileCreate = pikkuSessionlessFunc({
  description: "Create Organisation User Profile",
  input: OrgUsersProfileCreateInput,
  func: async ({ nocodb }, data) => {
    return nocodb.call("POST", "/api/v1/users/{userId}/profile", data)
  },
})
