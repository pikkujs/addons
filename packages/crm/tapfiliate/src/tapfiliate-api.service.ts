...
const ROUTES: Record<string, { path: string[], query: string[], headers: string[], errors?: Record<number, string> }> = {
  ...
  "PUT /affiliates/{affiliateId}/meta-data/": {
    "path": [
      "affiliateId"
    ],
    "query": [],
  ...
  "PUT /affiliates/{affiliateId}/meta-data/{key}/": {
    "path": [
      "affiliateId",
      "key"
    ],
  ...
  "DELETE /affiliates/{affiliateId}/meta-data/{key}/": {
    "path": [
      "affiliateId",
      "key"
    ],
  ...
  "GET /programs/{programId}/affiliates/": {
    "path": [
      "programId"
    ],
    "query": [
  ...
  "POST /programs/{programId}/affiliates/": {
    "path": [
      "programId"
    ],
    "query": [],
  ...
  "GET /programs/{programId}/affiliates/{affiliateId}/": {
    "path": [
      "programId",
      "affiliateId"
    ],
  ...
  "PUT /programs/{programId}/affiliates/{affiliateId}/approved/": {
    "path": [
      "programId",
      "affiliateId"
    ],
  ...
  "DELETE /programs/{programId}/affiliates/{affiliateId}/approved/": {
    "path": [
      "programId",
      "affiliateId"
    ],
...
export class TapfiliateService {
  ...
  constructor(private creds: { apiKey: string }, variables: TypedVariablesService) {
    this.baseUrl = variables.get('TAPFILIATE_BASE_URL') as string
  }
  ...
  async call<T>(
    ...
    if (!response.ok) {
      ...
      switch (response.status) {
        ...
        default: throw new Error(`Tapfiliate API error (${response.status}): ${errorText}`)
      }
    }
