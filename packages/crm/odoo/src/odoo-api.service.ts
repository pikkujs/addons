...
const ROUTES: Record<string, { path: string[], query: string[], headers: string[], errors?: Record<number, string> }> = {
  "POST /jsonrpc/activity/create": {
    "path": [],
    "query": [],
    "headers": []
  },
  "POST /jsonrpc/activity/get": {
    "path": [],
    "query": [],
    "headers": []
  },
  "POST /jsonrpc/activity/getAll": {
    "path": [],
    "query": [],
    "headers": []
  },
  "POST /jsonrpc/activity/update": {
    "path": [],
    "query": [],
    "headers": []
  },
  "POST /jsonrpc/activity/delete": {
    "path": [],
    "query": [],
    "headers": []
  },
  "POST /jsonrpc/contact/create": {
    "path": [],
    "query": [],
    "headers": []
  },
  "POST /jsonrpc/contact/get": {
    "path": [],
    "query": [],
    "headers": []
  },
  "POST /jsonrpc/contact/getAll": {
    "path": [],
    "query": [],
    "headers": []
  },
  "POST /jsonrpc/contact/update": {
    "path": [],
    "query": [],
    "headers": []
  },
  "POST /jsonrpc/contact/delete": {
    "path": [],
    "query": [],
    "headers": []
  },
  "POST /jsonrpc/custom/create": {
    "path": [],
    "query": [],
    "headers": []
  },
  "POST /jsonrpc/custom/get": {
    "path": [],
    "query": [],
    "headers": []
  },
  "POST /jsonrpc/custom/getAll": {
    "path": [],
    "query": [],
    "headers": []
  },
  "POST /jsonrpc/custom/update": {
    "path": [],
    "query": [],
    "headers": []
  },
  "POST /jsonrpc/custom/delete": {
    "path": [],
    "query": [],
    "headers": []
  },
  "POST /jsonrpc/note/create": {
    "path": [],
    "query": [],
    "headers": []
  },
  "POST /jsonrpc/note/get": {
    "path": [],
    "query": [],
    "headers": []
  },
  "POST /jsonrpc/note/getAll": {
    "path": [],
    "query": [],
    "headers": []
  },
  "POST /jsonrpc/note/update": {
    "path": [],
    "query": [],
    "headers": []
  },
  "POST /jsonrpc/note/delete": {
    "path": [],
    "query": [],
    "headers": []
  },
  "POST /jsonrpc/opportunity/create": {
    "path": [],
    "query": [],
    "headers": []
  },
  "POST /jsonrpc/opportunity/get": {
    "path": [],
    "query": [],
    "headers": []
  },
  "POST /jsonrpc/opportunity/getAll": {
    "path": [],
    "query": [],
    "headers": []
  },
  "POST /jsonrpc/opportunity/update": {
    "path": [],
    "query": [],
    "headers": []
  },
  "POST /jsonrpc/opportunity/delete": {
    "path": [],
    "query": [],
    "headers": []
  }
...
export class OdooService {
  ...
  constructor(private creds: { apiKey: string }, variables: TypedVariablesService) {
    this.baseUrl = variables.get('ODOO_BASE_URL') as string
  }
  ...
  async call<T>(
    ...
    if (!response.ok) {
      ...
      switch (response.status) {
        ...
        default: throw new Error(`Odoo API error (${response.status}): ${errorText}`)
      }
    }
