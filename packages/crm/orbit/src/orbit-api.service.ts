...
const ROUTES: Record<string, { path: string[], query: string[], headers: string[], errors?: Record<number, string> }> = {
  "POST /{workspaceId}/members/{memberId}/activities": {
    "path": [
      "workspaceId",
      "memberId"
    ],
  ...
  "GET /{workspaceId}/members/{memberId}/notes": {
    "path": [
      "workspaceId",
      "memberId"
    ],
  ...
  "POST /{workspaceId}/members/{memberId}/notes": {
    "path": [
      "workspaceId",
      "memberId"
    ],
  ...
  "PUT /{workspaceId}/members/{memberId}/notes/{noteId}": {
    "path": [
      "workspaceId",
      "memberId",
      "noteId"
  ...
  "POST /{workspaceId}/members/{memberId}/posts": {
    "path": [
      "workspaceId",
      "memberId"
    ],
  ...
  "DELETE /{workspaceId}/members/{memberId}/posts/{postId}": {
    "path": [
      "workspaceId",
      "memberId",
      "postId"
...
export class OrbitService {
  ...
  constructor(private creds: { token: string }, variables: TypedVariablesService) {
    this.baseUrl = variables.get('ORBIT_BASE_URL') as string
  }
  ...
  async call<T>(
    ...
    if (!response.ok) {
      ...
      switch (response.status) {
        ...
        default: throw new Error(`Orbit API error (${response.status}): ${errorText}`)
      }
    }
