...
const ROUTES: Record<string, { path: string[], query: string[], headers: string[], errors?: Record<number, string> }> = {
  ...
  "PUT /api/contacts/edit-properties": {
    "path": [],
    "query": [],
    "headers": []
  },
  "POST /api/filters/filter/dynamic-filter": {
    "path": [],
    "query": [],
    "headers": []
  },
  ...
  "DELETE /api/contacts/company/{companyId}": {
    "path": [
      "companyId"
    ],
    "query": [],
  ...
  "PUT /api/contacts/company/edit-properties": {
    "path": [],
    "query": [],
    "headers": []
  },
  "POST /api/filters/filter/company-dynamic-filter": {
    "path": [],
    "query": [],
    "headers": []
  },
  "GET /api/opportunity/{dealId}": {
    "path": [
      "dealId"
    ],
    "query": [],
  ...
  "PUT /api/opportunity/partial-update": {
    "path": [],
    "query": [],
    "headers": []
  }
...
export class AgileCrmService {
  private baseUrl: string

  constructor(private creds: { apiKey: string }, variables: TypedVariablesService) {
    this.baseUrl = variables.get('AGILE_CRM_BASE_URL') as string
  }
  ...
  async call<T>(
    ...
    if (!response.ok) {
      ...
      switch (response.status) {
        ...
        default: throw new Error(`Agile CRM API error (${response.status}): ${errorText}`)
      }
    }
