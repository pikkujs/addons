...
export const dealList = pikkuSessionlessFunc({
  description: 'Lists all HubSpot deals',
  node: { displayName: 'List Deals', category: 'Deals', type: 'action' },
  input: DealListInput,
  ...
  func: async ({ hubspot }, { limit, after, properties }) => {
    ...
    return hubspot.request<z.infer<typeof DealListOutput>>(
      'GET',
