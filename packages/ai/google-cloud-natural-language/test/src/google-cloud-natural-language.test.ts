...
test('google-cloud-natural-language addon', async () => {
  const secrets = new LocalSecretService()
  // Set up secrets for the service
  // await secrets.setSecret('GOOGLE_CLOUD_NATURAL_LANGUAGE_CREDENTIALS', { ... })
  ...
  try {
    const { passed, failed } = await rpc.invoke('testGoogleCloudNaturalLanguage', {})
