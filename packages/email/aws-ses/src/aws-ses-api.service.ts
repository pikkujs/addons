...
const ROUTES: Record<string, { path: string[], query: string[], headers: string[], errors?: Record<number, string> }> = {
  ...
  "POST /customVerificationEmail/create": {
    "path": [],
    "query": [],
    "headers": []
  },
  "POST /customVerificationEmail/delete": {
    "path": [],
    "query": [],
    "headers": []
  },
  "GET /customVerificationEmail/get": {
    "path": [],
    "query": [
      "templateName"
    ],
  ...
  "GET /customVerificationEmail/list": {
    "path": [],
    "query": [
      "limit"
    ],
  ...
  "POST /customVerificationEmail/send": {
    "path": [],
    "query": [],
    "headers": []
  },
  "POST /customVerificationEmail/update": {
    "path": [],
    "query": [],
    "headers": []
  }
...
export class AwsSesService {
  ...
  constructor(private creds: { apiKey: string }, variables: TypedVariablesService) {
    this.baseUrl = variables.get('AWS_SES_BASE_URL') as string
  }
  ...
  async call<T>(
    ...
    if (!response.ok) {
      ...
      switch (response.status) {
        ...
        default: throw new Error(`AWS SES API error (${response.status}): ${errorText}`)
      }
    }
