...
export const UserEventSnoozeReminderInput = z.object({
...
export const userEventSnoozeReminder = pikkuSessionlessFunc({
  description: "Postpone a reminder for an event in a user calendar until a new time.",
  input: UserEventSnoozeReminderInput,
  func: async ({ microsoftOutlook }, data) => {
    return microsoftOutlook.call("POST", "/users/{user-id}/events/{event-id}/microsoft.graph.snoozeReminder", data)
  },
})
