...
export const GroupCalendarEventSnoozeReminderInput = z.object({
...
export const groupCalendarEventSnoozeReminder = pikkuSessionlessFunc({
  description: "Postpone a reminder for an event in a user calendar until a new time.",
  input: GroupCalendarEventSnoozeReminderInput,
  func: async ({ microsoftOutlook }, data) => {
    return microsoftOutlook.call("POST", "/groups/{group-id}/calendar/events/{event-id}/microsoft.graph.snoozeReminder", data)
  },
})
