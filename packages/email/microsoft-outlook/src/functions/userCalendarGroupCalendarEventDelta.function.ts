...
export const UserCalendarGroupCalendarEventDeltaInput = z.object({
...
export const UserCalendarGroupCalendarEventDeltaOutput = z.any()

export const userCalendarGroupCalendarEventDelta = pikkuSessionlessFunc({
  ...
  input: UserCalendarGroupCalendarEventDeltaInput,
  output: UserCalendarGroupCalendarEventDeltaOutput,
  func: async ({ microsoftOutlook }, data) => {
    return microsoftOutlook.call("GET", "/users/{user-id}/calendarGroups/{calendarGroup-id}/calendars/{calendar-id}/events/microsoft.graph.delta()", data) as any
  },
})
