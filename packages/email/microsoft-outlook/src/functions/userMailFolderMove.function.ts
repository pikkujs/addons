...
export const UserMailFolderMoveInput = z.object({
  "user-id": z.string().describe("The unique identifier of user"),
  "mailFolder-id": z.string().describe("The unique identifier of mailFolder"),
  DestinationId: z.string().optional(),
})

export const UserMailFolderMoveOutput = z.object({
...
export const userMailFolderMove = pikkuSessionlessFunc({
  description: "Move a mailfolder and its contents to another mailfolder.",
  input: UserMailFolderMoveInput,
  output: UserMailFolderMoveOutput,
  func: async ({ microsoftOutlook }, data) => {
    return microsoftOutlook.call("POST", "/users/{user-id}/mailFolders/{mailFolder-id}/microsoft.graph.move", data) as any
  },
})
