...
export const PlaceAsRoomListWorkspaceGetCheckInInput = z.object({
...
export const PlaceAsRoomListWorkspaceGetCheckInOutput = z.object({
...
export const placeAsRoomListWorkspaceGetCheckIn = pikkuSessionlessFunc({
  ...
  input: PlaceAsRoomListWorkspaceGetCheckInInput,
  output: PlaceAsRoomListWorkspaceGetCheckInOutput,
  func: async ({ microsoftOutlook }, data) => {
    return microsoftOutlook.call("GET", "/places/{place-id}/microsoft.graph.roomList/workspaces/{workspace-id}/checkIns/{checkInClaim-calendarEventId}", data) as any
  },
})
