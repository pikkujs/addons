...
export const UserListContactFolderInput = z.object({
...
export const UserListContactFolderOutput = z.object({
...
export const userListContactFolder = pikkuSessionlessFunc({
  description: "The user's contacts folders. Read-only. Nullable.",
  input: UserListContactFolderInput,
  output: UserListContactFolderOutput,
  func: async ({ microsoftOutlook }, data) => {
    return microsoftOutlook.call("GET", "/users/{user-id}/contactFolders", data) as any
  },
})
