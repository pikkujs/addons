...
export const UserCalendarGroupCalendarEventAttachmentCreateUploadSessionInput = z.object({
...
export const UserCalendarGroupCalendarEventAttachmentCreateUploadSessionOutput = z.object({
...
export const userCalendarGroupCalendarEventAttachmentCreateUploadSession = pikkuSessionlessFunc({
  ...
  input: UserCalendarGroupCalendarEventAttachmentCreateUploadSessionInput,
  output: UserCalendarGroupCalendarEventAttachmentCreateUploadSessionOutput,
  func: async ({ microsoftOutlook }, data) => {
    return microsoftOutlook.call("POST", "/users/{user-id}/calendarGroups/{calendarGroup-id}/calendars/{calendar-id}/events/{event-id}/attachments/microsoft.graph.createUploadSession", data) as any
  },
})
