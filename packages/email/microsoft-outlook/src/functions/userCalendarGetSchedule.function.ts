...
export const UserCalendarGetScheduleInput = z.object({
...
export const UserCalendarGetScheduleOutput = z.object({
...
export const userCalendarGetSchedule = pikkuSessionlessFunc({
  ...
  input: UserCalendarGetScheduleInput,
  output: UserCalendarGetScheduleOutput,
  func: async ({ microsoftOutlook }, data) => {
    return microsoftOutlook.call("POST", "/users/{user-id}/calendar/microsoft.graph.getSchedule", data) as any
  },
})
