...
export const PlaceAsRoomListCheckInInput = z.object({
...
export const PlaceAsRoomListCheckInOutput = z.object({
...
export const placeAsRoomListCheckIn = pikkuSessionlessFunc({
  ...
  input: PlaceAsRoomListCheckInInput,
  output: PlaceAsRoomListCheckInOutput,
  func: async ({ microsoftOutlook }, data) => {
    return microsoftOutlook.call("GET", "/places/{place-id}/microsoft.graph.room/checkIns", data) as any
  },
})
