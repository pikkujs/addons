...
export const UserContactFolderListChildFolderInput = z.object({
...
export const UserContactFolderListChildFolderOutput = z.object({
...
export const userContactFolderListChildFolder = pikkuSessionlessFunc({
  description: "The collection of child folders in the folder. Navigation property. Read-only. Nullable.",
  input: UserContactFolderListChildFolderInput,
  output: UserContactFolderListChildFolderOutput,
  func: async ({ microsoftOutlook }, data) => {
    return microsoftOutlook.call("GET", "/users/{user-id}/contactFolders/{contactFolder-id}/childFolders", data) as any
  },
})
