...
export const UserEventAttachmentCreateUploadSessionInput = z.object({
...
export const UserEventAttachmentCreateUploadSessionOutput = z.object({
...
export const userEventAttachmentCreateUploadSession = pikkuSessionlessFunc({
  ...
  input: UserEventAttachmentCreateUploadSessionInput,
  output: UserEventAttachmentCreateUploadSessionOutput,
  func: async ({ microsoftOutlook }, data) => {
    return microsoftOutlook.call("POST", "/users/{user-id}/events/{event-id}/attachments/microsoft.graph.createUploadSession", data) as any
  },
})
