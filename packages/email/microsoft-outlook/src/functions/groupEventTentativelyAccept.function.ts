...
export const GroupEventTentativelyAcceptInput = z.object({
...
export const groupEventTentativelyAccept = pikkuSessionlessFunc({
  ...
  input: GroupEventTentativelyAcceptInput,
  func: async ({ microsoftOutlook }, data) => {
    return microsoftOutlook.call("POST", "/groups/{group-id}/events/{event-id}/microsoft.graph.tentativelyAccept", data)
  },
})
