...
export const PlaceAsDeskGetCheckInInput = z.object({
...
export const PlaceAsDeskGetCheckInOutput = z.object({
...
export const placeAsDeskGetCheckIn = pikkuSessionlessFunc({
  ...
  input: PlaceAsDeskGetCheckInInput,
  output: PlaceAsDeskGetCheckInOutput,
  func: async ({ microsoftOutlook }, data) => {
    return microsoftOutlook.call("GET", "/places/{place-id}/microsoft.graph.desk/checkIns/{checkInClaim-calendarEventId}", data) as any
  },
})
