...
export const PlaceAsBuildingListCheckInInput = z.object({
...
export const PlaceAsBuildingListCheckInOutput = z.object({
...
export const placeAsBuildingListCheckIn = pikkuSessionlessFunc({
  ...
  input: PlaceAsBuildingListCheckInInput,
  output: PlaceAsBuildingListCheckInOutput,
  func: async ({ microsoftOutlook }, data) => {
    return microsoftOutlook.call("GET", "/places/{place-id}/microsoft.graph.building/checkIns", data) as any
  },
})
