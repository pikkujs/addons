...
export const UserMailFolderUpdateMessageInput = z.object({
...
export const UserMailFolderUpdateMessageOutput = z.object({
  bccRecipients: z.array(z.object({
    emailAddress: z.object({
      address: z.string().nullable().optional().describe("The email address of the person or entity."),
      name: z.string().nullable().optional().describe("The display name of the person or entity."),
...
export const userMailFolderUpdateMessage = pikkuSessionlessFunc({
  input: UserMailFolderUpdateMessageInput,
  output: UserMailFolderUpdateMessageOutput,
  func: async ({ microsoftOutlook }, data) => {
    return microsoftOutlook.call("PATCH", "/users/{user-id}/mailFolders/{mailFolder-id}/messages/{message-id}", data) as any
  },
})
