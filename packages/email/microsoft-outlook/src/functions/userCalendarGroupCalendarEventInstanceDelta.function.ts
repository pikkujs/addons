...
export const UserCalendarGroupCalendarEventInstanceDeltaInput = z.object({
...
export const UserCalendarGroupCalendarEventInstanceDeltaOutput = z.any()

export const userCalendarGroupCalendarEventInstanceDelta = pikkuSessionlessFunc({
  ...
  input: UserCalendarGroupCalendarEventInstanceDeltaInput,
  output: UserCalendarGroupCalendarEventInstanceDeltaOutput,
  func: async ({ microsoftOutlook }, data) => {
    return microsoftOutlook.call("GET", "/users/{user-id}/calendarGroups/{calendarGroup-id}/calendars/{calendar-id}/events/{event-id}/instances/microsoft.graph.delta()", data) as any
  },
})
