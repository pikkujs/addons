...
export const UserMailFolderChildFolderDeltaInput = z.object({
...
export const UserMailFolderChildFolderDeltaOutput = z.object({
...
export const userMailFolderChildFolderDelta = pikkuSessionlessFunc({
  ...
  input: UserMailFolderChildFolderDeltaInput,
  output: UserMailFolderChildFolderDeltaOutput,
  func: async ({ microsoftOutlook }, data) => {
    return microsoftOutlook.call("GET", "/users/{user-id}/mailFolders/{mailFolder-id}/childFolders/microsoft.graph.delta()", data) as any
  },
})
