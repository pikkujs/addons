...
export const PlaceListPlaceAsRoomInput = z.object({
...
export const PlaceListPlaceAsRoomOutput = z.object({
...
export const placeListPlaceAsRoom = pikkuSessionlessFunc({
  ...
  input: PlaceListPlaceAsRoomInput,
  output: PlaceListPlaceAsRoomOutput,
  func: async ({ microsoftOutlook }, data) => {
    return microsoftOutlook.call("GET", "/places/microsoft.graph.room", data) as any
  },
})
