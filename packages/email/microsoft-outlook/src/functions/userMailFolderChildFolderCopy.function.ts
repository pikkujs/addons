...
export const UserMailFolderChildFolderCopyInput = z.object({
...
export const UserMailFolderChildFolderCopyOutput = z.object({
...
export const userMailFolderChildFolderCopy = pikkuSessionlessFunc({
  description: "Copy a mailfolder and its contents to another mailfolder.",
  input: UserMailFolderChildFolderCopyInput,
  output: UserMailFolderChildFolderCopyOutput,
  func: async ({ microsoftOutlook }, data) => {
    return microsoftOutlook.call("POST", "/users/{user-id}/mailFolders/{mailFolder-id}/childFolders/{mailFolder-id1}/microsoft.graph.copy", data) as any
  },
})
