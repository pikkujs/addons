...
export const UserCalendarEventDeclineInput = z.object({
...
export const userCalendarEventDecline = pikkuSessionlessFunc({
  ...
  input: UserCalendarEventDeclineInput,
  func: async ({ microsoftOutlook }, data) => {
    return microsoftOutlook.call("POST", "/users/{user-id}/calendar/events/{event-id}/microsoft.graph.decline", data)
  },
})
