...
export const UserMailFolderChildFolderMessageListExtensionInput = z.object({
...
export const UserMailFolderChildFolderMessageListExtensionOutput = z.object({
...
export const userMailFolderChildFolderMessageListExtension = pikkuSessionlessFunc({
  description: "The collection of open extensions defined for the message. Nullable.",
  input: UserMailFolderChildFolderMessageListExtensionInput,
  output: UserMailFolderChildFolderMessageListExtensionOutput,
  func: async ({ microsoftOutlook }, data) => {
    return microsoftOutlook.call("GET", "/users/{user-id}/mailFolders/{mailFolder-id}/childFolders/{mailFolder-id1}/messages/{message-id}/extensions", data) as any
  },
})
