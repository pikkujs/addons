...
export const UserEventListExtensionInput = z.object({
...
export const UserEventListExtensionOutput = z.object({
...
export const userEventListExtension = pikkuSessionlessFunc({
  description: "The collection of open extensions defined for the event. Nullable.",
  input: UserEventListExtensionInput,
  output: UserEventListExtensionOutput,
  func: async ({ microsoftOutlook }, data) => {
    return microsoftOutlook.call("GET", "/users/{user-id}/events/{event-id}/extensions", data) as any
  },
})
