...
export const GroupCalendarEventTentativelyAcceptInput = z.object({
...
export const groupCalendarEventTentativelyAccept = pikkuSessionlessFunc({
  ...
  input: GroupCalendarEventTentativelyAcceptInput,
  func: async ({ microsoftOutlook }, data) => {
    return microsoftOutlook.call("POST", "/groups/{group-id}/calendar/events/{event-id}/microsoft.graph.tentativelyAccept", data)
  },
})
