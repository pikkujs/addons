...
export const UserMailFolderChildFolderMessageReplyInput = z.object({
...
export const userMailFolderChildFolderMessageReply = pikkuSessionlessFunc({
  ...
  input: UserMailFolderChildFolderMessageReplyInput,
  func: async ({ microsoftOutlook }, data) => {
    return microsoftOutlook.call("POST", "/users/{user-id}/mailFolders/{mailFolder-id}/childFolders/{mailFolder-id1}/messages/{message-id}/microsoft.graph.reply", data)
  },
})
