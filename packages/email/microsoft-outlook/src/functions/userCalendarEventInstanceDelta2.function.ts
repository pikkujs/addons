...
export const UserCalendarEventInstanceDelta2Input = z.object({
...
export const UserCalendarEventInstanceDelta2Output = z.any()

export const userCalendarEventInstanceDelta2 = pikkuSessionlessFunc({
  ...
  input: UserCalendarEventInstanceDelta2Input,
  output: UserCalendarEventInstanceDelta2Output,
  func: async ({ microsoftOutlook }, data) => {
    return microsoftOutlook.call("GET", "/users/{user-id}/calendars/{calendar-id}/events/{event-id}/instances/microsoft.graph.delta()", data) as any
  },
})
