...
export const UserContactFolderCreateChildFolderInput = z.object({
...
export const UserContactFolderCreateChildFolderOutput = z.object({
  id: z.string().optional().describe("The unique identifier for an entity. Read-only."),
  displayName: z.string().nullable().optional().describe("The folder's display name."),
  parentFolderId: z.string().nullable().optional().describe("The ID of the folder's parent folder."),
  childFolders: z.array(z.object({
...
export const userContactFolderCreateChildFolder = pikkuSessionlessFunc({
  input: UserContactFolderCreateChildFolderInput,
  output: UserContactFolderCreateChildFolderOutput,
  func: async ({ microsoftOutlook }, data) => {
    return microsoftOutlook.call("POST", "/users/{user-id}/contactFolders/{contactFolder-id}/childFolders", data) as any
  },
})
