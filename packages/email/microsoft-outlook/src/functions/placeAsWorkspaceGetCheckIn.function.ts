...
export const PlaceAsWorkspaceGetCheckInInput = z.object({
...
export const PlaceAsWorkspaceGetCheckInOutput = z.object({
...
export const placeAsWorkspaceGetCheckIn = pikkuSessionlessFunc({
  ...
  input: PlaceAsWorkspaceGetCheckInInput,
  output: PlaceAsWorkspaceGetCheckInOutput,
  func: async ({ microsoftOutlook }, data) => {
    return microsoftOutlook.call("GET", "/places/{place-id}/microsoft.graph.workspace/checkIns/{checkInClaim-calendarEventId}", data) as any
  },
})
