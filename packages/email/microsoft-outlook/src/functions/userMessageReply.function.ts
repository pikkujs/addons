...
export const UserMessageReplyInput = z.object({
...
export const userMessageReply = pikkuSessionlessFunc({
  ...
  input: UserMessageReplyInput,
  func: async ({ microsoftOutlook }, data) => {
    return microsoftOutlook.call("POST", "/users/{user-id}/messages/{message-id}/microsoft.graph.reply", data)
  },
})
