...
export const GroupCalendarEventDeclineInput = z.object({
...
export const groupCalendarEventDecline = pikkuSessionlessFunc({
  ...
  input: GroupCalendarEventDeclineInput,
  func: async ({ microsoftOutlook }, data) => {
    return microsoftOutlook.call("POST", "/groups/{group-id}/calendar/events/{event-id}/microsoft.graph.decline", data)
  },
})
