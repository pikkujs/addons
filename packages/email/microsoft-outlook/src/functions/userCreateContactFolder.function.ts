...
export const UserCreateContactFolderInput = z.object({
...
export const UserCreateContactFolderOutput = z.object({
  id: z.string().optional().describe("The unique identifier for an entity. Read-only."),
  displayName: z.string().nullable().optional().describe("The folder's display name."),
  parentFolderId: z.string().nullable().optional().describe("The ID of the folder's parent folder."),
  childFolders: z.array(z.object({
...
export const userCreateContactFolder = pikkuSessionlessFunc({
  input: UserCreateContactFolderInput,
  output: UserCreateContactFolderOutput,
  func: async ({ microsoftOutlook }, data) => {
    return microsoftOutlook.call("POST", "/users/{user-id}/contactFolders", data) as any
  },
})
