...
export const GroupCalendarViewDeltaInput = z.object({
...
export const GroupCalendarViewDeltaOutput = z.any()

export const groupCalendarViewDelta = pikkuSessionlessFunc({
  ...
  input: GroupCalendarViewDeltaInput,
  output: GroupCalendarViewDeltaOutput,
  func: async ({ microsoftOutlook }, data) => {
    return microsoftOutlook.call("GET", "/groups/{group-id}/calendarView/microsoft.graph.delta()", data) as any
  },
})
