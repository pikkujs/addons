...
export const UserCalendarCalendarViewDelta2Input = z.object({
...
export const UserCalendarCalendarViewDelta2Output = z.any()

export const userCalendarCalendarViewDelta2 = pikkuSessionlessFunc({
  ...
  input: UserCalendarCalendarViewDelta2Input,
  output: UserCalendarCalendarViewDelta2Output,
  func: async ({ microsoftOutlook }, data) => {
    return microsoftOutlook.call("GET", "/users/{user-id}/calendars/{calendar-id}/calendarView/microsoft.graph.delta()", data) as any
  },
})
