...
export const PlaceAsBuildingMapLevelListSectionInput = z.object({
...
export const PlaceAsBuildingMapLevelListSectionOutput = z.object({
...
export const placeAsBuildingMapLevelListSection = pikkuSessionlessFunc({
  description: "Get a list of the sectionMap objects and their properties.",
  input: PlaceAsBuildingMapLevelListSectionInput,
  output: PlaceAsBuildingMapLevelListSectionOutput,
  func: async ({ microsoftOutlook }, data) => {
    return microsoftOutlook.call("GET", "/places/{place-id}/microsoft.graph.building/map/levels/{levelMap-id}/sections", data) as any
  },
})
