...
export const UserCalendarCalendarViewDeltaInput = z.object({
...
export const UserCalendarCalendarViewDeltaOutput = z.any()

export const userCalendarCalendarViewDelta = pikkuSessionlessFunc({
  ...
  input: UserCalendarCalendarViewDeltaInput,
  output: UserCalendarCalendarViewDeltaOutput,
  func: async ({ microsoftOutlook }, data) => {
    return microsoftOutlook.call("GET", "/users/{user-id}/calendar/calendarView/microsoft.graph.delta()", data) as any
  },
})
