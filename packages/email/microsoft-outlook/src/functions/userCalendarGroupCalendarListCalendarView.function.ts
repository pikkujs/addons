...
export const UserCalendarGroupCalendarListCalendarViewInput = z.object({
...
export const UserCalendarGroupCalendarListCalendarViewOutput = z.any()

export const userCalendarGroupCalendarListCalendarView = pikkuSessionlessFunc({
  description: "The calendar view for the calendar. Navigation property. Read-only.",
  input: UserCalendarGroupCalendarListCalendarViewInput,
  output: UserCalendarGroupCalendarListCalendarViewOutput,
  func: async ({ microsoftOutlook }, data) => {
    return microsoftOutlook.call("GET", "/users/{user-id}/calendarGroups/{calendarGroup-id}/calendars/{calendar-id}/calendarView", data) as any
  },
})
