...
export const GroupEventGetAttachmentInput = z.object({
...
export const GroupEventGetAttachmentOutput = z.object({
...
export const groupEventGetAttachment = pikkuSessionlessFunc({
  ...
  input: GroupEventGetAttachmentInput,
  output: GroupEventGetAttachmentOutput,
  func: async ({ microsoftOutlook }, data) => {
    return microsoftOutlook.call("GET", "/groups/{group-id}/events/{event-id}/attachments/{attachment-id}", data) as any
  },
})
