...
export const UserCalendarEventInstanceDeltaInput = z.object({
...
export const UserCalendarEventInstanceDeltaOutput = z.any()

export const userCalendarEventInstanceDelta = pikkuSessionlessFunc({
  ...
  input: UserCalendarEventInstanceDeltaInput,
  output: UserCalendarEventInstanceDeltaOutput,
  func: async ({ microsoftOutlook }, data) => {
    return microsoftOutlook.call("GET", "/users/{user-id}/calendar/events/{event-id}/instances/microsoft.graph.delta()", data) as any
  },
})
