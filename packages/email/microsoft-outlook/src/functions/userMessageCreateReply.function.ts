...
export const UserMessageCreateReplyInput = z.object({
...
export const UserMessageCreateReplyOutput = z.object({
  bccRecipients: z.array(z.object({
    emailAddress: z.object({
      address: z.string().nullable().optional().describe("The email address of the person or entity."),
      name: z.string().nullable().optional().describe("The display name of the person or entity."),
...
export const userMessageCreateReply = pikkuSessionlessFunc({
  ...
  input: UserMessageCreateReplyInput,
  output: UserMessageCreateReplyOutput,
  func: async ({ microsoftOutlook }, data) => {
    return microsoftOutlook.call("POST", "/users/{user-id}/messages/{message-id}/microsoft.graph.createReply", data) as any
  },
})
