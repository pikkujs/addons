...
export const UserMailFolderGetMessageInput = z.object({
...
export const UserMailFolderGetMessageOutput = z.object({
...
export const userMailFolderGetMessage = pikkuSessionlessFunc({
  description: "The collection of messages in the mailFolder.",
  input: UserMailFolderGetMessageInput,
  output: UserMailFolderGetMessageOutput,
  func: async ({ microsoftOutlook }, data) => {
    return microsoftOutlook.call("GET", "/users/{user-id}/mailFolders/{mailFolder-id}/messages/{message-id}", data) as any
  },
})
