...
export const UserCalendarEventDelta2Input = z.object({
...
export const UserCalendarEventDelta2Output = z.any()

export const userCalendarEventDelta2 = pikkuSessionlessFunc({
  ...
  input: UserCalendarEventDelta2Input,
  output: UserCalendarEventDelta2Output,
  func: async ({ microsoftOutlook }, data) => {
    return microsoftOutlook.call("GET", "/users/{user-id}/calendars/{calendar-id}/events/microsoft.graph.delta()", data) as any
  },
})
