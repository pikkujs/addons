...
export const UserGetContactInput = z.object({
...
export const UserGetContactOutput = z.object({
...
export const userGetContact = pikkuSessionlessFunc({
  description: "The user's contacts. Read-only. Nullable.",
  input: UserGetContactInput,
  output: UserGetContactOutput,
  func: async ({ microsoftOutlook }, data) => {
    return microsoftOutlook.call("GET", "/users/{user-id}/contacts/{contact-id}", data) as any
  },
})
