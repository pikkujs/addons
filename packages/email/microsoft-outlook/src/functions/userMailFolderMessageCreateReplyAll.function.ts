...
export const UserMailFolderMessageCreateReplyAllInput = z.object({
...
export const UserMailFolderMessageCreateReplyAllOutput = z.object({
  bccRecipients: z.array(z.object({
    emailAddress: z.object({
      address: z.string().nullable().optional().describe("The email address of the person or entity."),
      name: z.string().nullable().optional().describe("The display name of the person or entity."),
...
export const userMailFolderMessageCreateReplyAll = pikkuSessionlessFunc({
  ...
  input: UserMailFolderMessageCreateReplyAllInput,
  output: UserMailFolderMessageCreateReplyAllOutput,
  func: async ({ microsoftOutlook }, data) => {
    return microsoftOutlook.call("POST", "/users/{user-id}/mailFolders/{mailFolder-id}/messages/{message-id}/microsoft.graph.createReplyAll", data) as any
  },
})
