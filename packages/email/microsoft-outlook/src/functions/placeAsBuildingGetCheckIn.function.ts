...
export const PlaceAsBuildingGetCheckInInput = z.object({
...
export const PlaceAsBuildingGetCheckInOutput = z.object({
...
export const placeAsBuildingGetCheckIn = pikkuSessionlessFunc({
  ...
  input: PlaceAsBuildingGetCheckInInput,
  output: PlaceAsBuildingGetCheckInOutput,
  func: async ({ microsoftOutlook }, data) => {
    return microsoftOutlook.call("GET", "/places/{place-id}/microsoft.graph.building/checkIns/{checkInClaim-calendarEventId}", data) as any
  },
})
