...
export const UserCalendarViewDeltaInput = z.object({
...
export const UserCalendarViewDeltaOutput = z.any()

export const userCalendarViewDelta = pikkuSessionlessFunc({
  ...
  input: UserCalendarViewDeltaInput,
  output: UserCalendarViewDeltaOutput,
  func: async ({ microsoftOutlook }, data) => {
    return microsoftOutlook.call("GET", "/users/{user-id}/calendarView/microsoft.graph.delta()", data) as any
  },
})
