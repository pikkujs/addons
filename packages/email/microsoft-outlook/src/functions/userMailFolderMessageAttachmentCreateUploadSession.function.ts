...
export const UserMailFolderMessageAttachmentCreateUploadSessionInput = z.object({
...
export const UserMailFolderMessageAttachmentCreateUploadSessionOutput = z.object({
...
export const userMailFolderMessageAttachmentCreateUploadSession = pikkuSessionlessFunc({
  ...
  input: UserMailFolderMessageAttachmentCreateUploadSessionInput,
  output: UserMailFolderMessageAttachmentCreateUploadSessionOutput,
  func: async ({ microsoftOutlook }, data) => {
    return microsoftOutlook.call("POST", "/users/{user-id}/mailFolders/{mailFolder-id}/messages/{message-id}/attachments/microsoft.graph.createUploadSession", data) as any
  },
})
