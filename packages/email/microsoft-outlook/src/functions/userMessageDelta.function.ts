...
export const UserMessageDeltaInput = z.object({
...
export const UserMessageDeltaOutput = z.object({
...
export const userMessageDelta = pikkuSessionlessFunc({
  ...
  input: UserMessageDeltaInput,
  output: UserMessageDeltaOutput,
  func: async ({ microsoftOutlook }, data) => {
    return microsoftOutlook.call("GET", "/users/{user-id}/messages/microsoft.graph.delta()", data) as any
  },
})
