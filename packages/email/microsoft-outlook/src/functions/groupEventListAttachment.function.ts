...
export const GroupEventListAttachmentInput = z.object({
...
export const GroupEventListAttachmentOutput = z.object({
...
export const groupEventListAttachment = pikkuSessionlessFunc({
  ...
  input: GroupEventListAttachmentInput,
  output: GroupEventListAttachmentOutput,
  func: async ({ microsoftOutlook }, data) => {
    return microsoftOutlook.call("GET", "/groups/{group-id}/events/{event-id}/attachments", data) as any
  },
})
