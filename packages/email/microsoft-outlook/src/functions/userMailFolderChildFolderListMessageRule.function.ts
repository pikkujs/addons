...
export const UserMailFolderChildFolderListMessageRuleInput = z.object({
...
export const UserMailFolderChildFolderListMessageRuleOutput = z.object({
...
export const userMailFolderChildFolderListMessageRule = pikkuSessionlessFunc({
  description: "The collection of rules that apply to the user's Inbox folder.",
  input: UserMailFolderChildFolderListMessageRuleInput,
  output: UserMailFolderChildFolderListMessageRuleOutput,
  func: async ({ microsoftOutlook }, data) => {
    return microsoftOutlook.call("GET", "/users/{user-id}/mailFolders/{mailFolder-id}/childFolders/{mailFolder-id1}/messageRules", data) as any
  },
})
