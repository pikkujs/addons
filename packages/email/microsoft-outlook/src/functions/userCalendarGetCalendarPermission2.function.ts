...
export const UserCalendarGetCalendarPermission2Input = z.object({
...
export const UserCalendarGetCalendarPermission2Output = z.object({
...
export const userCalendarGetCalendarPermission2 = pikkuSessionlessFunc({
  description: "The permissions of the users with whom the calendar is shared.",
  input: UserCalendarGetCalendarPermission2Input,
  output: UserCalendarGetCalendarPermission2Output,
  func: async ({ microsoftOutlook }, data) => {
    return microsoftOutlook.call("GET", "/users/{user-id}/calendars/{calendar-id}/calendarPermissions/{calendarPermission-id}", data) as any
  },
})
