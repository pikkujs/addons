...
export const PlaceAsFloorGetCheckInInput = z.object({
...
export const PlaceAsFloorGetCheckInOutput = z.object({
...
export const placeAsFloorGetCheckIn = pikkuSessionlessFunc({
  ...
  input: PlaceAsFloorGetCheckInInput,
  output: PlaceAsFloorGetCheckInOutput,
  func: async ({ microsoftOutlook }, data) => {
    return microsoftOutlook.call("GET", "/places/{place-id}/microsoft.graph.floor/checkIns/{checkInClaim-calendarEventId}", data) as any
  },
})
