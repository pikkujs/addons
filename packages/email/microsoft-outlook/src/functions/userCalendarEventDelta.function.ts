...
export const UserCalendarEventDeltaInput = z.object({
...
export const UserCalendarEventDeltaOutput = z.any()

export const userCalendarEventDelta = pikkuSessionlessFunc({
  ...
  input: UserCalendarEventDeltaInput,
  output: UserCalendarEventDeltaOutput,
  func: async ({ microsoftOutlook }, data) => {
    return microsoftOutlook.call("GET", "/users/{user-id}/calendar/events/microsoft.graph.delta()", data) as any
  },
})
