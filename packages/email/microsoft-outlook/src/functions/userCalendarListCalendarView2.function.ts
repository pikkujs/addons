...
export const UserCalendarListCalendarView2Input = z.object({
...
export const UserCalendarListCalendarView2Output = z.any()

export const userCalendarListCalendarView2 = pikkuSessionlessFunc({
  description: "The calendar view for the calendar. Navigation property. Read-only.",
  input: UserCalendarListCalendarView2Input,
  output: UserCalendarListCalendarView2Output,
  func: async ({ microsoftOutlook }, data) => {
    return microsoftOutlook.call("GET", "/users/{user-id}/calendars/{calendar-id}/calendarView", data) as any
  },
})
