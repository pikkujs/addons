...
export const UserContactFolderDeltaInput = z.object({
...
export const UserContactFolderDeltaOutput = z.object({
...
export const userContactFolderDelta = pikkuSessionlessFunc({
  ...
  input: UserContactFolderDeltaInput,
  output: UserContactFolderDeltaOutput,
  func: async ({ microsoftOutlook }, data) => {
    return microsoftOutlook.call("GET", "/users/{user-id}/contactFolders/microsoft.graph.delta()", data) as any
  },
})
