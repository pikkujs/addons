...
export const UserMailFolderMessageForwardInput = z.object({
...
export const userMailFolderMessageForward = pikkuSessionlessFunc({
  ...
  input: UserMailFolderMessageForwardInput,
  func: async ({ microsoftOutlook }, data) => {
    return microsoftOutlook.call("POST", "/users/{user-id}/mailFolders/{mailFolder-id}/messages/{message-id}/microsoft.graph.forward", data)
  },
})
