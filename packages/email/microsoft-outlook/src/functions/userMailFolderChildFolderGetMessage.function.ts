...
export const UserMailFolderChildFolderGetMessageInput = z.object({
...
export const UserMailFolderChildFolderGetMessageOutput = z.object({
...
export const userMailFolderChildFolderGetMessage = pikkuSessionlessFunc({
  description: "The collection of messages in the mailFolder.",
  input: UserMailFolderChildFolderGetMessageInput,
  output: UserMailFolderChildFolderGetMessageOutput,
  func: async ({ microsoftOutlook }, data) => {
    return microsoftOutlook.call("GET", "/users/{user-id}/mailFolders/{mailFolder-id}/childFolders/{mailFolder-id1}/messages/{message-id}", data) as any
  },
})
