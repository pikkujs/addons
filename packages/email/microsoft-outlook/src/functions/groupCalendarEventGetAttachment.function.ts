...
export const GroupCalendarEventGetAttachmentInput = z.object({
...
export const GroupCalendarEventGetAttachmentOutput = z.object({
...
export const groupCalendarEventGetAttachment = pikkuSessionlessFunc({
  ...
  input: GroupCalendarEventGetAttachmentInput,
  output: GroupCalendarEventGetAttachmentOutput,
  func: async ({ microsoftOutlook }, data) => {
    return microsoftOutlook.call("GET", "/groups/{group-id}/calendar/events/{event-id}/attachments/{attachment-id}", data) as any
  },
})
