...
export const UserMessageReplyAllInput = z.object({
...
export const userMessageReplyAll = pikkuSessionlessFunc({
  ...
  input: UserMessageReplyAllInput,
  func: async ({ microsoftOutlook }, data) => {
    return microsoftOutlook.call("POST", "/users/{user-id}/messages/{message-id}/microsoft.graph.replyAll", data)
  },
})
