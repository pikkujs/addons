...
export const UserCalendarGroupCalendarEventListAttachmentInput = z.object({
...
export const UserCalendarGroupCalendarEventListAttachmentOutput = z.object({
...
export const userCalendarGroupCalendarEventListAttachment = pikkuSessionlessFunc({
  ...
  input: UserCalendarGroupCalendarEventListAttachmentInput,
  output: UserCalendarGroupCalendarEventListAttachmentOutput,
  func: async ({ microsoftOutlook }, data) => {
    return microsoftOutlook.call("GET", "/users/{user-id}/calendarGroups/{calendarGroup-id}/calendars/{calendar-id}/events/{event-id}/attachments", data) as any
  },
})
