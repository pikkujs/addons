...
export const GroupEventCancelInput = z.object({
  "group-id": z.string().describe("The unique identifier of group"),
  "event-id": z.string().describe("The unique identifier of event"),
  Comment: z.string().nullable().optional(),
})

export const groupEventCancel = pikkuSessionlessFunc({
  ...
  input: GroupEventCancelInput,
  func: async ({ microsoftOutlook }, data) => {
    return microsoftOutlook.call("POST", "/groups/{group-id}/events/{event-id}/microsoft.graph.cancel", data)
  },
})
