...
export const UserCalendarEventTentativelyAcceptInput = z.object({
...
export const userCalendarEventTentativelyAccept = pikkuSessionlessFunc({
  ...
  input: UserCalendarEventTentativelyAcceptInput,
  func: async ({ microsoftOutlook }, data) => {
    return microsoftOutlook.call("POST", "/users/{user-id}/calendar/events/{event-id}/microsoft.graph.tentativelyAccept", data)
  },
})
