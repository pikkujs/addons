...
export const UserCalendarEventListInstanceInput = z.object({
...
export const UserCalendarEventListInstanceOutput = z.any()

export const userCalendarEventListInstance = pikkuSessionlessFunc({
  ...
  input: UserCalendarEventListInstanceInput,
  output: UserCalendarEventListInstanceOutput,
  func: async ({ microsoftOutlook }, data) => {
    return microsoftOutlook.call("GET", "/users/{user-id}/calendar/events/{event-id}/instances", data) as any
  },
})
