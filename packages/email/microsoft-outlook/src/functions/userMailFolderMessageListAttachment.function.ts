...
export const UserMailFolderMessageListAttachmentInput = z.object({
...
export const UserMailFolderMessageListAttachmentOutput = z.object({
...
export const userMailFolderMessageListAttachment = pikkuSessionlessFunc({
  description: "The fileAttachment and itemAttachment attachments for the message.",
  input: UserMailFolderMessageListAttachmentInput,
  output: UserMailFolderMessageListAttachmentOutput,
  func: async ({ microsoftOutlook }, data) => {
    return microsoftOutlook.call("GET", "/users/{user-id}/mailFolders/{mailFolder-id}/messages/{message-id}/attachments", data) as any
  },
})
