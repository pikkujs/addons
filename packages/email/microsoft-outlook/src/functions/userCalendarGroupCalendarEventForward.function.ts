...
export const UserCalendarGroupCalendarEventForwardInput = z.object({
...
export const userCalendarGroupCalendarEventForward = pikkuSessionlessFunc({
  ...
  input: UserCalendarGroupCalendarEventForwardInput,
  func: async ({ microsoftOutlook }, data) => {
    return microsoftOutlook.call("POST", "/users/{user-id}/calendarGroups/{calendarGroup-id}/calendars/{calendar-id}/events/{event-id}/microsoft.graph.forward", data)
  },
})
