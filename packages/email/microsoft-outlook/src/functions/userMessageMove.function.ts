...
export const UserMessageMoveInput = z.object({
  "user-id": z.string().describe("The unique identifier of user"),
  "message-id": z.string().describe("The unique identifier of message"),
  DestinationId: z.string().optional(),
})

export const UserMessageMoveOutput = z.object({
...
export const userMessageMove = pikkuSessionlessFunc({
  ...
  input: UserMessageMoveInput,
  output: UserMessageMoveOutput,
  func: async ({ microsoftOutlook }, data) => {
    return microsoftOutlook.call("POST", "/users/{user-id}/messages/{message-id}/microsoft.graph.move", data) as any
  },
})
