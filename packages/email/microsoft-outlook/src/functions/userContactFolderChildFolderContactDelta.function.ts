...
export const UserContactFolderChildFolderContactDeltaInput = z.object({
...
export const UserContactFolderChildFolderContactDeltaOutput = z.object({
...
export const userContactFolderChildFolderContactDelta = pikkuSessionlessFunc({
  ...
  input: UserContactFolderChildFolderContactDeltaInput,
  output: UserContactFolderChildFolderContactDeltaOutput,
  func: async ({ microsoftOutlook }, data) => {
    return microsoftOutlook.call("GET", "/users/{user-id}/contactFolders/{contactFolder-id}/childFolders/{contactFolder-id1}/contacts/microsoft.graph.delta()", data) as any
  },
})
