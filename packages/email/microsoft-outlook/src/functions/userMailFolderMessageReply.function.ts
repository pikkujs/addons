...
export const UserMailFolderMessageReplyInput = z.object({
...
export const userMailFolderMessageReply = pikkuSessionlessFunc({
  ...
  input: UserMailFolderMessageReplyInput,
  func: async ({ microsoftOutlook }, data) => {
    return microsoftOutlook.call("POST", "/users/{user-id}/mailFolders/{mailFolder-id}/messages/{message-id}/microsoft.graph.reply", data)
  },
})
