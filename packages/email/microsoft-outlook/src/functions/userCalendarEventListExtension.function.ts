...
export const UserCalendarEventListExtensionInput = z.object({
...
export const UserCalendarEventListExtensionOutput = z.object({
...
export const userCalendarEventListExtension = pikkuSessionlessFunc({
  description: "The collection of open extensions defined for the event. Nullable.",
  input: UserCalendarEventListExtensionInput,
  output: UserCalendarEventListExtensionOutput,
  func: async ({ microsoftOutlook }, data) => {
    return microsoftOutlook.call("GET", "/users/{user-id}/calendar/events/{event-id}/extensions", data) as any
  },
})
