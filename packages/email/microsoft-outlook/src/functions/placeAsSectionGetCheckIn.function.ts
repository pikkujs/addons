...
export const PlaceAsSectionGetCheckInInput = z.object({
...
export const PlaceAsSectionGetCheckInOutput = z.object({
...
export const placeAsSectionGetCheckIn = pikkuSessionlessFunc({
  ...
  input: PlaceAsSectionGetCheckInInput,
  output: PlaceAsSectionGetCheckInOutput,
  func: async ({ microsoftOutlook }, data) => {
    return microsoftOutlook.call("GET", "/places/{place-id}/microsoft.graph.section/checkIns/{checkInClaim-calendarEventId}", data) as any
  },
})
