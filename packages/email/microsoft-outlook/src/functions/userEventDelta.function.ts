...
export const UserEventDeltaInput = z.object({
...
export const UserEventDeltaOutput = z.any()

export const userEventDelta = pikkuSessionlessFunc({
  ...
  input: UserEventDeltaInput,
  output: UserEventDeltaOutput,
  func: async ({ microsoftOutlook }, data) => {
    return microsoftOutlook.call("GET", "/users/{user-id}/events/microsoft.graph.delta()", data) as any
  },
})
