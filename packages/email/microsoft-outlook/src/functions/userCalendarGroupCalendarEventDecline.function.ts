...
export const UserCalendarGroupCalendarEventDeclineInput = z.object({
...
export const userCalendarGroupCalendarEventDecline = pikkuSessionlessFunc({
  ...
  input: UserCalendarGroupCalendarEventDeclineInput,
  func: async ({ microsoftOutlook }, data) => {
    return microsoftOutlook.call("POST", "/users/{user-id}/calendarGroups/{calendarGroup-id}/calendars/{calendar-id}/events/{event-id}/microsoft.graph.decline", data)
  },
})
