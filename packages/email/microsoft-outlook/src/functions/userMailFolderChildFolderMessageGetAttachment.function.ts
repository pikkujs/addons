...
export const UserMailFolderChildFolderMessageGetAttachmentInput = z.object({
...
export const UserMailFolderChildFolderMessageGetAttachmentOutput = z.object({
...
export const userMailFolderChildFolderMessageGetAttachment = pikkuSessionlessFunc({
  description: "The fileAttachment and itemAttachment attachments for the message.",
  input: UserMailFolderChildFolderMessageGetAttachmentInput,
  output: UserMailFolderChildFolderMessageGetAttachmentOutput,
  func: async ({ microsoftOutlook }, data) => {
    return microsoftOutlook.call("GET", "/users/{user-id}/mailFolders/{mailFolder-id}/childFolders/{mailFolder-id1}/messages/{message-id}/attachments/{attachment-id}", data) as any
  },
})
