...
export const GroupCalendarEventCancelInput = z.object({
  "group-id": z.string().describe("The unique identifier of group"),
  "event-id": z.string().describe("The unique identifier of event"),
  Comment: z.string().nullable().optional(),
})

export const groupCalendarEventCancel = pikkuSessionlessFunc({
  ...
  input: GroupCalendarEventCancelInput,
  func: async ({ microsoftOutlook }, data) => {
    return microsoftOutlook.call("POST", "/groups/{group-id}/calendar/events/{event-id}/microsoft.graph.cancel", data)
  },
})
