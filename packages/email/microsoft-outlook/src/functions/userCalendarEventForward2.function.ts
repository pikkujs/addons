...
export const UserCalendarEventForward2Input = z.object({
...
export const userCalendarEventForward2 = pikkuSessionlessFunc({
  ...
  input: UserCalendarEventForward2Input,
  func: async ({ microsoftOutlook }, data) => {
    return microsoftOutlook.call("POST", "/users/{user-id}/calendars/{calendar-id}/events/{event-id}/microsoft.graph.forward", data)
  },
})
