...
export const UserMailFolderChildFolderMessageCreateForwardInput = z.object({
...
export const UserMailFolderChildFolderMessageCreateForwardOutput = z.object({
  bccRecipients: z.array(z.object({
    emailAddress: z.object({
      address: z.string().nullable().optional().describe("The email address of the person or entity."),
      name: z.string().nullable().optional().describe("The display name of the person or entity."),
...
export const userMailFolderChildFolderMessageCreateForward = pikkuSessionlessFunc({
  input: UserMailFolderChildFolderMessageCreateForwardInput,
  output: UserMailFolderChildFolderMessageCreateForwardOutput,
  func: async ({ microsoftOutlook }, data) => {
    return microsoftOutlook.call("POST", "/users/{user-id}/mailFolders/{mailFolder-id}/childFolders/{mailFolder-id1}/messages/{message-id}/microsoft.graph.createForward", data) as any
  },
})
