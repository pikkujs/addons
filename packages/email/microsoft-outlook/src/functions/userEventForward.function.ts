...
export const UserEventForwardInput = z.object({
...
export const userEventForward = pikkuSessionlessFunc({
  ...
  input: UserEventForwardInput,
  func: async ({ microsoftOutlook }, data) => {
    return microsoftOutlook.call("POST", "/users/{user-id}/events/{event-id}/microsoft.graph.forward", data)
  },
})
