...
export const PlaceAsRoomGetCheckInInput = z.object({
...
export const PlaceAsRoomGetCheckInOutput = z.object({
...
export const placeAsRoomGetCheckIn = pikkuSessionlessFunc({
  ...
  input: PlaceAsRoomGetCheckInInput,
  output: PlaceAsRoomGetCheckInOutput,
  func: async ({ microsoftOutlook }, data) => {
    return microsoftOutlook.call("GET", "/places/{place-id}/microsoft.graph.room/checkIns/{checkInClaim-calendarEventId}", data) as any
  },
})
