...
export const GroupCalendarEventDeltaInput = z.object({
...
export const GroupCalendarEventDeltaOutput = z.any()

export const groupCalendarEventDelta = pikkuSessionlessFunc({
  ...
  input: GroupCalendarEventDeltaInput,
  output: GroupCalendarEventDeltaOutput,
  func: async ({ microsoftOutlook }, data) => {
    return microsoftOutlook.call("GET", "/groups/{group-id}/calendar/events/microsoft.graph.delta()", data) as any
  },
})
