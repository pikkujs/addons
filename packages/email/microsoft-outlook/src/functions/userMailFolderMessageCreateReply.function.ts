...
export const UserMailFolderMessageCreateReplyInput = z.object({
...
export const UserMailFolderMessageCreateReplyOutput = z.object({
  bccRecipients: z.array(z.object({
    emailAddress: z.object({
      address: z.string().nullable().optional().describe("The email address of the person or entity."),
      name: z.string().nullable().optional().describe("The display name of the person or entity."),
...
export const userMailFolderMessageCreateReply = pikkuSessionlessFunc({
  ...
  input: UserMailFolderMessageCreateReplyInput,
  output: UserMailFolderMessageCreateReplyOutput,
  func: async ({ microsoftOutlook }, data) => {
    return microsoftOutlook.call("POST", "/users/{user-id}/mailFolders/{mailFolder-id}/messages/{message-id}/microsoft.graph.createReply", data) as any
  },
})
