...
export const UserMessageCopyInput = z.object({
  "user-id": z.string().describe("The unique identifier of user"),
  "message-id": z.string().describe("The unique identifier of message"),
  DestinationId: z.string().optional(),
})

export const UserMessageCopyOutput = z.object({
...
export const userMessageCopy = pikkuSessionlessFunc({
  description: "Copy a message to a folder within the user's mailbox.",
  input: UserMessageCopyInput,
  output: UserMessageCopyOutput,
  func: async ({ microsoftOutlook }, data) => {
    return microsoftOutlook.call("POST", "/users/{user-id}/messages/{message-id}/microsoft.graph.copy", data) as any
  },
})
