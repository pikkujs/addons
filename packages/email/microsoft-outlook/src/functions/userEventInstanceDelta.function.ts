...
export const UserEventInstanceDeltaInput = z.object({
...
export const UserEventInstanceDeltaOutput = z.any()

export const userEventInstanceDelta = pikkuSessionlessFunc({
  ...
  input: UserEventInstanceDeltaInput,
  output: UserEventInstanceDeltaOutput,
  func: async ({ microsoftOutlook }, data) => {
    return microsoftOutlook.call("GET", "/users/{user-id}/events/{event-id}/instances/microsoft.graph.delta()", data) as any
  },
})
