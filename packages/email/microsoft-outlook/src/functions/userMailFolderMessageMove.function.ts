...
export const UserMailFolderMessageMoveInput = z.object({
...
export const UserMailFolderMessageMoveOutput = z.object({
...
export const userMailFolderMessageMove = pikkuSessionlessFunc({
  ...
  input: UserMailFolderMessageMoveInput,
  output: UserMailFolderMessageMoveOutput,
  func: async ({ microsoftOutlook }, data) => {
    return microsoftOutlook.call("POST", "/users/{user-id}/mailFolders/{mailFolder-id}/messages/{message-id}/microsoft.graph.move", data) as any
  },
})
