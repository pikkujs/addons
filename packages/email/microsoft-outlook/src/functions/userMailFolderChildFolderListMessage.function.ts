...
export const UserMailFolderChildFolderListMessageInput = z.object({
...
export const UserMailFolderChildFolderListMessageOutput = z.object({
...
export const userMailFolderChildFolderListMessage = pikkuSessionlessFunc({
  description: "The collection of messages in the mailFolder.",
  input: UserMailFolderChildFolderListMessageInput,
  output: UserMailFolderChildFolderListMessageOutput,
  func: async ({ microsoftOutlook }, data) => {
    return microsoftOutlook.call("GET", "/users/{user-id}/mailFolders/{mailFolder-id}/childFolders/{mailFolder-id1}/messages", data) as any
  },
})
