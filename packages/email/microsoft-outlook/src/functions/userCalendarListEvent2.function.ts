...
export const UserCalendarListEvent2Input = z.object({
...
export const UserCalendarListEvent2Output = z.any()

export const userCalendarListEvent2 = pikkuSessionlessFunc({
  description: "The events in the calendar. Navigation property. Read-only.",
  input: UserCalendarListEvent2Input,
  output: UserCalendarListEvent2Output,
  func: async ({ microsoftOutlook }, data) => {
    return microsoftOutlook.call("GET", "/users/{user-id}/calendars/{calendar-id}/events", data) as any
  },
})
