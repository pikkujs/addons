...
export const UserCalendarGroupCalendarGetCalendarPermissionInput = z.object({
...
export const UserCalendarGroupCalendarGetCalendarPermissionOutput = z.object({
...
export const userCalendarGroupCalendarGetCalendarPermission = pikkuSessionlessFunc({
  description: "The permissions of the users with whom the calendar is shared.",
  input: UserCalendarGroupCalendarGetCalendarPermissionInput,
  output: UserCalendarGroupCalendarGetCalendarPermissionOutput,
  func: async ({ microsoftOutlook }, data) => {
    return microsoftOutlook.call("GET", "/users/{user-id}/calendarGroups/{calendarGroup-id}/calendars/{calendar-id}/calendarPermissions/{calendarPermission-id}", data) as any
  },
})
