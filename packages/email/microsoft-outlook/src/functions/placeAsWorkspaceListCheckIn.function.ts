...
export const PlaceAsWorkspaceListCheckInInput = z.object({
...
export const PlaceAsWorkspaceListCheckInOutput = z.object({
...
export const placeAsWorkspaceListCheckIn = pikkuSessionlessFunc({
  ...
  input: PlaceAsWorkspaceListCheckInInput,
  output: PlaceAsWorkspaceListCheckInOutput,
  func: async ({ microsoftOutlook }, data) => {
    return microsoftOutlook.call("GET", "/places/{place-id}/microsoft.graph.workspace/checkIns", data) as any
  },
})
