...
export const UserCalendarEventDecline2Input = z.object({
...
export const userCalendarEventDecline2 = pikkuSessionlessFunc({
  ...
  input: UserCalendarEventDecline2Input,
  func: async ({ microsoftOutlook }, data) => {
    return microsoftOutlook.call("POST", "/users/{user-id}/calendars/{calendar-id}/events/{event-id}/microsoft.graph.decline", data)
  },
})
