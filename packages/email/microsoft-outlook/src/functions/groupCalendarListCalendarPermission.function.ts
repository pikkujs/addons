...
export const GroupCalendarListCalendarPermissionInput = z.object({
...
export const GroupCalendarListCalendarPermissionOutput = z.object({
...
export const groupCalendarListCalendarPermission = pikkuSessionlessFunc({
  description: "The permissions of the users with whom the calendar is shared.",
  input: GroupCalendarListCalendarPermissionInput,
  output: GroupCalendarListCalendarPermissionOutput,
  func: async ({ microsoftOutlook }, data) => {
    return microsoftOutlook.call("GET", "/groups/{group-id}/calendar/calendarPermissions", data) as any
  },
})
