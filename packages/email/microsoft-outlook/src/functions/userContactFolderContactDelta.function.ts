...
export const UserContactFolderContactDeltaInput = z.object({
...
export const UserContactFolderContactDeltaOutput = z.object({
...
export const userContactFolderContactDelta = pikkuSessionlessFunc({
  ...
  input: UserContactFolderContactDeltaInput,
  output: UserContactFolderContactDeltaOutput,
  func: async ({ microsoftOutlook }, data) => {
    return microsoftOutlook.call("GET", "/users/{user-id}/contactFolders/{contactFolder-id}/contacts/microsoft.graph.delta()", data) as any
  },
})
