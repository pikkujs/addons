...
export const PlaceAsRoomListGetCheckInInput = z.object({
...
export const PlaceAsRoomListGetCheckInOutput = z.object({
...
export const placeAsRoomListGetCheckIn = pikkuSessionlessFunc({
  ...
  input: PlaceAsRoomListGetCheckInInput,
  output: PlaceAsRoomListGetCheckInOutput,
  func: async ({ microsoftOutlook }, data) => {
    return microsoftOutlook.call("GET", "/places/{place-id}/microsoft.graph.roomList/checkIns/{checkInClaim-calendarEventId}", data) as any
  },
})
