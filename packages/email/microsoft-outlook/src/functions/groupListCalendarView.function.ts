...
export const GroupListCalendarViewInput = z.object({
...
export const GroupListCalendarViewOutput = z.any()

export const groupListCalendarView = pikkuSessionlessFunc({
  ...
  input: GroupListCalendarViewInput,
  output: GroupListCalendarViewOutput,
  func: async ({ microsoftOutlook }, data) => {
    return microsoftOutlook.call("GET", "/groups/{group-id}/calendarView", data) as any
  },
})
