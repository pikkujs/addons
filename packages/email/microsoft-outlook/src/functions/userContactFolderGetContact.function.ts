...
export const UserContactFolderGetContactInput = z.object({
...
export const UserContactFolderGetContactOutput = z.object({
...
export const userContactFolderGetContact = pikkuSessionlessFunc({
  description: "The contacts in the folder. Navigation property. Read-only. Nullable.",
  input: UserContactFolderGetContactInput,
  output: UserContactFolderGetContactOutput,
  func: async ({ microsoftOutlook }, data) => {
    return microsoftOutlook.call("GET", "/users/{user-id}/contactFolders/{contactFolder-id}/contacts/{contact-id}", data) as any
  },
})
