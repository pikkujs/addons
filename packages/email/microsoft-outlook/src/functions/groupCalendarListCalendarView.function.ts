...
export const GroupCalendarListCalendarViewInput = z.object({
...
export const GroupCalendarListCalendarViewOutput = z.any()

export const groupCalendarListCalendarView = pikkuSessionlessFunc({
  description: "The calendar view for the calendar. Navigation property. Read-only.",
  input: GroupCalendarListCalendarViewInput,
  output: GroupCalendarListCalendarViewOutput,
  func: async ({ microsoftOutlook }, data) => {
    return microsoftOutlook.call("GET", "/groups/{group-id}/calendar/calendarView", data) as any
  },
})
