...
export const UserMailFolderMessageCreateForwardInput = z.object({
...
export const UserMailFolderMessageCreateForwardOutput = z.object({
  bccRecipients: z.array(z.object({
    emailAddress: z.object({
      address: z.string().nullable().optional().describe("The email address of the person or entity."),
      name: z.string().nullable().optional().describe("The display name of the person or entity."),
...
export const userMailFolderMessageCreateForward = pikkuSessionlessFunc({
  input: UserMailFolderMessageCreateForwardInput,
  output: UserMailFolderMessageCreateForwardOutput,
  func: async ({ microsoftOutlook }, data) => {
    return microsoftOutlook.call("POST", "/users/{user-id}/mailFolders/{mailFolder-id}/messages/{message-id}/microsoft.graph.createForward", data) as any
  },
})
