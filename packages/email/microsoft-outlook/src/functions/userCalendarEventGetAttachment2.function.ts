...
export const UserCalendarEventGetAttachment2Input = z.object({
...
export const UserCalendarEventGetAttachment2Output = z.object({
...
export const userCalendarEventGetAttachment2 = pikkuSessionlessFunc({
  ...
  input: UserCalendarEventGetAttachment2Input,
  output: UserCalendarEventGetAttachment2Output,
  func: async ({ microsoftOutlook }, data) => {
    return microsoftOutlook.call("GET", "/users/{user-id}/calendars/{calendar-id}/events/{event-id}/attachments/{attachment-id}", data) as any
  },
})
