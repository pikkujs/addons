...
export const UserMailFolderChildFolderUpdateMessageInput = z.object({
...
export const UserMailFolderChildFolderUpdateMessageOutput = z.object({
  bccRecipients: z.array(z.object({
    emailAddress: z.object({
      address: z.string().nullable().optional().describe("The email address of the person or entity."),
      name: z.string().nullable().optional().describe("The display name of the person or entity."),
...
export const userMailFolderChildFolderUpdateMessage = pikkuSessionlessFunc({
  input: UserMailFolderChildFolderUpdateMessageInput,
  output: UserMailFolderChildFolderUpdateMessageOutput,
  func: async ({ microsoftOutlook }, data) => {
    return microsoftOutlook.call("PATCH", "/users/{user-id}/mailFolders/{mailFolder-id}/childFolders/{mailFolder-id1}/messages/{message-id}", data) as any
  },
})
