...
export const GroupCalendarEventAttachmentCreateUploadSessionInput = z.object({
...
export const GroupCalendarEventAttachmentCreateUploadSessionOutput = z.object({
...
export const groupCalendarEventAttachmentCreateUploadSession = pikkuSessionlessFunc({
  ...
  input: GroupCalendarEventAttachmentCreateUploadSessionInput,
  output: GroupCalendarEventAttachmentCreateUploadSessionOutput,
  func: async ({ microsoftOutlook }, data) => {
    return microsoftOutlook.call("POST", "/groups/{group-id}/calendar/events/{event-id}/attachments/microsoft.graph.createUploadSession", data) as any
  },
})
