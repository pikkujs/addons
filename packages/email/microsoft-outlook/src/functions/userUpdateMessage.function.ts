...
export const UserUpdateMessageInput = z.object({
...
export const UserUpdateMessageOutput = z.object({
  bccRecipients: z.array(z.object({
    emailAddress: z.object({
      address: z.string().nullable().optional().describe("The email address of the person or entity."),
      name: z.string().nullable().optional().describe("The display name of the person or entity."),
...
export const userUpdateMessage = pikkuSessionlessFunc({
  input: UserUpdateMessageInput,
  output: UserUpdateMessageOutput,
  func: async ({ microsoftOutlook }, data) => {
    return microsoftOutlook.call("PATCH", "/users/{user-id}/messages/{message-id}", data) as any
  },
})
