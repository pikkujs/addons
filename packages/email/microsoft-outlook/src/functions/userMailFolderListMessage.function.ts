...
export const UserMailFolderListMessageInput = z.object({
...
export const UserMailFolderListMessageOutput = z.object({
...
export const userMailFolderListMessage = pikkuSessionlessFunc({
  description: "The collection of messages in the mailFolder.",
  input: UserMailFolderListMessageInput,
  output: UserMailFolderListMessageOutput,
  func: async ({ microsoftOutlook }, data) => {
    return microsoftOutlook.call("GET", "/users/{user-id}/mailFolders/{mailFolder-id}/messages", data) as any
  },
})
