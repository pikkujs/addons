...
export const UserContactFolderChildFolderGetContactInput = z.object({
...
export const UserContactFolderChildFolderGetContactOutput = z.object({
...
export const userContactFolderChildFolderGetContact = pikkuSessionlessFunc({
  description: "The contacts in the folder. Navigation property. Read-only. Nullable.",
  input: UserContactFolderChildFolderGetContactInput,
  output: UserContactFolderChildFolderGetContactOutput,
  func: async ({ microsoftOutlook }, data) => {
    return microsoftOutlook.call("GET", "/users/{user-id}/contactFolders/{contactFolder-id}/childFolders/{contactFolder-id1}/contacts/{contact-id}", data) as any
  },
})
