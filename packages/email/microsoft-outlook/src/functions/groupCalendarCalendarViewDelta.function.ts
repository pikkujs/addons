...
export const GroupCalendarCalendarViewDeltaInput = z.object({
...
export const GroupCalendarCalendarViewDeltaOutput = z.any()

export const groupCalendarCalendarViewDelta = pikkuSessionlessFunc({
  ...
  input: GroupCalendarCalendarViewDeltaInput,
  output: GroupCalendarCalendarViewDeltaOutput,
  func: async ({ microsoftOutlook }, data) => {
    return microsoftOutlook.call("GET", "/groups/{group-id}/calendar/calendarView/microsoft.graph.delta()", data) as any
  },
})
