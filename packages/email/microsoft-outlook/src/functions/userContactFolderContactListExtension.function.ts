...
export const UserContactFolderContactListExtensionInput = z.object({
...
export const UserContactFolderContactListExtensionOutput = z.object({
...
export const userContactFolderContactListExtension = pikkuSessionlessFunc({
  description: "The collection of open extensions defined for the contact. Read-only. Nullable.",
  input: UserContactFolderContactListExtensionInput,
  output: UserContactFolderContactListExtensionOutput,
  func: async ({ microsoftOutlook }, data) => {
    return microsoftOutlook.call("GET", "/users/{user-id}/contactFolders/{contactFolder-id}/contacts/{contact-id}/extensions", data) as any
  },
})
