...
export const UserCalendarGetSchedule2Input = z.object({
...
export const UserCalendarGetSchedule2Output = z.object({
...
export const userCalendarGetSchedule2 = pikkuSessionlessFunc({
  ...
  input: UserCalendarGetSchedule2Input,
  output: UserCalendarGetSchedule2Output,
  func: async ({ microsoftOutlook }, data) => {
    return microsoftOutlook.call("POST", "/users/{user-id}/calendars/{calendar-id}/microsoft.graph.getSchedule", data) as any
  },
})
