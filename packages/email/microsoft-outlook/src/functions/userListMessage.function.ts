...
export const UserListMessageInput = z.object({
...
export const UserListMessageOutput = z.object({
...
export const userListMessage = pikkuSessionlessFunc({
  description: "The messages in a mailbox or folder. Read-only. Nullable.",
  input: UserListMessageInput,
  output: UserListMessageOutput,
  func: async ({ microsoftOutlook }, data) => {
    return microsoftOutlook.call("GET", "/users/{user-id}/messages", data) as any
  },
})
