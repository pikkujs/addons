...
export const UserMessageCreateForwardInput = z.object({
...
export const UserMessageCreateForwardOutput = z.object({
  bccRecipients: z.array(z.object({
    emailAddress: z.object({
      address: z.string().nullable().optional().describe("The email address of the person or entity."),
      name: z.string().nullable().optional().describe("The display name of the person or entity."),
...
export const userMessageCreateForward = pikkuSessionlessFunc({
  input: UserMessageCreateForwardInput,
  output: UserMessageCreateForwardOutput,
  func: async ({ microsoftOutlook }, data) => {
    return microsoftOutlook.call("POST", "/users/{user-id}/messages/{message-id}/microsoft.graph.createForward", data) as any
  },
})
