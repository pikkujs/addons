...
export const UserMailFolderMessageCopyInput = z.object({
...
export const UserMailFolderMessageCopyOutput = z.object({
...
export const userMailFolderMessageCopy = pikkuSessionlessFunc({
  description: "Copy a message to a folder within the user's mailbox.",
  input: UserMailFolderMessageCopyInput,
  output: UserMailFolderMessageCopyOutput,
  func: async ({ microsoftOutlook }, data) => {
    return microsoftOutlook.call("POST", "/users/{user-id}/mailFolders/{mailFolder-id}/messages/{message-id}/microsoft.graph.copy", data) as any
  },
})
