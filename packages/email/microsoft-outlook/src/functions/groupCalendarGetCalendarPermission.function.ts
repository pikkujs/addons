...
export const GroupCalendarGetCalendarPermissionInput = z.object({
...
export const GroupCalendarGetCalendarPermissionOutput = z.object({
...
export const groupCalendarGetCalendarPermission = pikkuSessionlessFunc({
  description: "The permissions of the users with whom the calendar is shared.",
  input: GroupCalendarGetCalendarPermissionInput,
  output: GroupCalendarGetCalendarPermissionOutput,
  func: async ({ microsoftOutlook }, data) => {
    return microsoftOutlook.call("GET", "/groups/{group-id}/calendar/calendarPermissions/{calendarPermission-id}", data) as any
  },
})
