...
export const UserCalendarEventListAttachment2Input = z.object({
...
export const UserCalendarEventListAttachment2Output = z.object({
...
export const userCalendarEventListAttachment2 = pikkuSessionlessFunc({
  ...
  input: UserCalendarEventListAttachment2Input,
  output: UserCalendarEventListAttachment2Output,
  func: async ({ microsoftOutlook }, data) => {
    return microsoftOutlook.call("GET", "/users/{user-id}/calendars/{calendar-id}/events/{event-id}/attachments", data) as any
  },
})
