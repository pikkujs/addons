...
export const UserCalendarEventCancelInput = z.object({
  "user-id": z.string().describe("The unique identifier of user"),
  "event-id": z.string().describe("The unique identifier of event"),
  Comment: z.string().nullable().optional(),
})

export const userCalendarEventCancel = pikkuSessionlessFunc({
  ...
  input: UserCalendarEventCancelInput,
  func: async ({ microsoftOutlook }, data) => {
    return microsoftOutlook.call("POST", "/users/{user-id}/calendar/events/{event-id}/microsoft.graph.cancel", data)
  },
})
