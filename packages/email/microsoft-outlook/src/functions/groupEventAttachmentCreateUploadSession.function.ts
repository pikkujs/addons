...
export const GroupEventAttachmentCreateUploadSessionInput = z.object({
...
export const GroupEventAttachmentCreateUploadSessionOutput = z.object({
...
export const groupEventAttachmentCreateUploadSession = pikkuSessionlessFunc({
  ...
  input: GroupEventAttachmentCreateUploadSessionInput,
  output: GroupEventAttachmentCreateUploadSessionOutput,
  func: async ({ microsoftOutlook }, data) => {
    return microsoftOutlook.call("POST", "/groups/{group-id}/events/{event-id}/attachments/microsoft.graph.createUploadSession", data) as any
  },
})
