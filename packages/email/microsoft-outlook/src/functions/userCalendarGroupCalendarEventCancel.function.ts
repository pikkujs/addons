...
export const UserCalendarGroupCalendarEventCancelInput = z.object({
...
export const userCalendarGroupCalendarEventCancel = pikkuSessionlessFunc({
  ...
  input: UserCalendarGroupCalendarEventCancelInput,
  func: async ({ microsoftOutlook }, data) => {
    return microsoftOutlook.call("POST", "/users/{user-id}/calendarGroups/{calendarGroup-id}/calendars/{calendar-id}/events/{event-id}/microsoft.graph.cancel", data)
  },
})
