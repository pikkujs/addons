...
export const UserUpdateContactFolderInput = z.object({
...
export const UserUpdateContactFolderOutput = z.object({
  id: z.string().optional().describe("The unique identifier for an entity. Read-only."),
  displayName: z.string().nullable().optional().describe("The folder's display name."),
  parentFolderId: z.string().nullable().optional().describe("The ID of the folder's parent folder."),
  childFolders: z.array(z.object({
...
export const userUpdateContactFolder = pikkuSessionlessFunc({
  input: UserUpdateContactFolderInput,
  output: UserUpdateContactFolderOutput,
  func: async ({ microsoftOutlook }, data) => {
    return microsoftOutlook.call("PATCH", "/users/{user-id}/contactFolders/{contactFolder-id}", data) as any
  },
})
