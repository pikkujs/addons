...
export const UserEventListAttachmentInput = z.object({
...
export const UserEventListAttachmentOutput = z.object({
...
export const userEventListAttachment = pikkuSessionlessFunc({
  ...
  input: UserEventListAttachmentInput,
  output: UserEventListAttachmentOutput,
  func: async ({ microsoftOutlook }, data) => {
    return microsoftOutlook.call("GET", "/users/{user-id}/events/{event-id}/attachments", data) as any
  },
})
