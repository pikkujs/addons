...
export const UserMailFolderChildFolderMessageMoveInput = z.object({
...
export const UserMailFolderChildFolderMessageMoveOutput = z.object({
...
export const userMailFolderChildFolderMessageMove = pikkuSessionlessFunc({
  ...
  input: UserMailFolderChildFolderMessageMoveInput,
  output: UserMailFolderChildFolderMessageMoveOutput,
  func: async ({ microsoftOutlook }, data) => {
    return microsoftOutlook.call("POST", "/users/{user-id}/mailFolders/{mailFolder-id}/childFolders/{mailFolder-id1}/messages/{message-id}/microsoft.graph.move", data) as any
  },
})
