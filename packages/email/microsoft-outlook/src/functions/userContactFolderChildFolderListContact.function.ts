...
export const UserContactFolderChildFolderListContactInput = z.object({
...
export const UserContactFolderChildFolderListContactOutput = z.object({
...
export const userContactFolderChildFolderListContact = pikkuSessionlessFunc({
  description: "The contacts in the folder. Navigation property. Read-only. Nullable.",
  input: UserContactFolderChildFolderListContactInput,
  output: UserContactFolderChildFolderListContactOutput,
  func: async ({ microsoftOutlook }, data) => {
    return microsoftOutlook.call("GET", "/users/{user-id}/contactFolders/{contactFolder-id}/childFolders/{contactFolder-id1}/contacts", data) as any
  },
})
