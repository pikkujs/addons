...
export const UserMailFolderMessageGetAttachmentInput = z.object({
...
export const UserMailFolderMessageGetAttachmentOutput = z.object({
...
export const userMailFolderMessageGetAttachment = pikkuSessionlessFunc({
  description: "The fileAttachment and itemAttachment attachments for the message.",
  input: UserMailFolderMessageGetAttachmentInput,
  output: UserMailFolderMessageGetAttachmentOutput,
  func: async ({ microsoftOutlook }, data) => {
    return microsoftOutlook.call("GET", "/users/{user-id}/mailFolders/{mailFolder-id}/messages/{message-id}/attachments/{attachment-id}", data) as any
  },
})
