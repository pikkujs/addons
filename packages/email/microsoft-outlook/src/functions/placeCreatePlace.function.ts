...
export const PlaceCreatePlaceInput = z.object({
  body: z.object({
...
export const PlaceCreatePlaceOutput = z.object({
  id: z.string().optional().describe("The unique identifier for an entity. Read-only."),
  address: z.object({
    city: z.string().nullable().optional().describe("The city."),
    countryOrRegion: z.string().nullable().optional().describe("The country or region. It's a free-format string value, for example, 'United States'."),
...
export const placeCreatePlace = pikkuSessionlessFunc({
  description: "Create a new place object. You can also use this method to create the following child object types: building, floor, section, room, workspace, or desk.",
  input: PlaceCreatePlaceInput,
  output: PlaceCreatePlaceOutput,
  func: async ({ microsoftOutlook }, data) => {
    return microsoftOutlook.call("POST", "/places", data) as any
  },
})
