...
export const UserMailFolderChildFolderMessageReplyAllInput = z.object({
...
export const userMailFolderChildFolderMessageReplyAll = pikkuSessionlessFunc({
  ...
  input: UserMailFolderChildFolderMessageReplyAllInput,
  func: async ({ microsoftOutlook }, data) => {
    return microsoftOutlook.call("POST", "/users/{user-id}/mailFolders/{mailFolder-id}/childFolders/{mailFolder-id1}/messages/{message-id}/microsoft.graph.replyAll", data)
  },
})
