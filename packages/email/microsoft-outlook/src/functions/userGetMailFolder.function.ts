...
export const UserGetMailFolderInput = z.object({
...
export const UserGetMailFolderOutput = z.object({
...
export const userGetMailFolder = pikkuSessionlessFunc({
  description: "The user's mail folders. Read-only. Nullable.",
  input: UserGetMailFolderInput,
  output: UserGetMailFolderOutput,
  func: async ({ microsoftOutlook }, data) => {
    return microsoftOutlook.call("GET", "/users/{user-id}/mailFolders/{mailFolder-id}", data) as any
  },
})
