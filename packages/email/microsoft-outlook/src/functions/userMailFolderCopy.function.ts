...
export const UserMailFolderCopyInput = z.object({
  "user-id": z.string().describe("The unique identifier of user"),
  "mailFolder-id": z.string().describe("The unique identifier of mailFolder"),
  DestinationId: z.string().optional(),
})

export const UserMailFolderCopyOutput = z.object({
...
export const userMailFolderCopy = pikkuSessionlessFunc({
  description: "Copy a mailfolder and its contents to another mailfolder.",
  input: UserMailFolderCopyInput,
  output: UserMailFolderCopyOutput,
  func: async ({ microsoftOutlook }, data) => {
    return microsoftOutlook.call("POST", "/users/{user-id}/mailFolders/{mailFolder-id}/microsoft.graph.copy", data) as any
  },
})
