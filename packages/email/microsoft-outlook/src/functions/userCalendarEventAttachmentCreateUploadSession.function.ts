...
export const UserCalendarEventAttachmentCreateUploadSessionInput = z.object({
...
export const UserCalendarEventAttachmentCreateUploadSessionOutput = z.object({
...
export const userCalendarEventAttachmentCreateUploadSession = pikkuSessionlessFunc({
  ...
  input: UserCalendarEventAttachmentCreateUploadSessionInput,
  output: UserCalendarEventAttachmentCreateUploadSessionOutput,
  func: async ({ microsoftOutlook }, data) => {
    return microsoftOutlook.call("POST", "/users/{user-id}/calendar/events/{event-id}/attachments/microsoft.graph.createUploadSession", data) as any
  },
})
