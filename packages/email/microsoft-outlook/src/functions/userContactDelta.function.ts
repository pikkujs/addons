...
export const UserContactDeltaInput = z.object({
...
export const UserContactDeltaOutput = z.object({
...
export const userContactDelta = pikkuSessionlessFunc({
  ...
  input: UserContactDeltaInput,
  output: UserContactDeltaOutput,
  func: async ({ microsoftOutlook }, data) => {
    return microsoftOutlook.call("GET", "/users/{user-id}/contacts/microsoft.graph.delta()", data) as any
  },
})
