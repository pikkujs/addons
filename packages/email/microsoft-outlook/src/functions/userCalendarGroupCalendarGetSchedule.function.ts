...
export const UserCalendarGroupCalendarGetScheduleInput = z.object({
...
export const UserCalendarGroupCalendarGetScheduleOutput = z.object({
...
export const userCalendarGroupCalendarGetSchedule = pikkuSessionlessFunc({
  ...
  input: UserCalendarGroupCalendarGetScheduleInput,
  output: UserCalendarGroupCalendarGetScheduleOutput,
  func: async ({ microsoftOutlook }, data) => {
    return microsoftOutlook.call("POST", "/users/{user-id}/calendarGroups/{calendarGroup-id}/calendars/{calendar-id}/microsoft.graph.getSchedule", data) as any
  },
})
