...
export const UserMessageForwardInput = z.object({
...
export const userMessageForward = pikkuSessionlessFunc({
  ...
  input: UserMessageForwardInput,
  func: async ({ microsoftOutlook }, data) => {
    return microsoftOutlook.call("POST", "/users/{user-id}/messages/{message-id}/microsoft.graph.forward", data)
  },
})
