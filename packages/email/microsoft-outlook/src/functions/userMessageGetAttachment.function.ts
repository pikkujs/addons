...
export const UserMessageGetAttachmentInput = z.object({
...
export const UserMessageGetAttachmentOutput = z.object({
...
export const userMessageGetAttachment = pikkuSessionlessFunc({
  description: "The fileAttachment and itemAttachment attachments for the message.",
  input: UserMessageGetAttachmentInput,
  output: UserMessageGetAttachmentOutput,
  func: async ({ microsoftOutlook }, data) => {
    return microsoftOutlook.call("GET", "/users/{user-id}/messages/{message-id}/attachments/{attachment-id}", data) as any
  },
})
