...
export const PlaceAsRoomListRoomListCheckInInput = z.object({
...
export const PlaceAsRoomListRoomListCheckInOutput = z.object({
...
export const placeAsRoomListRoomListCheckIn = pikkuSessionlessFunc({
  ...
  input: PlaceAsRoomListRoomListCheckInInput,
  output: PlaceAsRoomListRoomListCheckInOutput,
  func: async ({ microsoftOutlook }, data) => {
    return microsoftOutlook.call("GET", "/places/{place-id}/microsoft.graph.roomList/rooms/{room-id}/checkIns", data) as any
  },
})
