...
export const UserMailFolderDeltaInput = z.object({
...
export const UserMailFolderDeltaOutput = z.object({
...
export const userMailFolderDelta = pikkuSessionlessFunc({
  ...
  input: UserMailFolderDeltaInput,
  output: UserMailFolderDeltaOutput,
  func: async ({ microsoftOutlook }, data) => {
    return microsoftOutlook.call("GET", "/users/{user-id}/mailFolders/microsoft.graph.delta()", data) as any
  },
})
