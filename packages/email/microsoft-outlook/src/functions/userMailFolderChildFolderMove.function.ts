...
export const UserMailFolderChildFolderMoveInput = z.object({
...
export const UserMailFolderChildFolderMoveOutput = z.object({
...
export const userMailFolderChildFolderMove = pikkuSessionlessFunc({
  description: "Move a mailfolder and its contents to another mailfolder.",
  input: UserMailFolderChildFolderMoveInput,
  output: UserMailFolderChildFolderMoveOutput,
  func: async ({ microsoftOutlook }, data) => {
    return microsoftOutlook.call("POST", "/users/{user-id}/mailFolders/{mailFolder-id}/childFolders/{mailFolder-id1}/microsoft.graph.move", data) as any
  },
})
