...
export const UserCalendarEventTentativelyAccept2Input = z.object({
...
export const userCalendarEventTentativelyAccept2 = pikkuSessionlessFunc({
  ...
  input: UserCalendarEventTentativelyAccept2Input,
  func: async ({ microsoftOutlook }, data) => {
    return microsoftOutlook.call("POST", "/users/{user-id}/calendars/{calendar-id}/events/{event-id}/microsoft.graph.tentativelyAccept", data)
  },
})
