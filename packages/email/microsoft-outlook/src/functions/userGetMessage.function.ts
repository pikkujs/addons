...
export const UserGetMessageInput = z.object({
  "user-id": z.string().describe("The unique identifier of user"),
  "message-id": z.string().describe("The unique identifier of message"),
  includeHiddenMessages: z.string().optional().describe("Include Hidden Messages"),
  $select: z.array(z.string()).optional().describe("Select properties to be returned"),
  $expand: z.array(z.string()).optional().describe("Expand related entities"),
})

export const UserGetMessageOutput = z.object({
...
export const userGetMessage = pikkuSessionlessFunc({
  description: "The messages in a mailbox or folder. Read-only. Nullable.",
  input: UserGetMessageInput,
  output: UserGetMessageOutput,
  func: async ({ microsoftOutlook }, data) => {
    return microsoftOutlook.call("GET", "/users/{user-id}/messages/{message-id}", data) as any
  },
})
