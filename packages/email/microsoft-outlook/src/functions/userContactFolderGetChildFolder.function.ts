...
export const UserContactFolderGetChildFolderInput = z.object({
...
export const UserContactFolderGetChildFolderOutput = z.object({
...
export const userContactFolderGetChildFolder = pikkuSessionlessFunc({
  description: "The collection of child folders in the folder. Navigation property. Read-only. Nullable.",
  input: UserContactFolderGetChildFolderInput,
  output: UserContactFolderGetChildFolderOutput,
  func: async ({ microsoftOutlook }, data) => {
    return microsoftOutlook.call("GET", "/users/{user-id}/contactFolders/{contactFolder-id}/childFolders/{contactFolder-id1}", data) as any
  },
})
