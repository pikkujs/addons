...
export const UserListMailFolderInput = z.object({
...
export const UserListMailFolderOutput = z.object({
...
export const userListMailFolder = pikkuSessionlessFunc({
  description: "The user's mail folders. Read-only. Nullable.",
  input: UserListMailFolderInput,
  output: UserListMailFolderOutput,
  func: async ({ microsoftOutlook }, data) => {
    return microsoftOutlook.call("GET", "/users/{user-id}/mailFolders", data) as any
  },
})
