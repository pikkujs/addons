...
export const UserMailFolderGetChildFolderInput = z.object({
...
export const UserMailFolderGetChildFolderOutput = z.object({
...
export const userMailFolderGetChildFolder = pikkuSessionlessFunc({
  description: "The collection of child folders in the mailFolder.",
  input: UserMailFolderGetChildFolderInput,
  output: UserMailFolderGetChildFolderOutput,
  func: async ({ microsoftOutlook }, data) => {
    return microsoftOutlook.call("GET", "/users/{user-id}/mailFolders/{mailFolder-id}/childFolders/{mailFolder-id1}", data) as any
  },
})
