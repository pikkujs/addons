...
export const UserMailFolderListMessageRuleInput = z.object({
...
export const UserMailFolderListMessageRuleOutput = z.object({
...
export const userMailFolderListMessageRule = pikkuSessionlessFunc({
  description: "The collection of rules that apply to the user's Inbox folder.",
  input: UserMailFolderListMessageRuleInput,
  output: UserMailFolderListMessageRuleOutput,
  func: async ({ microsoftOutlook }, data) => {
    return microsoftOutlook.call("GET", "/users/{user-id}/mailFolders/{mailFolder-id}/messageRules", data) as any
  },
})
