...
export const GroupCalendarEventListAttachmentInput = z.object({
...
export const GroupCalendarEventListAttachmentOutput = z.object({
...
export const groupCalendarEventListAttachment = pikkuSessionlessFunc({
  ...
  input: GroupCalendarEventListAttachmentInput,
  output: GroupCalendarEventListAttachmentOutput,
  func: async ({ microsoftOutlook }, data) => {
    return microsoftOutlook.call("GET", "/groups/{group-id}/calendar/events/{event-id}/attachments", data) as any
  },
})
