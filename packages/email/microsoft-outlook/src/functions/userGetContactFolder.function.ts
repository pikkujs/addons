...
export const UserGetContactFolderInput = z.object({
...
export const UserGetContactFolderOutput = z.object({
  id: z.string().optional().describe("The unique identifier for an entity. Read-only."),
  displayName: z.string().nullable().optional().describe("The folder's display name."),
  parentFolderId: z.string().nullable().optional().describe("The ID of the folder's parent folder."),
  childFolders: z.array(z.object({
    id: z.string().optional().describe("The unique identifier for an entity. Read-only."),
    displayName: z.string().nullable().optional().describe("The folder's display name."),
    parentFolderId: z.string().nullable().optional().describe("The ID of the folder's parent folder."),
    childFolders: z.any().optional().describe("The collection of child folders in the folder. Navigation property. Read-only. Nullable."),
    ...
    })).optional().describe("The contacts in the folder. Navigation property. Read-only. Nullable."),
    multiValueExtendedProperties: z.array(z.object({
      id: z.string().optional().describe("The unique identifier for an entity. Read-only."),
      value: z.array(z.string()).optional().describe("A collection of property values."),
    })).optional().describe("The collection of multi-value extended properties defined for the contactFolder. Read-only. Nullable."),
    singleValueExtendedProperties: z.array(z.object({
      id: z.string().optional().describe("The unique identifier for an entity. Read-only."),
      value: z.string().nullable().optional().describe("A property value."),
    })).optional().describe("The collection of single-value extended properties defined for the contactFolder. Read-only. Nullable."),
  })).optional().describe("The collection of child folders in the folder. Navigation property. Read-only. Nullable."),
  contacts: z.array(z.object({
    assistantName: z.string().nullable().optional().describe("The name of the contact's assistant."),
    birthday: z.string().datetime().regex(new RegExp("^[0-9]{4,}-(0[1-9]|1[012])-(0[1-9]|[12][0-9]|3[01])T([01][0-9]|2[0-3]):[0-5][0-9]:[0-5][0-9]([.][0-9]{1,12})?(Z|[+-][0-9][0-9]:[0-9][0-9])$")).nullable().optional().describe("The contact's birthday. The Timestamp type represents date and time information using ISO 8601 format and is always in UTC time. For example, midnight UTC on Jan 1, 2014 is 2014-01-01T00:00:00Z"),
    businessAddress: z.object({
...
export const userGetContactFolder = pikkuSessionlessFunc({
  description: "The user's contacts folders. Read-only. Nullable.",
  input: UserGetContactFolderInput,
  output: UserGetContactFolderOutput,
  func: async ({ microsoftOutlook }, data) => {
    return microsoftOutlook.call("GET", "/users/{user-id}/contactFolders/{contactFolder-id}", data) as any
  },
})
