...
export const PlaceAsSectionListCheckInInput = z.object({
...
export const PlaceAsSectionListCheckInOutput = z.object({
...
export const placeAsSectionListCheckIn = pikkuSessionlessFunc({
  ...
  input: PlaceAsSectionListCheckInInput,
  output: PlaceAsSectionListCheckInOutput,
  func: async ({ microsoftOutlook }, data) => {
    return microsoftOutlook.call("GET", "/places/{place-id}/microsoft.graph.section/checkIns", data) as any
  },
})
