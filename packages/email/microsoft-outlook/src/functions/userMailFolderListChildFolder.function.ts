...
export const UserMailFolderListChildFolderInput = z.object({
  "user-id": z.string().describe("The unique identifier of user"),
  "mailFolder-id": z.string().describe("The unique identifier of mailFolder"),
  includeHiddenFolders: z.string().optional().describe("Include Hidden Folders"),
...
export const UserMailFolderListChildFolderOutput = z.object({
        ...
        actions: z.object({
          ...
          forwardAsAttachmentTo: z.array(z.object({
            emailAddress: z.object({
              address: z.any().nullable().optional().describe("The email address of the person or entity."),
              name: z.any().nullable().optional().describe("The display name of the person or entity."),
            }).optional(),
...
export const userMailFolderListChildFolder = pikkuSessionlessFunc({
  description: "The collection of child folders in the mailFolder.",
  input: UserMailFolderListChildFolderInput,
  output: UserMailFolderListChildFolderOutput,
  func: async ({ microsoftOutlook }, data) => {
    return microsoftOutlook.call("GET", "/users/{user-id}/mailFolders/{mailFolder-id}/childFolders", data) as any
  },
})
