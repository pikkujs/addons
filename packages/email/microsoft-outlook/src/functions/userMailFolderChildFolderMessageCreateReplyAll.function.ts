...
export const UserMailFolderChildFolderMessageCreateReplyAllInput = z.object({
...
export const UserMailFolderChildFolderMessageCreateReplyAllOutput = z.object({
  bccRecipients: z.array(z.object({
    emailAddress: z.object({
      address: z.string().nullable().optional().describe("The email address of the person or entity."),
      name: z.string().nullable().optional().describe("The display name of the person or entity."),
...
export const userMailFolderChildFolderMessageCreateReplyAll = pikkuSessionlessFunc({
  ...
  input: UserMailFolderChildFolderMessageCreateReplyAllInput,
  output: UserMailFolderChildFolderMessageCreateReplyAllOutput,
  func: async ({ microsoftOutlook }, data) => {
    return microsoftOutlook.call("POST", "/users/{user-id}/mailFolders/{mailFolder-id}/childFolders/{mailFolder-id1}/messages/{message-id}/microsoft.graph.createReplyAll", data) as any
  },
})
