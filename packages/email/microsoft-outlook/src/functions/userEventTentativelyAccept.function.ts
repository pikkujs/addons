...
export const UserEventTentativelyAcceptInput = z.object({
...
export const userEventTentativelyAccept = pikkuSessionlessFunc({
  ...
  input: UserEventTentativelyAcceptInput,
  func: async ({ microsoftOutlook }, data) => {
    return microsoftOutlook.call("POST", "/users/{user-id}/events/{event-id}/microsoft.graph.tentativelyAccept", data)
  },
})
