...
export const UserCalendarEventListExtension2Input = z.object({
...
export const UserCalendarEventListExtension2Output = z.object({
...
export const userCalendarEventListExtension2 = pikkuSessionlessFunc({
  description: "The collection of open extensions defined for the event. Nullable.",
  input: UserCalendarEventListExtension2Input,
  output: UserCalendarEventListExtension2Output,
  func: async ({ microsoftOutlook }, data) => {
    return microsoftOutlook.call("GET", "/users/{user-id}/calendars/{calendar-id}/events/{event-id}/extensions", data) as any
  },
})
