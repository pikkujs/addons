...
export const UserListContactInput = z.object({
...
export const UserListContactOutput = z.object({
...
export const userListContact = pikkuSessionlessFunc({
  description: "The user's contacts. Read-only. Nullable.",
  input: UserListContactInput,
  output: UserListContactOutput,
  func: async ({ microsoftOutlook }, data) => {
    return microsoftOutlook.call("GET", "/users/{user-id}/contacts", data) as any
  },
})
