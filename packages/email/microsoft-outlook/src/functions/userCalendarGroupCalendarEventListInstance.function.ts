...
export const UserCalendarGroupCalendarEventListInstanceInput = z.object({
...
export const UserCalendarGroupCalendarEventListInstanceOutput = z.any()

export const userCalendarGroupCalendarEventListInstance = pikkuSessionlessFunc({
  ...
  input: UserCalendarGroupCalendarEventListInstanceInput,
  output: UserCalendarGroupCalendarEventListInstanceOutput,
  func: async ({ microsoftOutlook }, data) => {
    return microsoftOutlook.call("GET", "/users/{user-id}/calendarGroups/{calendarGroup-id}/calendars/{calendar-id}/events/{event-id}/instances", data) as any
  },
})
