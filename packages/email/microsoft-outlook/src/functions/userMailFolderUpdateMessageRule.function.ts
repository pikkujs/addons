...
export const UserMailFolderUpdateMessageRuleInput = z.object({
...
export const UserMailFolderUpdateMessageRuleOutput = z.object({
  id: z.string().optional().describe("The unique identifier for an entity. Read-only."),
  actions: z.object({
    assignCategories: z.array(z.string()).optional().describe("A list of categories to be assigned to a message."),
    copyToFolder: z.string().nullable().optional().describe("The ID of a folder that a message is to be copied to."),
...
export const userMailFolderUpdateMessageRule = pikkuSessionlessFunc({
  input: UserMailFolderUpdateMessageRuleInput,
  output: UserMailFolderUpdateMessageRuleOutput,
  func: async ({ microsoftOutlook }, data) => {
    return microsoftOutlook.call("PATCH", "/users/{user-id}/mailFolders/{mailFolder-id}/messageRules/{messageRule-id}", data) as any
  },
})
