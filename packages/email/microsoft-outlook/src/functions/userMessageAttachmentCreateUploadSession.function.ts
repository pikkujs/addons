...
export const UserMessageAttachmentCreateUploadSessionInput = z.object({
...
export const UserMessageAttachmentCreateUploadSessionOutput = z.object({
...
export const userMessageAttachmentCreateUploadSession = pikkuSessionlessFunc({
  ...
  input: UserMessageAttachmentCreateUploadSessionInput,
  output: UserMessageAttachmentCreateUploadSessionOutput,
  func: async ({ microsoftOutlook }, data) => {
    return microsoftOutlook.call("POST", "/users/{user-id}/messages/{message-id}/attachments/microsoft.graph.createUploadSession", data) as any
  },
})
