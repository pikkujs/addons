...
export const PlaceListCheckInInput = z.object({
...
export const PlaceListCheckInOutput = z.object({
...
export const placeListCheckIn = pikkuSessionlessFunc({
  ...
  input: PlaceListCheckInInput,
  output: PlaceListCheckInOutput,
  func: async ({ microsoftOutlook }, data) => {
    return microsoftOutlook.call("GET", "/places/{place-id}/checkIns", data) as any
  },
})
