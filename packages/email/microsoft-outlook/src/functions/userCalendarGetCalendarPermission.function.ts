...
export const UserCalendarGetCalendarPermissionInput = z.object({
...
export const UserCalendarGetCalendarPermissionOutput = z.object({
...
export const userCalendarGetCalendarPermission = pikkuSessionlessFunc({
  description: "Get the specified permissions object of a user or group calendar that has been shared.",
  input: UserCalendarGetCalendarPermissionInput,
  output: UserCalendarGetCalendarPermissionOutput,
  func: async ({ microsoftOutlook }, data) => {
    return microsoftOutlook.call("GET", "/users/{user-id}/calendar/calendarPermissions/{calendarPermission-id}", data) as any
  },
})
