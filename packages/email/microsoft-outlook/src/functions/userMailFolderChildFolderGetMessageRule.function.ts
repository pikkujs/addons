...
export const UserMailFolderChildFolderGetMessageRuleInput = z.object({
...
export const UserMailFolderChildFolderGetMessageRuleOutput = z.object({
...
export const userMailFolderChildFolderGetMessageRule = pikkuSessionlessFunc({
  description: "The collection of rules that apply to the user's Inbox folder.",
  input: UserMailFolderChildFolderGetMessageRuleInput,
  output: UserMailFolderChildFolderGetMessageRuleOutput,
  func: async ({ microsoftOutlook }, data) => {
    return microsoftOutlook.call("GET", "/users/{user-id}/mailFolders/{mailFolder-id}/childFolders/{mailFolder-id1}/messageRules/{messageRule-id}", data) as any
  },
})
