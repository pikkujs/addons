...
export const UserMessageListAttachmentInput = z.object({
...
export const UserMessageListAttachmentOutput = z.object({
...
export const userMessageListAttachment = pikkuSessionlessFunc({
  description: "The fileAttachment and itemAttachment attachments for the message.",
  input: UserMessageListAttachmentInput,
  output: UserMessageListAttachmentOutput,
  func: async ({ microsoftOutlook }, data) => {
    return microsoftOutlook.call("GET", "/users/{user-id}/messages/{message-id}/attachments", data) as any
  },
})
