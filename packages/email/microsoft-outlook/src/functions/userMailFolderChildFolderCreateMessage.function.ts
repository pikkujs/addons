...
export const UserMailFolderChildFolderCreateMessageInput = z.object({
...
export const UserMailFolderChildFolderCreateMessageOutput = z.object({
  bccRecipients: z.array(z.object({
    emailAddress: z.object({
      address: z.string().nullable().optional().describe("The email address of the person or entity."),
      name: z.string().nullable().optional().describe("The display name of the person or entity."),
...
export const userMailFolderChildFolderCreateMessage = pikkuSessionlessFunc({
  input: UserMailFolderChildFolderCreateMessageInput,
  output: UserMailFolderChildFolderCreateMessageOutput,
  func: async ({ microsoftOutlook }, data) => {
    return microsoftOutlook.call("POST", "/users/{user-id}/mailFolders/{mailFolder-id}/childFolders/{mailFolder-id1}/messages", data) as any
  },
})
