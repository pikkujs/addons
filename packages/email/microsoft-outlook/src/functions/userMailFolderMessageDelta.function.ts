...
export const UserMailFolderMessageDeltaInput = z.object({
...
export const UserMailFolderMessageDeltaOutput = z.object({
...
export const userMailFolderMessageDelta = pikkuSessionlessFunc({
  ...
  input: UserMailFolderMessageDeltaInput,
  output: UserMailFolderMessageDeltaOutput,
  func: async ({ microsoftOutlook }, data) => {
    return microsoftOutlook.call("GET", "/users/{user-id}/mailFolders/{mailFolder-id}/messages/microsoft.graph.delta()", data) as any
  },
})
