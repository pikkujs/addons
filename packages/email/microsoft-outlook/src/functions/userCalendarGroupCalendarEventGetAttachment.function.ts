...
export const UserCalendarGroupCalendarEventGetAttachmentInput = z.object({
...
export const UserCalendarGroupCalendarEventGetAttachmentOutput = z.object({
...
export const userCalendarGroupCalendarEventGetAttachment = pikkuSessionlessFunc({
  ...
  input: UserCalendarGroupCalendarEventGetAttachmentInput,
  output: UserCalendarGroupCalendarEventGetAttachmentOutput,
  func: async ({ microsoftOutlook }, data) => {
    return microsoftOutlook.call("GET", "/users/{user-id}/calendarGroups/{calendarGroup-id}/calendars/{calendar-id}/events/{event-id}/attachments/{attachment-id}", data) as any
  },
})
