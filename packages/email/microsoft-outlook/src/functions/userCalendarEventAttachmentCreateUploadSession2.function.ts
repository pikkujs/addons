...
export const UserCalendarEventAttachmentCreateUploadSession2Input = z.object({
...
export const UserCalendarEventAttachmentCreateUploadSession2Output = z.object({
...
export const userCalendarEventAttachmentCreateUploadSession2 = pikkuSessionlessFunc({
  ...
  input: UserCalendarEventAttachmentCreateUploadSession2Input,
  output: UserCalendarEventAttachmentCreateUploadSession2Output,
  func: async ({ microsoftOutlook }, data) => {
    return microsoftOutlook.call("POST", "/users/{user-id}/calendars/{calendar-id}/events/{event-id}/attachments/microsoft.graph.createUploadSession", data) as any
  },
})
