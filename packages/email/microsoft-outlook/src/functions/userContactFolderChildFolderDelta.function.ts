...
export const UserContactFolderChildFolderDeltaInput = z.object({
...
export const UserContactFolderChildFolderDeltaOutput = z.object({
...
export const userContactFolderChildFolderDelta = pikkuSessionlessFunc({
  ...
  input: UserContactFolderChildFolderDeltaInput,
  output: UserContactFolderChildFolderDeltaOutput,
  func: async ({ microsoftOutlook }, data) => {
    return microsoftOutlook.call("GET", "/users/{user-id}/contactFolders/{contactFolder-id}/childFolders/microsoft.graph.delta()", data) as any
  },
})
