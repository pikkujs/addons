...
export const UserEventGetAttachmentInput = z.object({
...
export const UserEventGetAttachmentOutput = z.object({
...
export const userEventGetAttachment = pikkuSessionlessFunc({
  ...
  input: UserEventGetAttachmentInput,
  output: UserEventGetAttachmentOutput,
  func: async ({ microsoftOutlook }, data) => {
    return microsoftOutlook.call("GET", "/users/{user-id}/events/{event-id}/attachments/{attachment-id}", data) as any
  },
})
