...
export const GroupEventListInstanceInput = z.object({
...
export const GroupEventListInstanceOutput = z.any()

export const groupEventListInstance = pikkuSessionlessFunc({
  ...
  input: GroupEventListInstanceInput,
  output: GroupEventListInstanceOutput,
  func: async ({ microsoftOutlook }, data) => {
    return microsoftOutlook.call("GET", "/groups/{group-id}/events/{event-id}/instances", data) as any
  },
})
