...
export const PlaceAsRoomListWorkspaceListCheckInInput = z.object({
...
export const PlaceAsRoomListWorkspaceListCheckInOutput = z.object({
...
export const placeAsRoomListWorkspaceListCheckIn = pikkuSessionlessFunc({
  ...
  input: PlaceAsRoomListWorkspaceListCheckInInput,
  output: PlaceAsRoomListWorkspaceListCheckInOutput,
  func: async ({ microsoftOutlook }, data) => {
    return microsoftOutlook.call("GET", "/places/{place-id}/microsoft.graph.roomList/workspaces/{workspace-id}/checkIns", data) as any
  },
})
