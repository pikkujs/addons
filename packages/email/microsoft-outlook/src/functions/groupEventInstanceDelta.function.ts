...
export const GroupEventInstanceDeltaInput = z.object({
...
export const GroupEventInstanceDeltaOutput = z.any()

export const groupEventInstanceDelta = pikkuSessionlessFunc({
  ...
  input: GroupEventInstanceDeltaInput,
  output: GroupEventInstanceDeltaOutput,
  func: async ({ microsoftOutlook }, data) => {
    return microsoftOutlook.call("GET", "/groups/{group-id}/events/{event-id}/instances/microsoft.graph.delta()", data) as any
  },
})
