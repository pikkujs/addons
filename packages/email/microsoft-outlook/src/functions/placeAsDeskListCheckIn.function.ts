...
export const PlaceAsDeskListCheckInInput = z.object({
...
export const PlaceAsDeskListCheckInOutput = z.object({
...
export const placeAsDeskListCheckIn = pikkuSessionlessFunc({
  ...
  input: PlaceAsDeskListCheckInInput,
  output: PlaceAsDeskListCheckInOutput,
  func: async ({ microsoftOutlook }, data) => {
    return microsoftOutlook.call("GET", "/places/{place-id}/microsoft.graph.desk/checkIns", data) as any
  },
})
