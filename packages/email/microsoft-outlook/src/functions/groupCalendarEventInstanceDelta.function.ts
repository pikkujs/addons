...
export const GroupCalendarEventInstanceDeltaInput = z.object({
...
export const GroupCalendarEventInstanceDeltaOutput = z.any()

export const groupCalendarEventInstanceDelta = pikkuSessionlessFunc({
  ...
  input: GroupCalendarEventInstanceDeltaInput,
  output: GroupCalendarEventInstanceDeltaOutput,
  func: async ({ microsoftOutlook }, data) => {
    return microsoftOutlook.call("GET", "/groups/{group-id}/calendar/events/{event-id}/instances/microsoft.graph.delta()", data) as any
  },
})
