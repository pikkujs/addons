...
export const UserMailFolderChildFolderMessageForwardInput = z.object({
...
export const userMailFolderChildFolderMessageForward = pikkuSessionlessFunc({
  ...
  input: UserMailFolderChildFolderMessageForwardInput,
  func: async ({ microsoftOutlook }, data) => {
    return microsoftOutlook.call("POST", "/users/{user-id}/mailFolders/{mailFolder-id}/childFolders/{mailFolder-id1}/messages/{message-id}/microsoft.graph.forward", data)
  },
})
