...
export const UserMailFolderMessageListExtensionInput = z.object({
...
export const UserMailFolderMessageListExtensionOutput = z.object({
...
export const userMailFolderMessageListExtension = pikkuSessionlessFunc({
  description: "The collection of open extensions defined for the message. Nullable.",
  input: UserMailFolderMessageListExtensionInput,
  output: UserMailFolderMessageListExtensionOutput,
  func: async ({ microsoftOutlook }, data) => {
    return microsoftOutlook.call("GET", "/users/{user-id}/mailFolders/{mailFolder-id}/messages/{message-id}/extensions", data) as any
  },
})
