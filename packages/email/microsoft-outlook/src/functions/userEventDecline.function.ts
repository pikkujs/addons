...
export const UserEventDeclineInput = z.object({
...
export const userEventDecline = pikkuSessionlessFunc({
  ...
  input: UserEventDeclineInput,
  func: async ({ microsoftOutlook }, data) => {
    return microsoftOutlook.call("POST", "/users/{user-id}/events/{event-id}/microsoft.graph.decline", data)
  },
})
