...
export const UserMailFolderChildFolderMessageCopyInput = z.object({
...
export const UserMailFolderChildFolderMessageCopyOutput = z.object({
...
export const userMailFolderChildFolderMessageCopy = pikkuSessionlessFunc({
  description: "Copy a message to a folder within the user's mailbox.",
  input: UserMailFolderChildFolderMessageCopyInput,
  output: UserMailFolderChildFolderMessageCopyOutput,
  func: async ({ microsoftOutlook }, data) => {
    return microsoftOutlook.call("POST", "/users/{user-id}/mailFolders/{mailFolder-id}/childFolders/{mailFolder-id1}/messages/{message-id}/microsoft.graph.copy", data) as any
  },
})
