...
export const UserContactFolderUpdateChildFolderInput = z.object({
...
export const UserContactFolderUpdateChildFolderOutput = z.object({
  id: z.string().optional().describe("The unique identifier for an entity. Read-only."),
  displayName: z.string().nullable().optional().describe("The folder's display name."),
  parentFolderId: z.string().nullable().optional().describe("The ID of the folder's parent folder."),
  childFolders: z.array(z.object({
...
export const userContactFolderUpdateChildFolder = pikkuSessionlessFunc({
  input: UserContactFolderUpdateChildFolderInput,
  output: UserContactFolderUpdateChildFolderOutput,
  func: async ({ microsoftOutlook }, data) => {
    return microsoftOutlook.call("PATCH", "/users/{user-id}/contactFolders/{contactFolder-id}/childFolders/{contactFolder-id1}", data) as any
  },
})
