...
export const UserMailFolderCreateMessageInput = z.object({
...
export const UserMailFolderCreateMessageOutput = z.object({
  bccRecipients: z.array(z.object({
    emailAddress: z.object({
      address: z.string().nullable().optional().describe("The email address of the person or entity."),
      name: z.string().nullable().optional().describe("The display name of the person or entity."),
...
export const userMailFolderCreateMessage = pikkuSessionlessFunc({
  input: UserMailFolderCreateMessageInput,
  output: UserMailFolderCreateMessageOutput,
  func: async ({ microsoftOutlook }, data) => {
    return microsoftOutlook.call("POST", "/users/{user-id}/mailFolders/{mailFolder-id}/messages", data) as any
  },
})
