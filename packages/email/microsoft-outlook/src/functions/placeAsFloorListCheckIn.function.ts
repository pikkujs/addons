...
export const PlaceAsFloorListCheckInInput = z.object({
...
export const PlaceAsFloorListCheckInOutput = z.object({
...
export const placeAsFloorListCheckIn = pikkuSessionlessFunc({
  ...
  input: PlaceAsFloorListCheckInInput,
  output: PlaceAsFloorListCheckInOutput,
  func: async ({ microsoftOutlook }, data) => {
    return microsoftOutlook.call("GET", "/places/{place-id}/microsoft.graph.floor/checkIns", data) as any
  },
})
