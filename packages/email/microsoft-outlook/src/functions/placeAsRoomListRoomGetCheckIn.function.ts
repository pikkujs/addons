...
export const PlaceAsRoomListRoomGetCheckInInput = z.object({
...
export const PlaceAsRoomListRoomGetCheckInOutput = z.object({
...
export const placeAsRoomListRoomGetCheckIn = pikkuSessionlessFunc({
  ...
  input: PlaceAsRoomListRoomGetCheckInInput,
  output: PlaceAsRoomListRoomGetCheckInOutput,
  func: async ({ microsoftOutlook }, data) => {
    return microsoftOutlook.call("GET", "/places/{place-id}/microsoft.graph.roomList/rooms/{room-id}/checkIns/{checkInClaim-calendarEventId}", data) as any
  },
})
