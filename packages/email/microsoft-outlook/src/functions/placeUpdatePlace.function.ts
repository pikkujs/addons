...
export const PlaceUpdatePlaceInput = z.object({
...
export const PlaceUpdatePlaceOutput = z.object({
  id: z.string().optional().describe("The unique identifier for an entity. Read-only."),
  address: z.object({
    city: z.string().nullable().optional().describe("The city."),
    countryOrRegion: z.string().nullable().optional().describe("The country or region. It's a free-format string value, for example, 'United States'."),
...
export const placeUpdatePlace = pikkuSessionlessFunc({
  ...
  input: PlaceUpdatePlaceInput,
  output: PlaceUpdatePlaceOutput,
  func: async ({ microsoftOutlook }, data) => {
    return microsoftOutlook.call("PATCH", "/places/{place-id}", data) as any
  },
})
