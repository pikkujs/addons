...
export const UserCalendarEventListInstance2Input = z.object({
...
export const UserCalendarEventListInstance2Output = z.any()

export const userCalendarEventListInstance2 = pikkuSessionlessFunc({
  ...
  input: UserCalendarEventListInstance2Input,
  output: UserCalendarEventListInstance2Output,
  func: async ({ microsoftOutlook }, data) => {
    return microsoftOutlook.call("GET", "/users/{user-id}/calendars/{calendar-id}/events/{event-id}/instances", data) as any
  },
})
