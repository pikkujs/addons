...
export const UserCalendarEventListAttachmentInput = z.object({
...
export const UserCalendarEventListAttachmentOutput = z.object({
...
export const userCalendarEventListAttachment = pikkuSessionlessFunc({
  ...
  input: UserCalendarEventListAttachmentInput,
  output: UserCalendarEventListAttachmentOutput,
  func: async ({ microsoftOutlook }, data) => {
    return microsoftOutlook.call("GET", "/users/{user-id}/calendar/events/{event-id}/attachments", data) as any
  },
})
