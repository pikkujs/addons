...
export const UserMailFolderCreateMessageRuleInput = z.object({
...
export const UserMailFolderCreateMessageRuleOutput = z.object({
  id: z.string().optional().describe("The unique identifier for an entity. Read-only."),
  actions: z.object({
    assignCategories: z.array(z.string()).optional().describe("A list of categories to be assigned to a message."),
    copyToFolder: z.string().nullable().optional().describe("The ID of a folder that a message is to be copied to."),
...
export const userMailFolderCreateMessageRule = pikkuSessionlessFunc({
  input: UserMailFolderCreateMessageRuleInput,
  output: UserMailFolderCreateMessageRuleOutput,
  func: async ({ microsoftOutlook }, data) => {
    return microsoftOutlook.call("POST", "/users/{user-id}/mailFolders/{mailFolder-id}/messageRules", data) as any
  },
})
