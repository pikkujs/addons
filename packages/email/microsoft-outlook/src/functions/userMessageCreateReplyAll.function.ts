...
export const UserMessageCreateReplyAllInput = z.object({
...
export const UserMessageCreateReplyAllOutput = z.object({
  bccRecipients: z.array(z.object({
    emailAddress: z.object({
      address: z.string().nullable().optional().describe("The email address of the person or entity."),
      name: z.string().nullable().optional().describe("The display name of the person or entity."),
...
export const userMessageCreateReplyAll = pikkuSessionlessFunc({
  ...
  input: UserMessageCreateReplyAllInput,
  output: UserMessageCreateReplyAllOutput,
  func: async ({ microsoftOutlook }, data) => {
    return microsoftOutlook.call("POST", "/users/{user-id}/messages/{message-id}/microsoft.graph.createReplyAll", data) as any
  },
})
