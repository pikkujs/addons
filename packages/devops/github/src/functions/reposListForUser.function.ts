...
export const ReposListForUserInput = z.object({
  ...
  type: z.enum(["all", "owner", "member"]).optional().default("owner").describe("Limit results to repositories of the specified type."),
...
export const ReposListForUserOutput = z.array(z.object({
...
export const reposListForUser = pikkuSessionlessFunc({
  ...
  input: ReposListForUserInput,
  output: ReposListForUserOutput,
  func: async ({ github }, data) => {
    return github.call("GET", "/users/{username}/repos", data) as any
  },
})
