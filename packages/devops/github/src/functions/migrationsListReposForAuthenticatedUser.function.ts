...
export const MigrationsListReposForAuthenticatedUserInput = z.object({
  migration_id: z.number().int().describe("The unique identifier of the migration."),
  per_page: z.number().int().optional().default(30).describe("The number of results per page (max 100)."),
  page: z.number().int().optional().default(1).describe("Page number of the results to fetch."),
})

export const MigrationsListReposForAuthenticatedUserOutput = z.array(z.object({
...
export const migrationsListReposForAuthenticatedUser = pikkuSessionlessFunc({
  description: "Lists all the repositories for this user migration.",
  input: MigrationsListReposForAuthenticatedUserInput,
  output: MigrationsListReposForAuthenticatedUserOutput,
  errors: [NotFoundError],
  func: async ({ github }, data) => {
    return github.call("GET", "/user/migrations/{migration_id}/repositories", data) as any
  },
})
