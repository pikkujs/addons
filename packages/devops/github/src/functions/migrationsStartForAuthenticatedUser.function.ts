...
export const MigrationsStartForAuthenticatedUserInput = z.object({
  exclude: z.array(z.literal("repositories")).optional().describe("Exclude attributes from the API response to improve performance"),
  exclude_attachments: z.boolean().optional().describe("Do not include attachments in the migration"),
  exclude_git_data: z.boolean().optional().describe("Indicates whether the repository git data should be excluded from the migration."),
  exclude_metadata: z.boolean().optional().describe("Indicates whether metadata should be excluded and only git source should be included for the migration."),
  exclude_owner_projects: z.boolean().optional().describe("Indicates whether projects owned by the organization or users should be excluded."),
  exclude_releases: z.boolean().optional().describe("Do not include releases in the migration"),
  lock_repositories: z.boolean().optional().describe("Lock the repositories being migrated at the start of the migration"),
...
export const MigrationsStartForAuthenticatedUserOutput = z.object({
...
export const migrationsStartForAuthenticatedUser = pikkuSessionlessFunc({
  description: "Initiates the generation of a user migration archive.",
  input: MigrationsStartForAuthenticatedUserInput,
  output: MigrationsStartForAuthenticatedUserOutput,
  errors: [UnauthorizedError, ForbiddenError, UnprocessableContentError],
  func: async ({ github }, data) => {
    return github.call("POST", "/user/migrations", data) as any
  },
})
