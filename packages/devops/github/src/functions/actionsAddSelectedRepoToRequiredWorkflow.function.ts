...
export const ActionsAddSelectedRepoToRequiredWorkflowInput = z.object({
...
export const actionsAddSelectedRepoToRequiredWorkflow = pikkuSessionlessFunc({
  ...
  input: ActionsAddSelectedRepoToRequiredWorkflowInput,
  errors: [NotFoundError, UnprocessableContentError],
  func: async ({ github }, data) => {
    return github.call("PUT", "/orgs/{org}/actions/required_workflows/{required_workflow_id}/repositories/{repository_id}", data)
  },
})
