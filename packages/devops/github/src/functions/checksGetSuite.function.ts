...
export const checksGetSuite = pikkuSessionlessFunc({
  ...
  input: ChecksGetSuiteInput,
  output: ChecksGetSuiteOutput,
  func: async ({ github }, data) => {
    return github.call("GET", "/repos/{owner}/{repo}/check-suites/{check_suite_id}", data) as any
  },
})
