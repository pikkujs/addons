...
export const ReposCreateUsingTemplateInput = z.object({
  template_owner: z.string(),
  template_repo: z.string(),
  description: z.string().optional().describe("A short description of the new repository."),
  include_all_branches: z.boolean().optional().default(false).describe("Set to `true` to include the directory structure and files from all branches in the template repository, and not just the default branch. Default: `false`."),
  name: z.string().describe("The name of the new repository."),
  owner: z.string().optional().describe("The organization or person who will own the new repository. To create a new repository in an organization, the authenticated user must be a member of the specified organization."),
  private: z.boolean().optional().default(false).describe("Either `true` to create a new private repository or `false` to create a new public one."),
})

export const ReposCreateUsingTemplateOutput = z.object({
...
export const reposCreateUsingTemplate = pikkuSessionlessFunc({
  ...
  input: ReposCreateUsingTemplateInput,
  output: ReposCreateUsingTemplateOutput,
  func: async ({ github }, data) => {
    return github.call("POST", "/repos/{template_owner}/{template_repo}/generate", data) as any
  },
})
