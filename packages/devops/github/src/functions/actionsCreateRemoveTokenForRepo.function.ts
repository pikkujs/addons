...
export const ActionsCreateRemoveTokenForRepoInput = z.object({
  owner: z.string().describe("The account owner of the repository. The name is not case sensitive."),
  repo: z.string().describe("The name of the repository. The name is not case sensitive."),
})

export const ActionsCreateRemoveTokenForRepoOutput = z.object({
...
export const actionsCreateRemoveTokenForRepo = pikkuSessionlessFunc({
  ...
  input: ActionsCreateRemoveTokenForRepoInput,
  output: ActionsCreateRemoveTokenForRepoOutput,
  func: async ({ github }, data) => {
    return github.call("POST", "/repos/{owner}/{repo}/actions/runners/remove-token", data) as any
  },
})
