...
export const PackagesRestorePackageVersionForOrgInput = z.object({
...
export const packagesRestorePackageVersionForOrg = pikkuSessionlessFunc({
  ...
  input: PackagesRestorePackageVersionForOrgInput,
  errors: [UnauthorizedError, ForbiddenError, NotFoundError],
  func: async ({ github }, data) => {
    return github.call("POST", "/orgs/{org}/packages/{package_type}/{package_name}/versions/{package_version_id}/restore", data)
  },
})
