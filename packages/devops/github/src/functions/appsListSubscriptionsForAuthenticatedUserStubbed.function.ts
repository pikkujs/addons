...
export const AppsListSubscriptionsForAuthenticatedUserStubbedInput = z.object({
  per_page: z.number().int().optional().default(30).describe("The number of results per page (max 100)."),
  page: z.number().int().optional().default(1).describe("Page number of the results to fetch."),
})

export const AppsListSubscriptionsForAuthenticatedUserStubbedOutput = z.array(z.object({
  account: z.object({
...
export const appsListSubscriptionsForAuthenticatedUserStubbed = pikkuSessionlessFunc({
  ...
  input: AppsListSubscriptionsForAuthenticatedUserStubbedInput,
  output: AppsListSubscriptionsForAuthenticatedUserStubbedOutput,
  errors: [UnauthorizedError],
  func: async ({ github }, data) => {
    return github.call("GET", "/user/marketplace_purchases/stubbed", data) as any
  },
})
