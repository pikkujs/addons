...
export const ActionsGetRepoRequiredWorkflowInput = z.object({
...
export const ActionsGetRepoRequiredWorkflowOutput = z.object({
  badge_url: z.string(),
  ...
  url: z.string(),
}).describe("A GitHub Actions required workflow")

export const actionsGetRepoRequiredWorkflow = pikkuSessionlessFunc({
  ...
  input: ActionsGetRepoRequiredWorkflowInput,
  output: ActionsGetRepoRequiredWorkflowOutput,
  errors: [NotFoundError],
  func: async ({ github }, data) => {
    return github.call("GET", "/repos/{org}/{repo}/actions/required_workflows/{required_workflow_id_for_repo}", data) as any
  },
})
