...
export const PullsListReviewCommentsForRepoInput = z.object({
...
export const PullsListReviewCommentsForRepoOutput = z.array(z.object({
  _links: z.object({
    html: z.object({
      href: z.string().url(),
    }),
...
export const pullsListReviewCommentsForRepo = pikkuSessionlessFunc({
  ...
  input: PullsListReviewCommentsForRepoInput,
  output: PullsListReviewCommentsForRepoOutput,
  func: async ({ github }, data) => {
    return github.call("GET", "/repos/{owner}/{repo}/pulls/comments", data) as any
  },
})
