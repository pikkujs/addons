...
export const ActivityListWatchedReposForAuthenticatedUserInput = z.object({
  per_page: z.number().int().optional().default(30).describe("The number of results per page (max 100)."),
  page: z.number().int().optional().default(1).describe("Page number of the results to fetch."),
})

export const ActivityListWatchedReposForAuthenticatedUserOutput = z.array(z.object({
...
export const activityListWatchedReposForAuthenticatedUser = pikkuSessionlessFunc({
  description: "Lists repositories the authenticated user is watching.",
  input: ActivityListWatchedReposForAuthenticatedUserInput,
  output: ActivityListWatchedReposForAuthenticatedUserOutput,
  errors: [UnauthorizedError, ForbiddenError],
  func: async ({ github }, data) => {
    return github.call("GET", "/user/subscriptions", data) as any
  },
})
