...
export const TeamsListDiscussionsInOrgInput = z.object({
  ...
  pinned: z.string().optional().describe("Pinned discussions only filter"),
})

export const TeamsListDiscussionsInOrgOutput = z.array(z.object({
  author: z.object({
...
export const teamsListDiscussionsInOrg = pikkuSessionlessFunc({
  ...
  input: TeamsListDiscussionsInOrgInput,
  output: TeamsListDiscussionsInOrgOutput,
  func: async ({ github }, data) => {
    return github.call("GET", "/orgs/{org}/teams/{team_slug}/discussions", data) as any
  },
})
