...
export const MigrationsGetStatusForAuthenticatedUserInput = z.object({
  migration_id: z.number().int().describe("The unique identifier of the migration."),
  exclude: z.array(z.string()).optional(),
})

export const MigrationsGetStatusForAuthenticatedUserOutput = z.object({
...
export const migrationsGetStatusForAuthenticatedUser = pikkuSessionlessFunc({
  ...
  input: MigrationsGetStatusForAuthenticatedUserInput,
  output: MigrationsGetStatusForAuthenticatedUserOutput,
  errors: [UnauthorizedError, ForbiddenError, NotFoundError],
  func: async ({ github }, data) => {
    return github.call("GET", "/user/migrations/{migration_id}", data) as any
  },
})
