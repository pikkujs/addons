...
export const PullsCreateReplyForReviewCommentInput = z.object({
...
export const PullsCreateReplyForReviewCommentOutput = z.object({
  _links: z.object({
    html: z.object({
      href: z.string().url(),
    }),
...
export const pullsCreateReplyForReviewComment = pikkuSessionlessFunc({
  ...
  input: PullsCreateReplyForReviewCommentInput,
  output: PullsCreateReplyForReviewCommentOutput,
  errors: [NotFoundError],
  func: async ({ github }, data) => {
    return github.call("POST", "/repos/{owner}/{repo}/pulls/{pull_number}/comments/{comment_id}/replies", data) as any
  },
})
