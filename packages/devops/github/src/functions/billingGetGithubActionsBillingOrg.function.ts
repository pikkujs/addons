...
export const BillingGetGithubActionsBillingOrgInput = z.object({
  org: z.string().describe("The organization name. The name is not case sensitive."),
})

export const BillingGetGithubActionsBillingOrgOutput = z.object({
...
export const billingGetGithubActionsBillingOrg = pikkuSessionlessFunc({
  ...
  input: BillingGetGithubActionsBillingOrgInput,
  output: BillingGetGithubActionsBillingOrgOutput,
  func: async ({ github }, data) => {
    return github.call("GET", "/orgs/{org}/settings/billing/actions", data) as any
  },
})
