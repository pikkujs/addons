...
export const ActionsListWorkflowRunsForRepoInput = z.object({
...
export const ActionsListWorkflowRunsForRepoOutput = z.object({
...
export const actionsListWorkflowRunsForRepo = pikkuSessionlessFunc({
  ...
  input: ActionsListWorkflowRunsForRepoInput,
  output: ActionsListWorkflowRunsForRepoOutput,
  func: async ({ github }, data) => {
    return github.call("GET", "/repos/{owner}/{repo}/actions/runs", data) as any
  },
})
