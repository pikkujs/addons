...
export const ActionsListRequiredWorkflowsInput = z.object({
  org: z.string().describe("The organization name. The name is not case sensitive."),
  per_page: z.number().int().optional().default(30).describe("The number of results per page (max 100)."),
  page: z.number().int().optional().default(1).describe("Page number of the results to fetch."),
})

export const ActionsListRequiredWorkflowsOutput = z.object({
  required_workflows: z.array(z.object({
...
export const actionsListRequiredWorkflows = pikkuSessionlessFunc({
  ...
  input: ActionsListRequiredWorkflowsInput,
  output: ActionsListRequiredWorkflowsOutput,
  func: async ({ github }, data) => {
    return github.call("GET", "/orgs/{org}/actions/required_workflows", data) as any
  },
})
