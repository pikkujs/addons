...
export const ActionsListWorkflowRunsInput = z.object({
...
export const ActionsListWorkflowRunsOutput = z.object({
...
export const actionsListWorkflowRuns = pikkuSessionlessFunc({
  ...
  output: ActionsListWorkflowRunsOutput,
  func: async ({ github }, data) => {
    return github.call("GET", "/repos/{owner}/{repo}/actions/workflows/{workflow_id}/runs", data) as any
  },
})
