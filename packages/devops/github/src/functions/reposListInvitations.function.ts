...
export const ReposListInvitationsInput = z.object({
...
export const ReposListInvitationsOutput = z.array(z.object({
...
export const reposListInvitations = pikkuSessionlessFunc({
  description: "When authenticating as a user with admin rights to a repository, this endpoint will list all currently open repository invitations.",
  input: ReposListInvitationsInput,
  output: ReposListInvitationsOutput,
  func: async ({ github }, data) => {
    return github.call("GET", "/repos/{owner}/{repo}/invitations", data) as any
  },
})
