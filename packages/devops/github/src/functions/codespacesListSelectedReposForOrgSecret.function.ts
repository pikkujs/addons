...
export const CodespacesListSelectedReposForOrgSecretInput = z.object({
...
export const CodespacesListSelectedReposForOrgSecretOutput = z.object({
...
export const codespacesListSelectedReposForOrgSecret = pikkuSessionlessFunc({
  ...
  input: CodespacesListSelectedReposForOrgSecretInput,
  output: CodespacesListSelectedReposForOrgSecretOutput,
  errors: [NotFoundError],
  func: async ({ github }, data) => {
    return github.call("GET", "/orgs/{org}/codespaces/secrets/{secret_name}/repositories", data) as any
  },
})
