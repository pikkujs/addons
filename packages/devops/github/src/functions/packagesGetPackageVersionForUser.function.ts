...
export const PackagesGetPackageVersionForUserInput = z.object({
...
export const PackagesGetPackageVersionForUserOutput = z.object({
...
export const packagesGetPackageVersionForUser = pikkuSessionlessFunc({
  ...
  input: PackagesGetPackageVersionForUserInput,
  output: PackagesGetPackageVersionForUserOutput,
  func: async ({ github }, data) => {
    return github.call("GET", "/users/{username}/packages/{package_type}/{package_name}/versions/{package_version_id}", data) as any
  },
})
