...
export const GistsGetInput = z.object({
  gist_id: z.string().describe("The unique identifier of the gist."),
})

export const GistsGetOutput = z.object({
...
export const gistsGet = pikkuSessionlessFunc({
  input: GistsGetInput,
  output: GistsGetOutput,
  errors: [ForbiddenError, NotFoundError],
  func: async ({ github }, data) => {
    return github.call("GET", "/gists/{gist_id}", data) as any
  },
})
