...
export const ReposListBranchesInput = z.object({
  owner: z.string().describe("The account owner of the repository. The name is not case sensitive."),
  repo: z.string().describe("The name of the repository. The name is not case sensitive."),
  protected: z.boolean().optional().describe("Setting to `true` returns only protected branches. When set to `false`, only unprotected branches are returned. Omitting this parameter returns all branches."),
  per_page: z.number().int().optional().default(30).describe("The number of results per page (max 100)."),
  page: z.number().int().optional().default(1).describe("Page number of the results to fetch."),
})

export const ReposListBranchesOutput = z.array(z.object({
  commit: z.object({
    sha: z.string(),
    url: z.string().url(),
  }),
  ...
  protection: z.object({
    ...
    url: z.string().optional(),
  }).optional().describe("Branch Protection"),
  protection_url: z.string().url().optional(),
}))

export const reposListBranches = pikkuSessionlessFunc({
  input: ReposListBranchesInput,
  output: ReposListBranchesOutput,
  errors: [NotFoundError],
  func: async ({ github }, data) => {
    return github.call("GET", "/repos/{owner}/{repo}/branches", data) as any
  },
})
