...
export const ReposGetBranchInput = z.object({
...
export const ReposGetBranchOutput = z.object({
  _links: z.object({
    html: z.string(),
    self: z.string().url(),
  }),
...
export const reposGetBranch = pikkuSessionlessFunc({
  input: ReposGetBranchInput,
  output: ReposGetBranchOutput,
  errors: [NotFoundError],
  func: async ({ github }, data) => {
    return github.call("GET", "/repos/{owner}/{repo}/branches/{branch}", data) as any
  },
})
