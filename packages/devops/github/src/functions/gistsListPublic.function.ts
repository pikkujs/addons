...
export const GistsListPublicInput = z.object({
...
export const GistsListPublicOutput = z.array(z.object({
...
export const gistsListPublic = pikkuSessionlessFunc({
  ...
  input: GistsListPublicInput,
  output: GistsListPublicOutput,
  errors: [ForbiddenError, UnprocessableContentError],
  func: async ({ github }, data) => {
    return github.call("GET", "/gists/public", data) as any
  },
})
