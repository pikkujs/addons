...
export const AppsListInstallationReposForAuthenticatedUserInput = z.object({
  installation_id: z.number().int().describe("The unique identifier of the installation."),
  per_page: z.number().int().optional().default(30).describe("The number of results per page (max 100)."),
  page: z.number().int().optional().default(1).describe("Page number of the results to fetch."),
})

export const AppsListInstallationReposForAuthenticatedUserOutput = z.object({
...
export const appsListInstallationReposForAuthenticatedUser = pikkuSessionlessFunc({
  ...
  input: AppsListInstallationReposForAuthenticatedUserInput,
  output: AppsListInstallationReposForAuthenticatedUserOutput,
  errors: [ForbiddenError, NotFoundError],
  func: async ({ github }, data) => {
    return github.call("GET", "/user/installations/{installation_id}/repositories", data) as any
  },
})
