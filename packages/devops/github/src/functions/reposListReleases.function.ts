...
export const ReposListReleasesInput = z.object({
...
export const ReposListReleasesOutput = z.array(z.object({
...
export const reposListReleases = pikkuSessionlessFunc({
  ...
  input: ReposListReleasesInput,
  output: ReposListReleasesOutput,
  errors: [NotFoundError],
  func: async ({ github }, data) => {
    return github.call("GET", "/repos/{owner}/{repo}/releases", data) as any
  },
})
