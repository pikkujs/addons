...
export const PackagesGetAllPackageVersionsForPackageOwnedByOrgInput = z.object({
...
export const PackagesGetAllPackageVersionsForPackageOwnedByOrgOutput = z.array(z.object({
...
export const packagesGetAllPackageVersionsForPackageOwnedByOrg = pikkuSessionlessFunc({
  ...
  input: PackagesGetAllPackageVersionsForPackageOwnedByOrgInput,
  output: PackagesGetAllPackageVersionsForPackageOwnedByOrgOutput,
  errors: [UnauthorizedError, ForbiddenError, NotFoundError],
  func: async ({ github }, data) => {
    return github.call("GET", "/orgs/{org}/packages/{package_type}/{package_name}/versions", data) as any
  },
})
