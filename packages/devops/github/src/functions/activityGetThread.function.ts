...
export const ActivityGetThreadInput = z.object({
...
export const ActivityGetThreadOutput = z.object({
  id: z.string(),
...
export const activityGetThread = pikkuSessionlessFunc({
  description: "Gets information about a notification thread.",
  input: ActivityGetThreadInput,
  output: ActivityGetThreadOutput,
  errors: [UnauthorizedError, ForbiddenError],
  func: async ({ github }, data) => {
    return github.call("GET", "/notifications/threads/{thread_id}", data) as any
  },
})
