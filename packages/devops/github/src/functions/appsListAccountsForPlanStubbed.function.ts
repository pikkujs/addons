...
export const AppsListAccountsForPlanStubbedInput = z.object({
...
export const AppsListAccountsForPlanStubbedOutput = z.array(z.object({
...
export const appsListAccountsForPlanStubbed = pikkuSessionlessFunc({
  ...
  input: AppsListAccountsForPlanStubbedInput,
  output: AppsListAccountsForPlanStubbedOutput,
  errors: [UnauthorizedError],
  func: async ({ github }, data) => {
    return github.call("GET", "/marketplace_listing/stubbed/plans/{plan_id}/accounts", data) as any
  },
})
