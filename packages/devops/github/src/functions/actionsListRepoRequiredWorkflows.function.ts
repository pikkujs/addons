...
export const ActionsListRepoRequiredWorkflowsInput = z.object({
...
export const ActionsListRepoRequiredWorkflowsOutput = z.object({
...
export const actionsListRepoRequiredWorkflows = pikkuSessionlessFunc({
  ...
  input: ActionsListRepoRequiredWorkflowsInput,
  output: ActionsListRepoRequiredWorkflowsOutput,
  errors: [NotFoundError],
  func: async ({ github }, data) => {
    return github.call("GET", "/repos/{org}/{repo}/actions/required_workflows", data) as any
  },
})
