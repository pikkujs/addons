...
export const ReposTransferInput = z.object({
  owner: z.string().describe("The account owner of the repository. The name is not case sensitive."),
  repo: z.string().describe("The name of the repository. The name is not case sensitive."),
  new_name: z.string().optional().describe("The new name to be given to the repository."),
  new_owner: z.string().describe("The username or organization name the repository will be transferred to."),
  team_ids: z.array(z.number().int()).optional().describe("ID of the team or teams to add to the repository. Teams can only be added to organization-owned repositories."),
})

export const ReposTransferOutput = z.object({
...
export const reposTransfer = pikkuSessionlessFunc({
  description: "A transfer request will need to be accepted by the new owner when transferring a personal repository to another user. The response will contain the original `owner`, and the transfer will continue asynchronously. For more details on the requirements to transfer personal and organization-owned repositories, see [about repository transfers](https://docs.github.com/articles/about-repository-transfers/).",
  input: ReposTransferInput,
  output: ReposTransferOutput,
  func: async ({ github }, data) => {
    return github.call("POST", "/repos/{owner}/{repo}/transfer", data) as any
  },
})
