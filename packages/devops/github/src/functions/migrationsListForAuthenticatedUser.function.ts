...
export const MigrationsListForAuthenticatedUserInput = z.object({
  per_page: z.number().int().optional().default(30).describe("The number of results per page (max 100)."),
  page: z.number().int().optional().default(1).describe("Page number of the results to fetch."),
})

export const MigrationsListForAuthenticatedUserOutput = z.array(z.object({
...
export const migrationsListForAuthenticatedUser = pikkuSessionlessFunc({
  description: "Lists all migrations a user has started.",
  input: MigrationsListForAuthenticatedUserInput,
  output: MigrationsListForAuthenticatedUserOutput,
  errors: [UnauthorizedError, ForbiddenError],
  func: async ({ github }, data) => {
    return github.call("GET", "/user/migrations", data) as any
  },
})
