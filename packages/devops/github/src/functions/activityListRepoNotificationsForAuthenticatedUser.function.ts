...
export const ActivityListRepoNotificationsForAuthenticatedUserInput = z.object({
...
export const ActivityListRepoNotificationsForAuthenticatedUserOutput = z.array(z.object({
  id: z.string(),
...
export const activityListRepoNotificationsForAuthenticatedUser = pikkuSessionlessFunc({
  description: "Lists all notifications for the current user in the specified repository.",
  input: ActivityListRepoNotificationsForAuthenticatedUserInput,
  output: ActivityListRepoNotificationsForAuthenticatedUserOutput,
  func: async ({ github }, data) => {
    return github.call("GET", "/repos/{owner}/{repo}/notifications", data) as any
  },
})
