...
export const PackagesDeletePackageVersionForOrgInput = z.object({
...
export const packagesDeletePackageVersionForOrg = pikkuSessionlessFunc({
  ...
  input: PackagesDeletePackageVersionForOrgInput,
  errors: [UnauthorizedError, ForbiddenError, NotFoundError],
  func: async ({ github }, data) => {
    return github.call("DELETE", "/orgs/{org}/packages/{package_type}/{package_name}/versions/{package_version_id}", data)
  },
})
