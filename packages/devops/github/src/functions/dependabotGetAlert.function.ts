...
export const DependabotGetAlertInput = z.object({
...
export const DependabotGetAlertOutput = z.object({
...
export const dependabotGetAlert = pikkuSessionlessFunc({
  ...
  input: DependabotGetAlertInput,
  output: DependabotGetAlertOutput,
  errors: [ForbiddenError, NotFoundError],
  func: async ({ github }, data) => {
    return github.call("GET", "/repos/{owner}/{repo}/dependabot/alerts/{alert_number}", data) as any
  },
})
