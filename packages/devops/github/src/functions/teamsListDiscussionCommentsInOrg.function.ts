...
export const TeamsListDiscussionCommentsInOrgInput = z.object({
...
export const TeamsListDiscussionCommentsInOrgOutput = z.array(z.object({
  author: z.object({
...
export const teamsListDiscussionCommentsInOrg = pikkuSessionlessFunc({
  ...
  input: TeamsListDiscussionCommentsInOrgInput,
  output: TeamsListDiscussionCommentsInOrgOutput,
  func: async ({ github }, data) => {
    return github.call("GET", "/orgs/{org}/teams/{team_slug}/discussions/{discussion_number}/comments", data) as any
  },
})
