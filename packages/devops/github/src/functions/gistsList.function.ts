...
export const GistsListInput = z.object({
...
export const GistsListOutput = z.array(z.object({
...
export const gistsList = pikkuSessionlessFunc({
  description: "Lists the authenticated user's gists or if called anonymously, this endpoint returns all public gists:",
  input: GistsListInput,
  output: GistsListOutput,
  errors: [ForbiddenError],
  func: async ({ github }, data) => {
    return github.call("GET", "/gists", data) as any
  },
})
