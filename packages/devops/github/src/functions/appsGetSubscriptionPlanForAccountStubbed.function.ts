...
export const AppsGetSubscriptionPlanForAccountStubbedInput = z.object({
  account_id: z.number().int().describe("account_id parameter"),
})

export const AppsGetSubscriptionPlanForAccountStubbedOutput = z.object({
...
export const appsGetSubscriptionPlanForAccountStubbed = pikkuSessionlessFunc({
  ...
  input: AppsGetSubscriptionPlanForAccountStubbedInput,
  output: AppsGetSubscriptionPlanForAccountStubbedOutput,
  errors: [UnauthorizedError, NotFoundError],
  func: async ({ github }, data) => {
    return github.call("GET", "/marketplace_listing/stubbed/accounts/{account_id}", data) as any
  },
})
