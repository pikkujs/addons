...
export const IssuesListCommentsForRepoInput = z.object({
...
export const IssuesListCommentsForRepoOutput = z.array(z.object({
...
export const issuesListCommentsForRepo = pikkuSessionlessFunc({
  description: "By default, Issue Comments are ordered by ascending ID.",
  input: IssuesListCommentsForRepoInput,
  output: IssuesListCommentsForRepoOutput,
  errors: [NotFoundError, UnprocessableContentError],
  func: async ({ github }, data) => {
    return github.call("GET", "/repos/{owner}/{repo}/issues/comments", data) as any
  },
})
