...
export const OrgsGetWebhookConfigForOrgInput = z.object({
  org: z.string().describe("The organization name. The name is not case sensitive."),
  hook_id: z.number().int().describe("The unique identifier of the hook."),
})

export const OrgsGetWebhookConfigForOrgOutput = z.object({
...
export const orgsGetWebhookConfigForOrg = pikkuSessionlessFunc({
  ...
  input: OrgsGetWebhookConfigForOrgInput,
  output: OrgsGetWebhookConfigForOrgOutput,
  func: async ({ github }, data) => {
    return github.call("GET", "/orgs/{org}/hooks/{hook_id}/config", data) as any
  },
})
