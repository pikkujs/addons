...
export const IssuesListForOrgInput = z.object({
...
export const IssuesListForOrgOutput = z.any()

export const issuesListForOrg = pikkuSessionlessFunc({
  ...
  input: IssuesListForOrgInput,
  output: IssuesListForOrgOutput,
  errors: [NotFoundError],
  func: async ({ github }, data) => {
    return github.call("GET", "/orgs/{org}/issues", data) as any
  },
})
