...
export const ActionsCreateRequiredWorkflowInput = z.object({
  org: z.string().describe("The organization name. The name is not case sensitive."),
  repository_id: z.string().describe("The ID of the repository that contains the workflow file."),
  ...
  selected_repository_ids: z.array(z.number().int()).optional().describe("A list of repository IDs where you want to enable the required workflow. You can only provide a list of repository ids when the `scope` is set to `selected`."),
  workflow_file_path: z.string().describe("Path of the workflow file to be configured as a required workflow."),
})

export const ActionsCreateRequiredWorkflowOutput = z.object({
...
export const actionsCreateRequiredWorkflow = pikkuSessionlessFunc({
  ...
  input: ActionsCreateRequiredWorkflowInput,
  output: ActionsCreateRequiredWorkflowOutput,
  errors: [UnprocessableContentError],
  func: async ({ github }, data) => {
    return github.call("POST", "/orgs/{org}/actions/required_workflows", data) as any
  },
})
