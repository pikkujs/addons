...
export const gistsCreateComment = pikkuSessionlessFunc({
  input: GistsCreateCommentInput,
  output: GistsCreateCommentOutput,
  errors: [ForbiddenError, NotFoundError],
  func: async ({ github }, data) => {
    return github.call("POST", "/gists/{gist_id}/comments", data) as any
  },
})
