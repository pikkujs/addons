...
export const ReposListCommitCommentsForRepoInput = z.object({
...
export const ReposListCommitCommentsForRepoOutput = z.array(z.object({
...
export const reposListCommitCommentsForRepo = pikkuSessionlessFunc({
  ...
  input: ReposListCommitCommentsForRepoInput,
  output: ReposListCommitCommentsForRepoOutput,
  func: async ({ github }, data) => {
    return github.call("GET", "/repos/{owner}/{repo}/comments", data) as any
  },
})
