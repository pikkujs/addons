...
export const PackagesGetPackageForUserInput = z.object({
...
export const PackagesGetPackageForUserOutput = z.object({
...
export const packagesGetPackageForUser = pikkuSessionlessFunc({
  ...
  input: PackagesGetPackageForUserInput,
  output: PackagesGetPackageForUserOutput,
  func: async ({ github }, data) => {
    return github.call("GET", "/users/{username}/packages/{package_type}/{package_name}", data) as any
  },
})
