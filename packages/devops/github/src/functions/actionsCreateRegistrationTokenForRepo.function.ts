...
export const ActionsCreateRegistrationTokenForRepoInput = z.object({
  owner: z.string().describe("The account owner of the repository. The name is not case sensitive."),
  repo: z.string().describe("The name of the repository. The name is not case sensitive."),
})

export const ActionsCreateRegistrationTokenForRepoOutput = z.object({
  expires_at: z.string().datetime().describe("The time this token expires"),
  ...
  })).optional().describe("The repositories this token has access to"),
  repository_selection: z.enum(["all", "selected"]).optional().describe("Describe whether all repositories have been selected or there's a selection involved"),
  single_file: z.string().nullable().optional(),
  token: z.string().describe("The token used for authentication"),
}).describe("Authentication Token")

export const actionsCreateRegistrationTokenForRepo = pikkuSessionlessFunc({
  ...
  input: ActionsCreateRegistrationTokenForRepoInput,
  output: ActionsCreateRegistrationTokenForRepoOutput,
  func: async ({ github }, data) => {
    return github.call("POST", "/repos/{owner}/{repo}/actions/runners/registration-token", data) as any
  },
})
