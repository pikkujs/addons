...
export const PackagesDeletePackageForAuthenticatedUserInput = z.object({
...
export const packagesDeletePackageForAuthenticatedUser = pikkuSessionlessFunc({
  ...
  input: PackagesDeletePackageForAuthenticatedUserInput,
  errors: [UnauthorizedError, ForbiddenError, NotFoundError],
  func: async ({ github }, data) => {
    return github.call("DELETE", "/user/packages/{package_type}/{package_name}", data)
  },
})
