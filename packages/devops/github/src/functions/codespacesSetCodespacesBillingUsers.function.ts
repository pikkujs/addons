...
export const CodespacesSetCodespacesBillingUsersInput = z.object({
...
export const codespacesSetCodespacesBillingUsers = pikkuSessionlessFunc({
  ...
  input: CodespacesSetCodespacesBillingUsersInput,
  errors: [BadRequestError, NotFoundError, UnprocessableContentError, InternalServerError],
  func: async ({ github }, data) => {
    return github.call("POST", "/orgs/{org}/codespaces/billing/selected_users", data)
  },
})
