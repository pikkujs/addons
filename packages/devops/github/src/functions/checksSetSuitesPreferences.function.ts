...
export const ChecksSetSuitesPreferencesInput = z.object({
  owner: z.string().describe("The account owner of the repository. The name is not case sensitive."),
  repo: z.string().describe("The name of the repository. The name is not case sensitive."),
  auto_trigger_checks: z.array(z.object({
...
})).optional().describe("Enables or disables automatic creation of CheckSuite events upon pushes to the repository. Enabled by default."),
})

export const ChecksSetSuitesPreferencesOutput = z.object({
...
export const checksSetSuitesPreferences = pikkuSessionlessFunc({
  ...
  input: ChecksSetSuitesPreferencesInput,
  output: ChecksSetSuitesPreferencesOutput,
  func: async ({ github }, data) => {
    return github.call("PATCH", "/repos/{owner}/{repo}/check-suites/preferences", data) as any
  },
})
