...
export const ActionsListSelectedReposForOrgVariableInput = z.object({
...
export const ActionsListSelectedReposForOrgVariableOutput = z.object({
...
export const actionsListSelectedReposForOrgVariable = pikkuSessionlessFunc({
  ...
  input: ActionsListSelectedReposForOrgVariableInput,
  output: ActionsListSelectedReposForOrgVariableOutput,
  errors: [ConflictError],
  func: async ({ github }, data) => {
    return github.call("GET", "/orgs/{org}/actions/variables/{name}/repositories", data) as any
  },
})
