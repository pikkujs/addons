...
export const ReposUpdateCommitCommentInput = z.object({
...
export const ReposUpdateCommitCommentOutput = z.object({
...
export const reposUpdateCommitComment = pikkuSessionlessFunc({
  input: ReposUpdateCommitCommentInput,
  output: ReposUpdateCommitCommentOutput,
  errors: [NotFoundError],
  func: async ({ github }, data) => {
    return github.call("PATCH", "/repos/{owner}/{repo}/comments/{comment_id}", data) as any
  },
})
