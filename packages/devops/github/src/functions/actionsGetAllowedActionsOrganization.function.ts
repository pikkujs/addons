...
export const ActionsGetAllowedActionsOrganizationInput = z.object({
  org: z.string().describe("The organization name. The name is not case sensitive."),
})

export const ActionsGetAllowedActionsOrganizationOutput = z.object({
...
export const actionsGetAllowedActionsOrganization = pikkuSessionlessFunc({
  ...
  input: ActionsGetAllowedActionsOrganizationInput,
  output: ActionsGetAllowedActionsOrganizationOutput,
  func: async ({ github }, data) => {
    return github.call("GET", "/orgs/{org}/actions/permissions/selected-actions", data) as any
  },
})
