...
export const DependabotListAlertsForEnterpriseInput = z.object({
...
export const DependabotListAlertsForEnterpriseOutput = z.array(z.object({
...
export const dependabotListAlertsForEnterprise = pikkuSessionlessFunc({
  ...
  input: DependabotListAlertsForEnterpriseInput,
  output: DependabotListAlertsForEnterpriseOutput,
  errors: [ForbiddenError, NotFoundError, UnprocessableContentError],
  func: async ({ github }, data) => {
    return github.call("GET", "/enterprises/{enterprise}/dependabot/alerts", data) as any
  },
})
