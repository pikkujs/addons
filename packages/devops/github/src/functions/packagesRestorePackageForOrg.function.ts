...
export const PackagesRestorePackageForOrgInput = z.object({
...
export const packagesRestorePackageForOrg = pikkuSessionlessFunc({
  ...
  input: PackagesRestorePackageForOrgInput,
  errors: [UnauthorizedError, ForbiddenError, NotFoundError],
  func: async ({ github }, data) => {
    return github.call("POST", "/orgs/{org}/packages/{package_type}/{package_name}/restore", data)
  },
})
