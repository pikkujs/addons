...
export const IssuesListCommentsInput = z.object({
...
export const IssuesListCommentsOutput = z.array(z.object({
...
export const issuesListComments = pikkuSessionlessFunc({
  description: "Issue Comments are ordered by ascending ID.",
  input: IssuesListCommentsInput,
  output: IssuesListCommentsOutput,
  errors: [NotFoundError],
  func: async ({ github }, data) => {
    return github.call("GET", "/repos/{owner}/{repo}/issues/{issue_number}/comments", data) as any
  },
})
