...
export const ReposGetReadmeInDirectoryInput = z.object({
...
export const ReposGetReadmeInDirectoryOutput = z.object({
  _links: z.object({
...
export const reposGetReadmeInDirectory = pikkuSessionlessFunc({
  description: "Gets the README from a repository directory.\n\nREADMEs support [custom media types](https://docs.github.com/rest/reference/repos#custom-media-types) for retrieving the raw content or rendered HTML.",
  input: ReposGetReadmeInDirectoryInput,
  output: ReposGetReadmeInDirectoryOutput,
  errors: [NotFoundError, UnprocessableContentError],
  func: async ({ github }, data) => {
    return github.call("GET", "/repos/{owner}/{repo}/readme/{dir}", data) as any
  },
})
