...
export const ActionsGetRequiredWorkflowInput = z.object({
  org: z.string().describe("The organization name. The name is not case sensitive."),
  required_workflow_id: z.number().int().describe("The unique identifier of the required workflow."),
})

export const ActionsGetRequiredWorkflowOutput = z.object({
...
export const actionsGetRequiredWorkflow = pikkuSessionlessFunc({
  ...
  input: ActionsGetRequiredWorkflowInput,
  output: ActionsGetRequiredWorkflowOutput,
  func: async ({ github }, data) => {
    return github.call("GET", "/orgs/{org}/actions/required_workflows/{required_workflow_id}", data) as any
  },
})
