...
export const PullsGetReviewInput = z.object({
...
export const PullsGetReviewOutput = z.object({
  _links: z.object({
    html: z.object({
      href: z.string(),
    }),
...
export const pullsGetReview = pikkuSessionlessFunc({
  input: PullsGetReviewInput,
  output: PullsGetReviewOutput,
  errors: [NotFoundError],
  func: async ({ github }, data) => {
    return github.call("GET", "/repos/{owner}/{repo}/pulls/{pull_number}/reviews/{review_id}", data) as any
  },
})
