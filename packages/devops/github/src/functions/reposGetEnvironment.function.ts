...
export const reposGetEnvironment = pikkuSessionlessFunc({
  ...
  input: ReposGetEnvironmentInput,
  output: ReposGetEnvironmentOutput,
  func: async ({ github }, data) => {
    return github.call("GET", "/repos/{owner}/{repo}/environments/{environment_name}", data) as any
  },
})
