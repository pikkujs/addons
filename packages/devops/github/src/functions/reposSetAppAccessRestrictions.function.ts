...
export const ReposSetAppAccessRestrictionsInput = z.object({
...
export const ReposSetAppAccessRestrictionsOutput = z.array(z.object({
...
export const reposSetAppAccessRestrictions = pikkuSessionlessFunc({
  ...
  input: ReposSetAppAccessRestrictionsInput,
  output: ReposSetAppAccessRestrictionsOutput,
  errors: [UnprocessableContentError],
  func: async ({ github }, data) => {
    return github.call("PUT", "/repos/{owner}/{repo}/branches/{branch}/protection/restrictions/apps", data) as any
  },
})
