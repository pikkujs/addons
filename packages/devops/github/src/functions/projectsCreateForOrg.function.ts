...
export const ProjectsCreateForOrgInput = z.object({
  org: z.string().describe("The organization name. The name is not case sensitive."),
  body: z.string().optional().describe("The description of the project."),
  name: z.string().describe("The name of the project."),
})

export const ProjectsCreateForOrgOutput = z.object({
...
export const projectsCreateForOrg = pikkuSessionlessFunc({
  ...
  input: ProjectsCreateForOrgInput,
  output: ProjectsCreateForOrgOutput,
  errors: [UnauthorizedError, ForbiddenError, NotFoundError, UnprocessableContentError],
  func: async ({ github }, data) => {
    return github.call("POST", "/orgs/{org}/projects", data) as any
  },
})
