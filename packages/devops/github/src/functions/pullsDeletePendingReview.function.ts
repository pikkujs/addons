...
export const PullsDeletePendingReviewInput = z.object({
...
export const PullsDeletePendingReviewOutput = z.object({
  _links: z.object({
    html: z.object({
      href: z.string(),
    }),
...
export const pullsDeletePendingReview = pikkuSessionlessFunc({
  input: PullsDeletePendingReviewInput,
  output: PullsDeletePendingReviewOutput,
  errors: [NotFoundError, UnprocessableContentError],
  func: async ({ github }, data) => {
    return github.call("DELETE", "/repos/{owner}/{repo}/pulls/{pull_number}/reviews/{review_id}", data) as any
  },
})
