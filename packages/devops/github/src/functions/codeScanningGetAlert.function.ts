...
export const CodeScanningGetAlertInput = z.object({
...
export const CodeScanningGetAlertOutput = z.object({
...
export const codeScanningGetAlert = pikkuSessionlessFunc({
  ...
  input: CodeScanningGetAlertInput,
  output: CodeScanningGetAlertOutput,
  errors: [ForbiddenError, NotFoundError],
  func: async ({ github }, data) => {
    return github.call("GET", "/repos/{owner}/{repo}/code-scanning/alerts/{alert_number}", data) as any
  },
})
