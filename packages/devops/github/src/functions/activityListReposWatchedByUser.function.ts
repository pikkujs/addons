...
export const ActivityListReposWatchedByUserInput = z.object({
  username: z.string().describe("The handle for the GitHub user account."),
  per_page: z.number().int().optional().default(30).describe("The number of results per page (max 100)."),
  page: z.number().int().optional().default(1).describe("Page number of the results to fetch."),
})

export const ActivityListReposWatchedByUserOutput = z.array(z.object({
...
export const activityListReposWatchedByUser = pikkuSessionlessFunc({
  description: "Lists repositories a user is watching.",
  input: ActivityListReposWatchedByUserInput,
  output: ActivityListReposWatchedByUserOutput,
  func: async ({ github }, data) => {
    return github.call("GET", "/users/{username}/subscriptions", data) as any
  },
})
