...
export const CodespacesListRepositoriesForSecretForAuthenticatedUserInput = z.object({
  secret_name: z.string().describe("The name of the secret."),
})

export const CodespacesListRepositoriesForSecretForAuthenticatedUserOutput = z.object({
...
export const codespacesListRepositoriesForSecretForAuthenticatedUser = pikkuSessionlessFunc({
  ...
  input: CodespacesListRepositoriesForSecretForAuthenticatedUserInput,
  output: CodespacesListRepositoriesForSecretForAuthenticatedUserOutput,
  errors: [UnauthorizedError, ForbiddenError, NotFoundError, InternalServerError],
  func: async ({ github }, data) => {
    return github.call("GET", "/user/codespaces/secrets/{secret_name}/repositories", data) as any
  },
})
