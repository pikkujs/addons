...
export const ReposUpdateInvitationInput = z.object({
  owner: z.string().describe("The account owner of the repository. The name is not case sensitive."),
  repo: z.string().describe("The name of the repository. The name is not case sensitive."),
  invitation_id: z.number().int().describe("The unique identifier of the invitation."),
  permissions: z.enum(["read", "write", "maintain", "triage", "admin"]).optional().describe("The permissions that the associated user will have on the repository. Valid values are `read`, `write`, `maintain`, `triage`, and `admin`."),
})

export const ReposUpdateInvitationOutput = z.object({
...
export const reposUpdateInvitation = pikkuSessionlessFunc({
  input: ReposUpdateInvitationInput,
  output: ReposUpdateInvitationOutput,
  func: async ({ github }, data) => {
    return github.call("PATCH", "/repos/{owner}/{repo}/invitations/{invitation_id}", data) as any
  },
})
