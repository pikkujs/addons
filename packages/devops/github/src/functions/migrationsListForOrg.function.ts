...
export const MigrationsListForOrgOutput = z.array(z.object({
...
export const migrationsListForOrg = pikkuSessionlessFunc({
  ...
  input: MigrationsListForOrgInput,
  output: MigrationsListForOrgOutput,
  func: async ({ github }, data) => {
    return github.call("GET", "/orgs/{org}/migrations", data) as any
  },
})
