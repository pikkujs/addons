...
export const PullsUpdateReviewCommentInput = z.object({
...
export const PullsUpdateReviewCommentOutput = z.object({
  _links: z.object({
    html: z.object({
      href: z.string().url(),
    }),
...
export const pullsUpdateReviewComment = pikkuSessionlessFunc({
  description: "Enables you to edit a review comment.",
  input: PullsUpdateReviewCommentInput,
  output: PullsUpdateReviewCommentOutput,
  func: async ({ github }, data) => {
    return github.call("PATCH", "/repos/{owner}/{repo}/pulls/comments/{comment_id}", data) as any
  },
})
