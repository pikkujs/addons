...
export const PackagesRestorePackageVersionForAuthenticatedUserInput = z.object({
...
export const packagesRestorePackageVersionForAuthenticatedUser = pikkuSessionlessFunc({
  ...
  input: PackagesRestorePackageVersionForAuthenticatedUserInput,
  errors: [UnauthorizedError, ForbiddenError, NotFoundError],
  func: async ({ github }, data) => {
    return github.call("POST", "/user/packages/{package_type}/{package_name}/versions/{package_version_id}/restore", data)
  },
})
