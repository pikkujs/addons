...
export const PackagesListPackagesForUserOutput = z.array(z.object({
...
export const packagesListPackagesForUser = pikkuSessionlessFunc({
  ...
  input: PackagesListPackagesForUserInput,
  output: PackagesListPackagesForUserOutput,
  errors: [UnauthorizedError, ForbiddenError],
  func: async ({ github }, data) => {
    return github.call("GET", "/users/{username}/packages", data) as any
  },
})
