...
export const ActionsCreateOrgVariableInput = z.object({
...
export const ActionsCreateOrgVariableOutput = z.record(z.string(), z.unknown()).describe("An object without any properties.")

export const actionsCreateOrgVariable = pikkuSessionlessFunc({
  ...
  input: ActionsCreateOrgVariableInput,
  output: ActionsCreateOrgVariableOutput,
  func: async ({ github }, data) => {
    return github.call("POST", "/orgs/{org}/actions/variables", data) as any
  },
})
