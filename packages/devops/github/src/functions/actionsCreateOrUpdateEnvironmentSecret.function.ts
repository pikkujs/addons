...
export const ActionsCreateOrUpdateEnvironmentSecretInput = z.object({
...
export const ActionsCreateOrUpdateEnvironmentSecretOutput = z.record(z.string(), z.unknown()).describe("An object without any properties.")

export const actionsCreateOrUpdateEnvironmentSecret = pikkuSessionlessFunc({
  ...
  input: ActionsCreateOrUpdateEnvironmentSecretInput,
  output: ActionsCreateOrUpdateEnvironmentSecretOutput,
  func: async ({ github }, data) => {
    return github.call("PUT", "/repositories/{repository_id}/environments/{environment_name}/secrets/{secret_name}", data) as any
  },
})
