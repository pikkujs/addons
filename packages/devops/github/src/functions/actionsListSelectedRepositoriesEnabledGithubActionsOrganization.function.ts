...
export const ActionsListSelectedRepositoriesEnabledGithubActionsOrganizationInput = z.object({
  org: z.string().describe("The organization name. The name is not case sensitive."),
  per_page: z.number().int().optional().default(30).describe("The number of results per page (max 100)."),
  page: z.number().int().optional().default(1).describe("Page number of the results to fetch."),
})

export const ActionsListSelectedRepositoriesEnabledGithubActionsOrganizationOutput = z.object({
...
export const actionsListSelectedRepositoriesEnabledGithubActionsOrganization = pikkuSessionlessFunc({
  ...
  input: ActionsListSelectedRepositoriesEnabledGithubActionsOrganizationInput,
  output: ActionsListSelectedRepositoriesEnabledGithubActionsOrganizationOutput,
  func: async ({ github }, data) => {
    return github.call("GET", "/orgs/{org}/actions/permissions/repositories", data) as any
  },
})
