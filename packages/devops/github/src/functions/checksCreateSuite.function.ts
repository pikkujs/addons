...
export const ChecksCreateSuiteInput = z.object({
  owner: z.string().describe("The account owner of the repository. The name is not case sensitive."),
  repo: z.string().describe("The name of the repository. The name is not case sensitive."),
  head_sha: z.string().describe("The sha of the head commit."),
})

export const ChecksCreateSuiteOutput = z.object({
...
export const checksCreateSuite = pikkuSessionlessFunc({
  ...
  input: ChecksCreateSuiteInput,
  output: ChecksCreateSuiteOutput,
  func: async ({ github }, data) => {
    return github.call("POST", "/repos/{owner}/{repo}/check-suites", data) as any
  },
})
