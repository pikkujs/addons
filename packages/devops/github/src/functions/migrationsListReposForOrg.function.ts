...
export const MigrationsListReposForOrgInput = z.object({
...
export const MigrationsListReposForOrgOutput = z.array(z.object({
...
export const migrationsListReposForOrg = pikkuSessionlessFunc({
  description: "List all the repositories for this organization migration.",
  input: MigrationsListReposForOrgInput,
  output: MigrationsListReposForOrgOutput,
  errors: [NotFoundError],
  func: async ({ github }, data) => {
    return github.call("GET", "/orgs/{org}/migrations/{migration_id}/repositories", data) as any
  },
})
