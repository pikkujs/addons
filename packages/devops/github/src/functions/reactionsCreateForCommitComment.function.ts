...
export const ReactionsCreateForCommitCommentInput = z.object({
  owner: z.string().describe("The account owner of the repository. The name is not case sensitive."),
  repo: z.string().describe("The name of the repository. The name is not case sensitive."),
  comment_id: z.number().int().describe("The unique identifier of the comment."),
  content: z.enum(["+1", "-1", "laugh", "confused", "heart", "hooray", "rocket", "eyes"]).describe("The [reaction type](https://docs.github.com/rest/reference/reactions#reaction-types) to add to the commit comment."),
})

export const ReactionsCreateForCommitCommentOutput = z.object({
...
export const reactionsCreateForCommitComment = pikkuSessionlessFunc({
  ...
  input: ReactionsCreateForCommitCommentInput,
  output: ReactionsCreateForCommitCommentOutput,
  errors: [UnprocessableContentError],
  func: async ({ github }, data) => {
    return github.call("POST", "/repos/{owner}/{repo}/comments/{comment_id}/reactions", data) as any
  },
})
