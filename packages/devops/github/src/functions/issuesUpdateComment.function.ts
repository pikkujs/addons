...
export const IssuesUpdateCommentInput = z.object({
...
export const IssuesUpdateCommentOutput = z.object({
...
export const issuesUpdateComment = pikkuSessionlessFunc({
  input: IssuesUpdateCommentInput,
  output: IssuesUpdateCommentOutput,
  errors: [UnprocessableContentError],
  func: async ({ github }, data) => {
    return github.call("PATCH", "/repos/{owner}/{repo}/issues/comments/{comment_id}", data) as any
  },
})
