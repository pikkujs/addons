...
export const ActionsListSelectedRepositoriesRequiredWorkflowInput = z.object({
  org: z.string().describe("The organization name. The name is not case sensitive."),
  required_workflow_id: z.number().int().describe("The unique identifier of the required workflow."),
})

export const ActionsListSelectedRepositoriesRequiredWorkflowOutput = z.object({
...
export const actionsListSelectedRepositoriesRequiredWorkflow = pikkuSessionlessFunc({
  ...
  input: ActionsListSelectedRepositoriesRequiredWorkflowInput,
  output: ActionsListSelectedRepositoriesRequiredWorkflowOutput,
  errors: [NotFoundError],
  func: async ({ github }, data) => {
    return github.call("GET", "/orgs/{org}/actions/required_workflows/{required_workflow_id}/repositories", data) as any
  },
})
