...
export const ActionsEnableWorkflowInput = z.object({
...
export const actionsEnableWorkflow = pikkuSessionlessFunc({
  ...
  func: async ({ github }, data) => {
    return github.call("PUT", "/repos/{owner}/{repo}/actions/workflows/{workflow_id}/enable", data)
  },
})
