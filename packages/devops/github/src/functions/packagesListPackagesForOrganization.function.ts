...
export const PackagesListPackagesForOrganizationInput = z.object({
...
export const PackagesListPackagesForOrganizationOutput = z.array(z.object({
...
export const packagesListPackagesForOrganization = pikkuSessionlessFunc({
  ...
  input: PackagesListPackagesForOrganizationInput,
  output: PackagesListPackagesForOrganizationOutput,
  errors: [UnauthorizedError, ForbiddenError],
  func: async ({ github }, data) => {
    return github.call("GET", "/orgs/{org}/packages", data) as any
  },
})
