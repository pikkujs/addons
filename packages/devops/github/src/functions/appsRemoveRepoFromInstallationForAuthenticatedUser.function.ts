...
export const AppsRemoveRepoFromInstallationForAuthenticatedUserInput = z.object({
...
export const appsRemoveRepoFromInstallationForAuthenticatedUser = pikkuSessionlessFunc({
  ...
  input: AppsRemoveRepoFromInstallationForAuthenticatedUserInput,
  errors: [ForbiddenError, NotFoundError],
  func: async ({ github }, data) => {
    return github.call("DELETE", "/user/installations/{installation_id}/repositories/{repository_id}", data)
  },
})
