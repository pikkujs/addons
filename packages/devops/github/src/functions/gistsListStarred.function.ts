...
export const GistsListStarredInput = z.object({
...
export const GistsListStarredOutput = z.array(z.object({
...
export const gistsListStarred = pikkuSessionlessFunc({
  description: "List the authenticated user's starred gists:",
  input: GistsListStarredInput,
  output: GistsListStarredOutput,
  errors: [UnauthorizedError, ForbiddenError],
  func: async ({ github }, data) => {
    return github.call("GET", "/gists/starred", data) as any
  },
})
