...
export const ReposGetCombinedStatusForRefInput = z.object({
...
export const ReposGetCombinedStatusForRefOutput = z.object({
...
export const reposGetCombinedStatusForRef = pikkuSessionlessFunc({
  ...
  input: ReposGetCombinedStatusForRefInput,
  output: ReposGetCombinedStatusForRefOutput,
  errors: [NotFoundError],
  func: async ({ github }, data) => {
    return github.call("GET", "/repos/{owner}/{repo}/commits/{ref}/status", data) as any
  },
})
