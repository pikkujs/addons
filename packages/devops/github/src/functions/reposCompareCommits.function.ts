...
export const ReposCompareCommitsInput = z.object({
...
export const ReposCompareCommitsOutput = z.object({
...
export const reposCompareCommits = pikkuSessionlessFunc({
  ...
  input: ReposCompareCommitsInput,
  output: ReposCompareCommitsOutput,
  errors: [NotFoundError, InternalServerError],
  func: async ({ github }, data) => {
    return github.call("GET", "/repos/{owner}/{repo}/compare/{basehead}", data) as any
  },
})
