...
export const ActionsCreateRemoveTokenForOrgInput = z.object({
  org: z.string().describe("The organization name. The name is not case sensitive."),
})

export const ActionsCreateRemoveTokenForOrgOutput = z.object({
...
export const actionsCreateRemoveTokenForOrg = pikkuSessionlessFunc({
  ...
  input: ActionsCreateRemoveTokenForOrgInput,
  output: ActionsCreateRemoveTokenForOrgOutput,
  func: async ({ github }, data) => {
    return github.call("POST", "/orgs/{org}/actions/runners/remove-token", data) as any
  },
})
