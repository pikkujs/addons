...
export const pullsGetReviewComment = pikkuSessionlessFunc({
  description: "Provides details for a review comment.",
  input: PullsGetReviewCommentInput,
  output: PullsGetReviewCommentOutput,
  errors: [NotFoundError],
  func: async ({ github }, data) => {
    return github.call("GET", "/repos/{owner}/{repo}/pulls/comments/{comment_id}", data) as any
  },
})
