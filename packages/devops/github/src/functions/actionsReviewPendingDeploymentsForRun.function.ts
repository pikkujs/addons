...
export const ActionsReviewPendingDeploymentsForRunInput = z.object({
...
export const ActionsReviewPendingDeploymentsForRunOutput = z.array(z.object({
...
export const actionsReviewPendingDeploymentsForRun = pikkuSessionlessFunc({
  ...
  input: ActionsReviewPendingDeploymentsForRunInput,
  output: ActionsReviewPendingDeploymentsForRunOutput,
  func: async ({ github }, data) => {
    return github.call("POST", "/repos/{owner}/{repo}/actions/runs/{run_id}/pending_deployments", data) as any
  },
})
