...
export const ActivityListNotificationsForAuthenticatedUserInput = z.object({
  all: z.boolean().optional().default(false).describe("If `true`, show notifications marked as read."),
  participating: z.boolean().optional().default(false).describe("If `true`, only shows notifications in which the user is directly participating or mentioned."),
  ...
  per_page: z.number().int().optional().default(50).describe("The number of results per page (max 50)."),
})

export const ActivityListNotificationsForAuthenticatedUserOutput = z.array(z.object({
  id: z.string(),
...
export const activityListNotificationsForAuthenticatedUser = pikkuSessionlessFunc({
  description: "List all notifications for the current user, sorted by most recently updated.",
  input: ActivityListNotificationsForAuthenticatedUserInput,
  output: ActivityListNotificationsForAuthenticatedUserOutput,
  errors: [UnauthorizedError, ForbiddenError, UnprocessableContentError],
  func: async ({ github }, data) => {
    return github.call("GET", "/notifications", data) as any
  },
})
