...
export const SecretScanningListAlertsForEnterpriseInput = z.object({
...
export const SecretScanningListAlertsForEnterpriseOutput = z.array(z.object({
...
export const secretScanningListAlertsForEnterprise = pikkuSessionlessFunc({
  ...
  input: SecretScanningListAlertsForEnterpriseInput,
  output: SecretScanningListAlertsForEnterpriseOutput,
  errors: [NotFoundError],
  func: async ({ github }, data) => {
    return github.call("GET", "/enterprises/{enterprise}/secret-scanning/alerts", data) as any
  },
})
