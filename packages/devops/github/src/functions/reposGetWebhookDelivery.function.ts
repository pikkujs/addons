...
export const ReposGetWebhookDeliveryInput = z.object({
...
export const ReposGetWebhookDeliveryOutput = z.object({
...
export const reposGetWebhookDelivery = pikkuSessionlessFunc({
  description: "Returns a delivery for a webhook configured in a repository.",
  input: ReposGetWebhookDeliveryInput,
  output: ReposGetWebhookDeliveryOutput,
  errors: [BadRequestError, UnprocessableContentError],
  func: async ({ github }, data) => {
    return github.call("GET", "/repos/{owner}/{repo}/hooks/{hook_id}/deliveries/{delivery_id}", data) as any
  },
})
