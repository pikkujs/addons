...
export const PackagesRestorePackageForUserInput = z.object({
...
export const packagesRestorePackageForUser = pikkuSessionlessFunc({
  ...
  input: PackagesRestorePackageForUserInput,
  errors: [UnauthorizedError, ForbiddenError, NotFoundError],
  func: async ({ github }, data) => {
    return github.call("POST", "/users/{username}/packages/{package_type}/{package_name}/restore", data)
  },
})
