...
export const GistsGetRevisionOutput = z.object({
...
export const gistsGetRevision = pikkuSessionlessFunc({
  input: GistsGetRevisionInput,
  output: GistsGetRevisionOutput,
  errors: [ForbiddenError, NotFoundError, UnprocessableContentError],
  func: async ({ github }, data) => {
    return github.call("GET", "/gists/{gist_id}/{sha}", data) as any
  },
})
