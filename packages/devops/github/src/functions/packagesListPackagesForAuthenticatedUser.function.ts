...
export const PackagesListPackagesForAuthenticatedUserInput = z.object({
  ...
  visibility: z.enum(["public", "private", "internal"]).optional().describe("The selected visibility of the packages.  This parameter is optional and only filters an existing result set.\n\nThe `internal` visibility is only supported for GitHub Packages registries that allow for granular permissions. For other ecosystems `internal` is synonymous with `private`.\nFor the list of GitHub Packages registries that support granular permissions, see \"[About permissions for GitHub Packages](https://docs.github.com/packages/learn-github-packages/about-permissions-for-github-packages#granular-permissions-for-userorganization-scoped-packages).\""),
})

export const PackagesListPackagesForAuthenticatedUserOutput = z.array(z.object({
...
export const packagesListPackagesForAuthenticatedUser = pikkuSessionlessFunc({
  ...
  input: PackagesListPackagesForAuthenticatedUserInput,
  output: PackagesListPackagesForAuthenticatedUserOutput,
  func: async ({ github }, data) => {
    return github.call("GET", "/user/packages", data) as any
  },
})
