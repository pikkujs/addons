...
export const ActionsListSelectedReposForOrgSecretInput = z.object({
...
export const ActionsListSelectedReposForOrgSecretOutput = z.object({
...
export const actionsListSelectedReposForOrgSecret = pikkuSessionlessFunc({
  ...
  input: ActionsListSelectedReposForOrgSecretInput,
  output: ActionsListSelectedReposForOrgSecretOutput,
  func: async ({ github }, data) => {
    return github.call("GET", "/orgs/{org}/actions/secrets/{secret_name}/repositories", data) as any
  },
})
