...
export const ReposListInvitationsForAuthenticatedUserInput = z.object({
  per_page: z.number().int().optional().default(30).describe("The number of results per page (max 100)."),
  page: z.number().int().optional().default(1).describe("Page number of the results to fetch."),
})

export const ReposListInvitationsForAuthenticatedUserOutput = z.array(z.object({
...
export const reposListInvitationsForAuthenticatedUser = pikkuSessionlessFunc({
  ...
  input: ReposListInvitationsForAuthenticatedUserInput,
  output: ReposListInvitationsForAuthenticatedUserOutput,
  errors: [UnauthorizedError, ForbiddenError, NotFoundError],
  func: async ({ github }, data) => {
    return github.call("GET", "/user/repository_invitations", data) as any
  },
})
