...
export const ActionsGetWorkflowAccessToRepositoryInput = z.object({
  owner: z.string().describe("The account owner of the repository. The name is not case sensitive."),
  repo: z.string().describe("The name of the repository. The name is not case sensitive."),
})

export const ActionsGetWorkflowAccessToRepositoryOutput = z.object({
...
export const actionsGetWorkflowAccessToRepository = pikkuSessionlessFunc({
  ...
  input: ActionsGetWorkflowAccessToRepositoryInput,
  output: ActionsGetWorkflowAccessToRepositoryOutput,
  func: async ({ github }, data) => {
    return github.call("GET", "/repos/{owner}/{repo}/actions/permissions/access", data) as any
  },
})
