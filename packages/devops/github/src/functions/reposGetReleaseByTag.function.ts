...
export const ReposGetReleaseByTagInput = z.object({
  owner: z.string().describe("The account owner of the repository. The name is not case sensitive."),
  repo: z.string().describe("The name of the repository. The name is not case sensitive."),
  tag: z.string().describe("tag parameter"),
})

export const ReposGetReleaseByTagOutput = z.object({
...
export const reposGetReleaseByTag = pikkuSessionlessFunc({
  description: "Get a published release with the specified tag.",
  input: ReposGetReleaseByTagInput,
  output: ReposGetReleaseByTagOutput,
  errors: [NotFoundError],
  func: async ({ github }, data) => {
    return github.call("GET", "/repos/{owner}/{repo}/releases/tags/{tag}", data) as any
  },
})
