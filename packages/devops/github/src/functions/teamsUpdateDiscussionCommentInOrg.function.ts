...
export const TeamsUpdateDiscussionCommentInOrgInput = z.object({
...
export const TeamsUpdateDiscussionCommentInOrgOutput = z.object({
  author: z.object({
...
export const teamsUpdateDiscussionCommentInOrg = pikkuSessionlessFunc({
  ...
  input: TeamsUpdateDiscussionCommentInOrgInput,
  output: TeamsUpdateDiscussionCommentInOrgOutput,
  func: async ({ github }, data) => {
    return github.call("PATCH", "/orgs/{org}/teams/{team_slug}/discussions/{discussion_number}/comments/{comment_number}", data) as any
  },
})
