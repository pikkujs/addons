...
export const PackagesGetPackageVersionForAuthenticatedUserInput = z.object({
...
export const PackagesGetPackageVersionForAuthenticatedUserOutput = z.object({
...
export const packagesGetPackageVersionForAuthenticatedUser = pikkuSessionlessFunc({
  ...
  input: PackagesGetPackageVersionForAuthenticatedUserInput,
  output: PackagesGetPackageVersionForAuthenticatedUserOutput,
  func: async ({ github }, data) => {
    return github.call("GET", "/user/packages/{package_type}/{package_name}/versions/{package_version_id}", data) as any
  },
})
