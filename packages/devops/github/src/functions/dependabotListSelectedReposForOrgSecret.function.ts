...
export const DependabotListSelectedReposForOrgSecretInput = z.object({
...
export const DependabotListSelectedReposForOrgSecretOutput = z.object({
...
export const dependabotListSelectedReposForOrgSecret = pikkuSessionlessFunc({
  ...
  input: DependabotListSelectedReposForOrgSecretInput,
  output: DependabotListSelectedReposForOrgSecretOutput,
  func: async ({ github }, data) => {
    return github.call("GET", "/orgs/{org}/dependabot/secrets/{secret_name}/repositories", data) as any
  },
})
