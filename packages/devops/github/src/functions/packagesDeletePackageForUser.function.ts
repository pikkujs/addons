...
export const PackagesDeletePackageForUserInput = z.object({
...
export const packagesDeletePackageForUser = pikkuSessionlessFunc({
  ...
  input: PackagesDeletePackageForUserInput,
  errors: [UnauthorizedError, ForbiddenError, NotFoundError],
  func: async ({ github }, data) => {
    return github.call("DELETE", "/users/{username}/packages/{package_type}/{package_name}", data)
  },
})
