...
export const PackagesGetPackageForAuthenticatedUserInput = z.object({
...
export const PackagesGetPackageForAuthenticatedUserOutput = z.object({
...
export const packagesGetPackageForAuthenticatedUser = pikkuSessionlessFunc({
  ...
  input: PackagesGetPackageForAuthenticatedUserInput,
  output: PackagesGetPackageForAuthenticatedUserOutput,
  func: async ({ github }, data) => {
    return github.call("GET", "/user/packages/{package_type}/{package_name}", data) as any
  },
})
