...
export const OrgsGetMembershipForAuthenticatedUserInput = z.object({
  org: z.string().describe("The organization name. The name is not case sensitive."),
})

export const OrgsGetMembershipForAuthenticatedUserOutput = z.object({
...
export const orgsGetMembershipForAuthenticatedUser = pikkuSessionlessFunc({
  input: OrgsGetMembershipForAuthenticatedUserInput,
  output: OrgsGetMembershipForAuthenticatedUserOutput,
  errors: [ForbiddenError, NotFoundError],
  func: async ({ github }, data) => {
    return github.call("GET", "/user/memberships/orgs/{org}", data) as any
  },
})
