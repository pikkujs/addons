...
export const TeamsCreateDiscussionCommentInOrgInput = z.object({
...
export const TeamsCreateDiscussionCommentInOrgOutput = z.object({
  author: z.object({
...
export const teamsCreateDiscussionCommentInOrg = pikkuSessionlessFunc({
  ...
  input: TeamsCreateDiscussionCommentInOrgInput,
  output: TeamsCreateDiscussionCommentInOrgOutput,
  func: async ({ github }, data) => {
    return github.call("POST", "/orgs/{org}/teams/{team_slug}/discussions/{discussion_number}/comments", data) as any
  },
})
