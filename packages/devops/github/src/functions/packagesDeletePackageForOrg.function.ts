...
export const PackagesDeletePackageForOrgInput = z.object({
...
export const packagesDeletePackageForOrg = pikkuSessionlessFunc({
  ...
  input: PackagesDeletePackageForOrgInput,
  errors: [UnauthorizedError, ForbiddenError, NotFoundError],
  func: async ({ github }, data) => {
    return github.call("DELETE", "/orgs/{org}/packages/{package_type}/{package_name}", data)
  },
})
