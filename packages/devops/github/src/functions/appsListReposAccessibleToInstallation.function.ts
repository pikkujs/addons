...
export const AppsListReposAccessibleToInstallationInput = z.object({
  per_page: z.number().int().optional().default(30).describe("The number of results per page (max 100)."),
  page: z.number().int().optional().default(1).describe("Page number of the results to fetch."),
})

export const AppsListReposAccessibleToInstallationOutput = z.object({
...
export const appsListReposAccessibleToInstallation = pikkuSessionlessFunc({
  description: "List repositories that an app installation can access.\n\nYou must use an [installation access token](https://docs.github.com/apps/building-github-apps/authenticating-with-github-apps/#authenticating-as-an-installation) to access this endpoint.",
  input: AppsListReposAccessibleToInstallationInput,
  output: AppsListReposAccessibleToInstallationOutput,
  errors: [UnauthorizedError, ForbiddenError],
  func: async ({ github }, data) => {
    return github.call("GET", "/installation/repositories", data) as any
  },
})
