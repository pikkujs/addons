...
export const PackagesGetAllPackageVersionsForPackageOwnedByUserInput = z.object({
...
export const PackagesGetAllPackageVersionsForPackageOwnedByUserOutput = z.array(z.object({
...
export const packagesGetAllPackageVersionsForPackageOwnedByUser = pikkuSessionlessFunc({
  ...
  input: PackagesGetAllPackageVersionsForPackageOwnedByUserInput,
  output: PackagesGetAllPackageVersionsForPackageOwnedByUserOutput,
  errors: [UnauthorizedError, ForbiddenError, NotFoundError],
  func: async ({ github }, data) => {
    return github.call("GET", "/users/{username}/packages/{package_type}/{package_name}/versions", data) as any
  },
})
