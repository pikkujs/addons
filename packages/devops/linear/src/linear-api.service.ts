...
const ROUTES: Record<string, { path: string[], query: string[], headers: string[], errors?: Record<number, string> }> = {
  "POST /graphql/issue/create": {
    "path": [],
    "query": [],
    "headers": []
  },
  "POST /graphql/issue/get": {
    "path": [],
    "query": [],
    "headers": []
  },
  "POST /graphql/issue/getAll": {
    "path": [],
    "query": [],
    "headers": []
  },
  "POST /graphql/issue/update": {
    "path": [],
    "query": [],
    "headers": []
  },
  "POST /graphql/issue/delete": {
    "path": [],
    "query": [],
    "headers": []
  },
  "POST /graphql/issue/addLink": {
    "path": [],
    "query": [],
    "headers": []
  },
  "POST /graphql/comment/addComment": {
    "path": [],
    "query": [],
    "headers": []
  }
...
export class LinearService {
  ...
  constructor(private creds: { apiKey: string }, variables: TypedVariablesService) {
    this.baseUrl = variables.get('LINEAR_BASE_URL') as string
  }
  ...
  async call<T>(
    ...
    if (!response.ok) {
      ...
      switch (response.status) {
        ...
        default: throw new Error(`Linear API error (${response.status}): ${errorText}`)
      }
    }
