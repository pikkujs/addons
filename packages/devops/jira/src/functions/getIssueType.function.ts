...
export const GetIssueTypeInput = z.object({
  id: z.string().describe("The ID of the issue type."),
})

export const GetIssueTypeOutput = z.object({
...
export const getIssueType = pikkuSessionlessFunc({
  ...
  input: GetIssueTypeInput,
  output: GetIssueTypeOutput,
  errors: [BadRequestError, UnauthorizedError, NotFoundError],
  func: async ({ jira }, data) => {
    return jira.call("GET", "/rest/api/3/issuetype/{id}", data) as any
  },
})
