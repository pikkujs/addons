...
export const PartialUpdateProjectRoleInput = z.object({
  ...
  description: z.string().optional().describe("A description of the project role. Required when fully updating a project role. Optional when creating or partially updating a project role."),
  name: z.string().optional().describe("The name of the project role. Must be unique. Cannot begin or end with whitespace. The maximum length is 255 characters. Required when creating a project role. Optional when partially updating a project role."),
})

export const PartialUpdateProjectRoleOutput = z.object({
...
export const partialUpdateProjectRole = pikkuSessionlessFunc({
  ...
  input: PartialUpdateProjectRoleInput,
  output: PartialUpdateProjectRoleOutput,
  errors: [BadRequestError, UnauthorizedError, ForbiddenError, NotFoundError],
  func: async ({ jira }, data) => {
    return jira.call("POST", "/rest/api/3/role/{id}", data) as any
  },
})
