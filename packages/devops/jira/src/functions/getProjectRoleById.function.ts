...
export const GetProjectRoleByIdInput = z.object({
...
export const GetProjectRoleByIdOutput = z.object({
...
export const getProjectRoleById = pikkuSessionlessFunc({
  ...
  input: GetProjectRoleByIdInput,
  output: GetProjectRoleByIdOutput,
  errors: [UnauthorizedError, ForbiddenError, NotFoundError],
  func: async ({ jira }, data) => {
    return jira.call("GET", "/rest/api/3/role/{id}", data) as any
  },
})
