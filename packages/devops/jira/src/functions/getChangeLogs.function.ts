...
export const GetChangeLogsInput = z.object({
...
export const GetChangeLogsOutput = z.object({
...
export const getChangeLogs = pikkuSessionlessFunc({
  ...
  func: async ({ jira }, data) => {
    return jira.call("GET", "/rest/api/3/issue/{issueIdOrKey}/changelog", data) as any
  },
})
