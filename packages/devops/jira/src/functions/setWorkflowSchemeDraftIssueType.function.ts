...
export const SetWorkflowSchemeDraftIssueTypeInput = z.object({
...
export const SetWorkflowSchemeDraftIssueTypeOutput = z.object({
...
export const setWorkflowSchemeDraftIssueType = pikkuSessionlessFunc({
  description: "Sets the workflow for an issue type in a workflow scheme's draft.\n\n**[Permissions](#permissions) required:** *Administer Jira* [global permission](https://confluence.atlassian.com/x/x4dKLg).",
  input: SetWorkflowSchemeDraftIssueTypeInput,
  output: SetWorkflowSchemeDraftIssueTypeOutput,
  errors: [BadRequestError, UnauthorizedError, ForbiddenError, NotFoundError],
  func: async ({ jira }, data) => {
    return jira.call("PUT", "/rest/api/3/workflowscheme/{id}/draft/issuetype/{issueType}", data) as any
  },
})
