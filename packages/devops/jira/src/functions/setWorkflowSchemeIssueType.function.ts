...
export const SetWorkflowSchemeIssueTypeInput = z.object({
...
export const SetWorkflowSchemeIssueTypeOutput = z.object({
...
export const setWorkflowSchemeIssueType = pikkuSessionlessFunc({
  ...
  input: SetWorkflowSchemeIssueTypeInput,
  output: SetWorkflowSchemeIssueTypeOutput,
  errors: [BadRequestError, UnauthorizedError, ForbiddenError, NotFoundError],
  func: async ({ jira }, data) => {
    return jira.call("PUT", "/rest/api/3/workflowscheme/{id}/issuetype/{issueType}", data) as any
  },
})
