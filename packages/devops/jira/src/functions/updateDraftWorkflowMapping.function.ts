...
export const UpdateDraftWorkflowMappingInput = z.object({
...
export const UpdateDraftWorkflowMappingOutput = z.object({
...
export const updateDraftWorkflowMapping = pikkuSessionlessFunc({
  ...
  input: UpdateDraftWorkflowMappingInput,
  output: UpdateDraftWorkflowMappingOutput,
  errors: [BadRequestError, UnauthorizedError, ForbiddenError, NotFoundError],
  func: async ({ jira }, data) => {
    return jira.call("PUT", "/rest/api/3/workflowscheme/{id}/draft/workflow", data) as any
  },
})
