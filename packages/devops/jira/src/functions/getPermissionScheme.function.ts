...
export const GetPermissionSchemeInput = z.object({
...
export const GetPermissionSchemeOutput = z.object({
...
export const getPermissionScheme = pikkuSessionlessFunc({
  description: "Returns a permission scheme.\n\n**[Permissions](#permissions) required:** Permission to access Jira.",
  input: GetPermissionSchemeInput,
  output: GetPermissionSchemeOutput,
  errors: [UnauthorizedError, NotFoundError],
  func: async ({ jira }, data) => {
    return jira.call("GET", "/rest/api/3/permissionscheme/{schemeId}", data) as any
  },
})
