...
export const AddCommentOutput = z.object({
  author: z.object({
...
export const addComment = pikkuSessionlessFunc({
  ...
  func: async ({ jira }, data) => {
    return jira.call("POST", "/rest/api/3/issue/{issueIdOrKey}/comment", data) as any
  },
})
