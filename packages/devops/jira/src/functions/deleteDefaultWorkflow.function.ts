...
export const DeleteDefaultWorkflowInput = z.object({
...
export const DeleteDefaultWorkflowOutput = z.object({
...
export const deleteDefaultWorkflow = pikkuSessionlessFunc({
  ...
  output: DeleteDefaultWorkflowOutput,
  errors: [BadRequestError, UnauthorizedError, ForbiddenError, NotFoundError],
  func: async ({ jira }, data) => {
    return jira.call("DELETE", "/rest/api/3/workflowscheme/{id}/default", data) as any
  },
})
