...
export const GetRemoteIssueLinkByIdInput = z.object({
  issueIdOrKey: z.string().describe("The ID or key of the issue."),
  linkId: z.string().describe("The ID of the remote issue link."),
})

export const GetRemoteIssueLinkByIdOutput = z.object({
...
export const getRemoteIssueLinkById = pikkuSessionlessFunc({
  ...
  input: GetRemoteIssueLinkByIdInput,
  output: GetRemoteIssueLinkByIdOutput,
  errors: [BadRequestError, UnauthorizedError, ForbiddenError, NotFoundError],
  func: async ({ jira }, data) => {
    return jira.call("GET", "/rest/api/3/issue/{issueIdOrKey}/remotelink/{linkId}", data) as any
  },
})
