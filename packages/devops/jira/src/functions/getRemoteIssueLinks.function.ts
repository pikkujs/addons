...
export const GetRemoteIssueLinksInput = z.object({
  issueIdOrKey: z.string().describe("The ID or key of the issue."),
  globalId: z.string().optional().describe("The global ID of the remote issue link."),
})

export const GetRemoteIssueLinksOutput = z.object({
  ...
  }).optional().describe("Details of the remote application the linked item is in."),
  globalId: z.string().optional().describe("The global ID of the link, such as the ID of the item on the remote system."),
  id: z.number().int().optional().describe("The ID of the link."),
  object: z.object({
    icon: z.object({
  ...
  }).optional().describe("Details of the item linked to."),
  relationship: z.string().optional().describe("Description of the relationship between the issue and the linked item."),
  self: z.string().url().optional().describe("The URL of the link."),
}).describe("Details of an issue remote link.")

export const getRemoteIssueLinks = pikkuSessionlessFunc({
  ...
  input: GetRemoteIssueLinksInput,
  output: GetRemoteIssueLinksOutput,
  errors: [BadRequestError, UnauthorizedError, ForbiddenError, NotFoundError],
  func: async ({ jira }, data) => {
    return jira.call("GET", "/rest/api/3/issue/{issueIdOrKey}/remotelink", data) as any
  },
})
