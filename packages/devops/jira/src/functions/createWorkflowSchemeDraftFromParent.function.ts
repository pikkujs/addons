...
export const CreateWorkflowSchemeDraftFromParentInput = z.object({
  id: z.number().int().describe("The ID of the active workflow scheme that the draft is created from."),
})

export const CreateWorkflowSchemeDraftFromParentOutput = z.object({
...
export const createWorkflowSchemeDraftFromParent = pikkuSessionlessFunc({
  ...
  input: CreateWorkflowSchemeDraftFromParentInput,
  output: CreateWorkflowSchemeDraftFromParentOutput,
  errors: [BadRequestError, UnauthorizedError, ForbiddenError],
  func: async ({ jira }, data) => {
    return jira.call("POST", "/rest/api/3/workflowscheme/{id}/createdraft", data) as any
  },
})
