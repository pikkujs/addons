...
export const DeleteDraftDefaultWorkflowInput = z.object({
  id: z.number().int().describe("The ID of the workflow scheme that the draft belongs to."),
})

export const DeleteDraftDefaultWorkflowOutput = z.object({
...
export const deleteDraftDefaultWorkflow = pikkuSessionlessFunc({
  ...
  input: DeleteDraftDefaultWorkflowInput,
  output: DeleteDraftDefaultWorkflowOutput,
  errors: [UnauthorizedError, ForbiddenError, NotFoundError],
  func: async ({ jira }, data) => {
    return jira.call("DELETE", "/rest/api/3/workflowscheme/{id}/draft/default", data) as any
  },
})
