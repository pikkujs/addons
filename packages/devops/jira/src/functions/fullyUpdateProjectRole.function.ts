...
export const FullyUpdateProjectRoleInput = z.object({
...
export const FullyUpdateProjectRoleOutput = z.object({
...
export const fullyUpdateProjectRole = pikkuSessionlessFunc({
  ...
  input: FullyUpdateProjectRoleInput,
  output: FullyUpdateProjectRoleOutput,
  errors: [BadRequestError, UnauthorizedError, ForbiddenError, NotFoundError],
  func: async ({ jira }, data) => {
    return jira.call("PUT", "/rest/api/3/role/{id}", data) as any
  },
})
