...
export const GetWorkflowSchemeProjectAssociationsOutput = z.object({
  values: z.array(z.object({
    projectIds: z.array(z.string()).describe("The list of projects that use the workflow scheme."),
    workflowScheme: z.object({
    ...
    }).describe("The workflow scheme."),
  })).describe("A list of workflow schemes together with projects they are associated with."),
}).describe("A container for a list of workflow schemes together with the projects they are associated with.")

export const getWorkflowSchemeProjectAssociations = pikkuSessionlessFunc({
  ...
  input: GetWorkflowSchemeProjectAssociationsInput,
  output: GetWorkflowSchemeProjectAssociationsOutput,
  errors: [BadRequestError, UnauthorizedError, ForbiddenError],
  func: async ({ jira }, data) => {
    return jira.call("GET", "/rest/api/3/workflowscheme/project", data) as any
  },
})
