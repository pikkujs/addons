...
export const CreateOrUpdateRemoteIssueLinkInput = z.object({
...
export const CreateOrUpdateRemoteIssueLinkOutput = z.object({
  id: z.number().int().optional().describe("The ID of the remote issue link, such as the ID of the item on the remote system."),
  self: z.string().optional().describe("The URL of the remote issue link."),
}).describe("Details of the identifiers for a created or updated remote issue link.")

export const createOrUpdateRemoteIssueLink = pikkuSessionlessFunc({
  ...
  input: CreateOrUpdateRemoteIssueLinkInput,
  output: CreateOrUpdateRemoteIssueLinkOutput,
  errors: [BadRequestError, UnauthorizedError, ForbiddenError, NotFoundError],
  func: async ({ jira }, data) => {
    return jira.call("POST", "/rest/api/3/issue/{issueIdOrKey}/remotelink", data) as any
  },
})
