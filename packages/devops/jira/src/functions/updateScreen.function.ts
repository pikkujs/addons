...
export const UpdateScreenInput = z.object({
  ...
  name: z.string().optional().describe("The name of the screen. The name must be unique. The maximum length is 255 characters."),
})

export const UpdateScreenOutput = z.object({
...
export const updateScreen = pikkuSessionlessFunc({
  ...
  output: UpdateScreenOutput,
  errors: [BadRequestError, UnauthorizedError, ForbiddenError, NotFoundError],
  func: async ({ jira }, data) => {
    return jira.call("PUT", "/rest/api/3/screens/{screenId}", data) as any
  },
})
