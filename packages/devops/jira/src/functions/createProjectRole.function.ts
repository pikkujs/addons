...
export const CreateProjectRoleInput = z.object({
...
export const CreateProjectRoleOutput = z.object({
...
export const createProjectRole = pikkuSessionlessFunc({
  ...
  output: CreateProjectRoleOutput,
  errors: [BadRequestError, UnauthorizedError, ForbiddenError, ConflictError],
  func: async ({ jira }, data) => {
    return jira.call("POST", "/rest/api/3/role", data) as any
  },
})
