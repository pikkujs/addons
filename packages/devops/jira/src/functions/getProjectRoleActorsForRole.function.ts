...
export const GetProjectRoleActorsForRoleInput = z.object({
...
export const GetProjectRoleActorsForRoleOutput = z.object({
...
export const getProjectRoleActorsForRole = pikkuSessionlessFunc({
  description: "Returns the [default actors](#api-rest-api-3-resolution-get) for the project role.\n\n**[Permissions](#permissions) required:** *Administer Jira* [global permission](https://confluence.atlassian.com/x/x4dKLg).",
  input: GetProjectRoleActorsForRoleInput,
  output: GetProjectRoleActorsForRoleOutput,
  errors: [BadRequestError, UnauthorizedError, ForbiddenError, NotFoundError],
  func: async ({ jira }, data) => {
    return jira.call("GET", "/rest/api/3/role/{id}/actors", data) as any
  },
})
