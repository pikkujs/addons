...
export const CreateUiModificationInput = z.object({
...
export const CreateUiModificationOutput = z.object({
  id: z.string().describe("The ID of the UI modification."),
  self: z.string().describe("The URL of the UI modification."),
}).describe("Identifiers for a UI modification.")

export const createUiModification = pikkuSessionlessFunc({
  ...
  input: CreateUiModificationInput,
  output: CreateUiModificationOutput,
  errors: [BadRequestError, UnauthorizedError, ForbiddenError, NotFoundError],
  func: async ({ jira }, data) => {
    return jira.call("POST", "/rest/api/3/uiModifications", data) as any
  },
})
