...
export const DeleteWorkflowSchemeDraftIssueTypeInput = z.object({
...
export const DeleteWorkflowSchemeDraftIssueTypeOutput = z.object({
...
export const deleteWorkflowSchemeDraftIssueType = pikkuSessionlessFunc({
  description: "Deletes the issue type-workflow mapping for an issue type in a workflow scheme's draft.\n\n**[Permissions](#permissions) required:** *Administer Jira* [global permission](https://confluence.atlassian.com/x/x4dKLg).",
  input: DeleteWorkflowSchemeDraftIssueTypeInput,
  output: DeleteWorkflowSchemeDraftIssueTypeOutput,
  errors: [UnauthorizedError, ForbiddenError, NotFoundError],
  func: async ({ jira }, data) => {
    return jira.call("DELETE", "/rest/api/3/workflowscheme/{id}/draft/issuetype/{issueType}", data) as any
  },
})
