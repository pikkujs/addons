...
export const UpdateWorkflowTransitionPropertyInput = z.object({
...
export const UpdateWorkflowTransitionPropertyOutput = z.object({
...
export const updateWorkflowTransitionProperty = pikkuSessionlessFunc({
  ...
  input: UpdateWorkflowTransitionPropertyInput,
  output: UpdateWorkflowTransitionPropertyOutput,
  errors: [BadRequestError, UnauthorizedError, ForbiddenError, NotFoundError],
  func: async ({ jira }, data) => {
    return jira.call("PUT", "/rest/api/3/workflow/transitions/{transitionId}/properties", data) as any
  },
})
