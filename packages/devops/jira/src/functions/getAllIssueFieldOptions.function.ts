...
export const GetAllIssueFieldOptionsInput = z.object({
...
export const GetAllIssueFieldOptionsOutput = z.object({
...
export const getAllIssueFieldOptions = pikkuSessionlessFunc({
  ...
  input: GetAllIssueFieldOptionsInput,
  output: GetAllIssueFieldOptionsOutput,
  errors: [BadRequestError, ForbiddenError],
  func: async ({ jira }, data) => {
    return jira.call("GET", "/rest/api/3/field/{fieldKey}/option", data) as any
  },
})
