...
export const UpdateNotificationSchemeInput = z.object({
  ...
  name: z.string().max(255).optional().describe("The name of the notification scheme. Must be unique."),
})

export const UpdateNotificationSchemeOutput = z.unknown()

export const updateNotificationScheme = pikkuSessionlessFunc({
  description: "Updates a notification scheme.\n\n**[Permissions](#permissions) required:** *Administer Jira* [global permission](https://confluence.atlassian.com/x/x4dKLg).",
  input: UpdateNotificationSchemeInput,
  output: UpdateNotificationSchemeOutput,
  errors: [BadRequestError, UnauthorizedError, ForbiddenError, NotFoundError],
  func: async ({ jira }, data) => {
    return jira.call("PUT", "/rest/api/3/notificationscheme/{id}", data) as any
  },
})
