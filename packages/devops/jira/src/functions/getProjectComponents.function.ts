...
export const GetProjectComponentsInput = z.object({
  projectIdOrKey: z.string().describe("The project ID or project key (case sensitive)."),
})

export const GetProjectComponentsOutput = z.array(z.object({
  assignee: z.object({
...
export const getProjectComponents = pikkuSessionlessFunc({
  ...
  output: GetProjectComponentsOutput,
  errors: [UnauthorizedError, NotFoundError],
  func: async ({ jira }, data) => {
    return jira.call("GET", "/rest/api/3/project/{projectIdOrKey}/components", data) as any
  },
})
