...
export const UpdateDefaultWorkflowInput = z.object({
...
export const UpdateDefaultWorkflowOutput = z.object({
...
export const updateDefaultWorkflow = pikkuSessionlessFunc({
  ...
  output: UpdateDefaultWorkflowOutput,
  errors: [BadRequestError, UnauthorizedError, ForbiddenError, NotFoundError],
  func: async ({ jira }, data) => {
    return jira.call("PUT", "/rest/api/3/workflowscheme/{id}/default", data) as any
  },
})
