...
export const GetAlternativeIssueTypesInput = z.object({
  id: z.string().describe("The ID of the issue type."),
})

export const GetAlternativeIssueTypesOutput = z.array(z.object({
...
export const getAlternativeIssueTypes = pikkuSessionlessFunc({
  ...
  input: GetAlternativeIssueTypesInput,
  output: GetAlternativeIssueTypesOutput,
  errors: [UnauthorizedError, NotFoundError],
  func: async ({ jira }, data) => {
    return jira.call("GET", "/rest/api/3/issuetype/{id}/alternatives", data) as any
  },
})
