...
export const GetIssueFieldOptionInput = z.object({
...
export const GetIssueFieldOptionOutput = z.object({
  config: z.object({
...
export const getIssueFieldOption = pikkuSessionlessFunc({
  ...
  input: GetIssueFieldOptionInput,
  output: GetIssueFieldOptionOutput,
  errors: [BadRequestError, ForbiddenError, NotFoundError],
  func: async ({ jira }, data) => {
    return jira.call("GET", "/rest/api/3/field/{fieldKey}/option/{optionId}", data) as any
  },
})
