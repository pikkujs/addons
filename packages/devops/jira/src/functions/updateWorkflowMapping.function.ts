...
export const UpdateWorkflowMappingInput = z.object({
...
export const UpdateWorkflowMappingOutput = z.object({
...
export const updateWorkflowMapping = pikkuSessionlessFunc({
  ...
  input: UpdateWorkflowMappingInput,
  output: UpdateWorkflowMappingOutput,
  errors: [BadRequestError, UnauthorizedError, ForbiddenError, NotFoundError],
  func: async ({ jira }, data) => {
    return jira.call("PUT", "/rest/api/3/workflowscheme/{id}/workflow", data) as any
  },
})
