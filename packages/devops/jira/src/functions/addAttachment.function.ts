...
export const AddAttachmentOutput = z.array(z.object({
  author: z.object({
  ...
  }).optional().describe("Details of the user who added the attachment."),
  content: z.string().optional().describe("The content of the attachment."),
  created: z.string().datetime().optional().describe("The datetime the attachment was created."),
  filename: z.string().optional().describe("The file name of the attachment."),
  id: z.string().optional().describe("The ID of the attachment."),
  mimeType: z.string().optional().describe("The MIME type of the attachment."),
  self: z.string().optional().describe("The URL of the attachment details response."),
...
export const addAttachment = pikkuSessionlessFunc({
  ...
  func: async ({ jira }, data) => {
    return jira.call("POST", "/rest/api/3/issue/{issueIdOrKey}/attachments", data) as any
  },
})
