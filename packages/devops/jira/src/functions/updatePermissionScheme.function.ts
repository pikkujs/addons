...
export const UpdatePermissionSchemeInput = z.object({
...
export const UpdatePermissionSchemeOutput = z.object({
  description: z.string().optional().describe("A description for the permission scheme."),
...
export const updatePermissionScheme = pikkuSessionlessFunc({
  ...
  output: UpdatePermissionSchemeOutput,
  errors: [UnauthorizedError, ForbiddenError, NotFoundError],
  func: async ({ jira }, data) => {
    return jira.call("PUT", "/rest/api/3/permissionscheme/{schemeId}", data) as any
  },
})
