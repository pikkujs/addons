...
export const GetWorklogPropertyKeysInput = z.object({
  issueIdOrKey: z.string().describe("The ID or key of the issue."),
  worklogId: z.string().describe("The ID of the worklog."),
})

export const GetWorklogPropertyKeysOutput = z.object({
...
export const getWorklogPropertyKeys = pikkuSessionlessFunc({
  ...
  input: GetWorklogPropertyKeysInput,
  output: GetWorklogPropertyKeysOutput,
  errors: [BadRequestError, UnauthorizedError, NotFoundError],
  func: async ({ jira }, data) => {
    return jira.call("GET", "/rest/api/3/issue/{issueIdOrKey}/worklog/{worklogId}/properties", data) as any
  },
})
