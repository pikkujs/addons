...
export const UpdateDraftDefaultWorkflowInput = z.object({
...
export const UpdateDraftDefaultWorkflowOutput = z.object({
...
export const updateDraftDefaultWorkflow = pikkuSessionlessFunc({
  description: "Sets the default workflow for a workflow scheme's draft.\n\n**[Permissions](#permissions) required:** *Administer Jira* [global permission](https://confluence.atlassian.com/x/x4dKLg).",
  input: UpdateDraftDefaultWorkflowInput,
  output: UpdateDraftDefaultWorkflowOutput,
  errors: [BadRequestError, UnauthorizedError, ForbiddenError, NotFoundError],
  func: async ({ jira }, data) => {
    return jira.call("PUT", "/rest/api/3/workflowscheme/{id}/draft/default", data) as any
  },
})
