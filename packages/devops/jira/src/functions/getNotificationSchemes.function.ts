...
export const GetNotificationSchemesInput = z.object({
  ...
  id: z.array(z.string()).optional().describe("The list of notification schemes IDs to be filtered by"),
  projectId: z.array(z.string()).optional().describe("The list of projects IDs to be filtered by"),
  onlyDefault: z.boolean().optional().default(false).describe("When set to true, returns only the default notification scheme. If you provide project IDs not associated with the default, returns an empty page. The default value is false."),
...
export const GetNotificationSchemesOutput = z.object({
      ...
      notifications: z.array(z.object({
        ...
        field: z.object({
          ...
          scope: z.object({
            project: z.object({
              avatarUrls: z.object({
                "16x16": z.any().optional().describe("The URL of the item's 16x16 pixel avatar."),
                "24x24": z.any().optional().describe("The URL of the item's 24x24 pixel avatar."),
                "32x32": z.any().optional().describe("The URL of the item's 32x32 pixel avatar."),
                "48x48": z.any().optional().describe("The URL of the item's 48x48 pixel avatar."),
              ...
              projectCategory: z.object({
                description: z.any().optional().describe("The name of the project category."),
                id: z.any().optional().describe("The ID of the project category."),
                name: z.any().optional().describe("The description of the project category."),
                self: z.any().optional().describe("The URL of the project category."),
        ...
        projectRole: z.object({
          actors: z.array(z.object({
            actorGroup: z.object({
              displayName: z.any().optional().describe("The display name of the group."),
              groupId: z.any().optional().describe("The ID of the group."),
              name: z.any().optional().describe("The name of the group. As a group's name can change, use of `groupId` is recommended to identify the group."),
            }).optional(),
            actorUser: z.object({
              accountId: z.any().optional().describe("The account ID of the user, which uniquely identifies the user across all Atlassian products. For example, *5b10ac8d82e05b22cc7d4ef5*. Returns *unknown* if the record is deleted and corrupted, for example, as the result of a server import."),
            }).optional(),
...
export const getNotificationSchemes = pikkuSessionlessFunc({
  ...
  input: GetNotificationSchemesInput,
  output: GetNotificationSchemesOutput,
  errors: [BadRequestError, UnauthorizedError],
  func: async ({ jira }, data) => {
    return jira.call("GET", "/rest/api/3/notificationscheme", data) as any
  },
})
