...
export const GetAllUsersInput = z.object({
...
export const GetAllUsersOutput = z.array(z.object({
...
export const getAllUsers = pikkuSessionlessFunc({
  ...
  func: async ({ jira }, data) => {
    return jira.call("GET", "/rest/api/3/users/search", data) as any
  },
})
