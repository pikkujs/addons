...
export const GetWorkflowSchemeDraftInput = z.object({
  id: z.number().int().describe("The ID of the active workflow scheme that the draft was created from."),
})

export const GetWorkflowSchemeDraftOutput = z.object({
...
export const getWorkflowSchemeDraft = pikkuSessionlessFunc({
  ...
  input: GetWorkflowSchemeDraftInput,
  output: GetWorkflowSchemeDraftOutput,
  errors: [UnauthorizedError, ForbiddenError, NotFoundError],
  func: async ({ jira }, data) => {
    return jira.call("GET", "/rest/api/3/workflowscheme/{id}/draft", data) as any
  },
})
