...
export const UpdateIssueTypeScreenSchemeInput = z.object({
  ...
  name: z.string().optional().describe("The name of the issue type screen scheme. The name must be unique. The maximum length is 255 characters."),
})

export const UpdateIssueTypeScreenSchemeOutput = z.unknown()

export const updateIssueTypeScreenScheme = pikkuSessionlessFunc({
  description: "Updates an issue type screen scheme.\n\n**[Permissions](#permissions) required:** *Administer Jira* [global permission](https://confluence.atlassian.com/x/x4dKLg).",
  input: UpdateIssueTypeScreenSchemeInput,
  output: UpdateIssueTypeScreenSchemeOutput,
  errors: [BadRequestError, UnauthorizedError, ForbiddenError, NotFoundError],
  func: async ({ jira }, data) => {
    return jira.call("PUT", "/rest/api/3/issuetypescreenscheme/{issueTypeScreenSchemeId}", data) as any
  },
})
