...
export const DeleteProjectRoleActorsFromRoleInput = z.object({
  ...
  user: z.string().optional().describe("The user account ID of the user to remove as a default actor."),
  groupId: z.string().optional().describe("The group ID of the group to be removed as a default actor. This parameter cannot be used with the `group` parameter."),
  group: z.string().optional().describe("The group name of the group to be removed as a default actor.This parameter cannot be used with the `groupId` parameter. As a group's name can change, use of `groupId` is recommended."),
})

export const DeleteProjectRoleActorsFromRoleOutput = z.object({
...
export const deleteProjectRoleActorsFromRole = pikkuSessionlessFunc({
  ...
  input: DeleteProjectRoleActorsFromRoleInput,
  output: DeleteProjectRoleActorsFromRoleOutput,
  errors: [BadRequestError, UnauthorizedError, ForbiddenError, NotFoundError],
  func: async ({ jira }, data) => {
    return jira.call("DELETE", "/rest/api/3/role/{id}/actors", data) as any
  },
})
