...
export const UpdateIssueTypeInput = z.object({
  ...
  avatarId: z.number().int().optional().describe("The ID of an issue type avatar."),
  description: z.string().optional().describe("The description of the issue type."),
  name: z.string().optional().describe("The unique name for the issue type. The maximum length is 60 characters."),
})

export const UpdateIssueTypeOutput = z.object({
