...
export const DeleteTemplatesRevisionInput = z.object({
...
export const DeleteTemplatesRevisionOutput = z.object({
...
export const deleteTemplatesRevision = pikkuSessionlessFunc({
  input: DeleteTemplatesRevisionInput,
  output: DeleteTemplatesRevisionOutput,
  func: async ({ wordpress }, data) => {
    return wordpress.call("DELETE", "/templates/{parent}/revisions/{id}", data) as any
  },
})
