...
export const CreateWpPatternCategory2Input = z.object({
...
export const CreateWpPatternCategory2Output = z.object({
...
export const createWpPatternCategory2 = pikkuSessionlessFunc({
  input: CreateWpPatternCategory2Input,
  output: CreateWpPatternCategory2Output,
  func: async ({ wordpress }, data) => {
    return wordpress.call("POST", "/wp_pattern_category/{id}", data) as any
  },
})
