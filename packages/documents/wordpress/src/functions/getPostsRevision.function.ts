...
export const GetPostsRevisionInput = z.object({
...
export const GetPostsRevisionOutput = z.object({
...
export const getPostsRevision = pikkuSessionlessFunc({
  input: GetPostsRevisionInput,
  output: GetPostsRevisionOutput,
  func: async ({ wordpress }, data) => {
    return wordpress.call("GET", "/posts/{parent}/revisions/{id}", data) as any
  },
})
