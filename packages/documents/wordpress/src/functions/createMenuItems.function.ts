...
export const CreateMenuItemsOutput = z.object({
  title: z.union([z.string(), z.record(z.string(), z.unknown())]).optional().describe("The title for the object."),
...
export const createMenuItems = pikkuSessionlessFunc({
  input: CreateMenuItemsInput,
  output: CreateMenuItemsOutput,
  func: async ({ wordpress }, data) => {
    return wordpress.call("POST", "/menu-items", data) as any
  },
})
