...
export const GetBlockTypeInput = z.object({
...
export const GetBlockTypeOutput = z.object({
...
export const getBlockType = pikkuSessionlessFunc({
  input: GetBlockTypeInput,
  output: GetBlockTypeOutput,
  func: async ({ wordpress }, data) => {
    return wordpress.call("GET", "/block-types/{namespace}", data) as any
  },
})
