...
export const UpdateMenuItem2Input = z.object({
...
export const UpdateMenuItem2Output = z.object({
  title: z.union([z.string(), z.record(z.string(), z.unknown())]).optional().describe("The title for the object."),
...
export const updateMenuItem2 = pikkuSessionlessFunc({
  input: UpdateMenuItem2Input,
  output: UpdateMenuItem2Output,
  func: async ({ wordpress }, data) => {
    return wordpress.call("PATCH", "/menu-items/{id}", data) as any
  },
})
