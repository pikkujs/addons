...
export const DeleteMenuItemOutput = z.object({
...
export const deleteMenuItem = pikkuSessionlessFunc({
  input: DeleteMenuItemInput,
  output: DeleteMenuItemOutput,
  func: async ({ wordpress }, data) => {
    return wordpress.call("DELETE", "/menu-items/{id}", data) as any
  },
})
