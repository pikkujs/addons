...
export const UpdateUsersMeInput = z.object({
...
export const UpdateUsersMeOutput = z.object({
...
export const updateUsersMe = pikkuSessionlessFunc({
  input: UpdateUsersMeInput,
  output: UpdateUsersMeOutput,
  func: async ({ wordpress }, data) => {
    return wordpress.call("PUT", "/users/me", data) as any
  },
})
