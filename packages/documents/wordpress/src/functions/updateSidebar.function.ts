...
export const updateSidebar = pikkuSessionlessFunc({
  input: UpdateSidebarInput,
  output: UpdateSidebarOutput,
  func: async ({ wordpress }, data) => {
    return wordpress.call("PUT", "/sidebars/{id}", data) as any
  },
})
