...
export const ListTemplatesRevisionsInput = z.object({
...
export const ListTemplatesRevisionsOutput = z.array(z.object({
...
export const listTemplatesRevisions = pikkuSessionlessFunc({
  input: ListTemplatesRevisionsInput,
  output: ListTemplatesRevisionsOutput,
  func: async ({ wordpress }, data) => {
    return wordpress.call("GET", "/templates/{parent}/revisions", data) as any
  },
})
