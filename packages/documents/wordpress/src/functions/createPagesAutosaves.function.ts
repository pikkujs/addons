...
export const CreatePagesAutosavesInput = z.object({
  id: z.string(),
...
export const CreatePagesAutosavesOutput = z.object({
...
export const createPagesAutosaves = pikkuSessionlessFunc({
  input: CreatePagesAutosavesInput,
  output: CreatePagesAutosavesOutput,
  func: async ({ wordpress }, data) => {
    return wordpress.call("POST", "/pages/{id}/autosaves", data) as any
  },
})
