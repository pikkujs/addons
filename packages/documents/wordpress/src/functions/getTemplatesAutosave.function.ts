...
export const GetTemplatesAutosaveInput = z.object({
...
export const GetTemplatesAutosaveOutput = z.object({
...
export const getTemplatesAutosave = pikkuSessionlessFunc({
  input: GetTemplatesAutosaveInput,
  output: GetTemplatesAutosaveOutput,
  func: async ({ wordpress }, data) => {
    return wordpress.call("GET", "/templates/{parent}/autosaves/{id}", data) as any
  },
})
