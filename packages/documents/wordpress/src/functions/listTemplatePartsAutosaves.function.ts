...
export const ListTemplatePartsAutosavesInput = z.object({
...
export const ListTemplatePartsAutosavesOutput = z.array(z.object({
...
export const listTemplatePartsAutosaves = pikkuSessionlessFunc({
  input: ListTemplatePartsAutosavesInput,
  output: ListTemplatePartsAutosavesOutput,
  func: async ({ wordpress }, data) => {
    return wordpress.call("GET", "/template-parts/{id}/autosaves", data) as any
  },
})
