...
export const ListNavigationRevisionsInput = z.object({
...
export const ListNavigationRevisionsOutput = z.array(z.object({
...
export const listNavigationRevisions = pikkuSessionlessFunc({
  input: ListNavigationRevisionsInput,
  output: ListNavigationRevisionsOutput,
  func: async ({ wordpress }, data) => {
    return wordpress.call("GET", "/navigation/{parent}/revisions", data) as any
  },
})
