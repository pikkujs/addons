...
export const CreateTemplatePartsAutosavesInput = z.object({
...
export const CreateTemplatePartsAutosavesOutput = z.object({
...
export const createTemplatePartsAutosaves = pikkuSessionlessFunc({
  input: CreateTemplatePartsAutosavesInput,
  output: CreateTemplatePartsAutosavesOutput,
  func: async ({ wordpress }, data) => {
    return wordpress.call("POST", "/template-parts/{id}/autosaves", data) as any
  },
})
