...
export const UpdateBlock2Input = z.object({
...
export const UpdateBlock2Output = z.object({
  date: z.string().datetime().nullable().optional().describe("The date the post was published, in the site's timezone."),
  date_gmt: z.string().datetime().nullable().optional().describe("The date the post was published, as GMT."),
  guid: z.object({
...
export const updateBlock2 = pikkuSessionlessFunc({
  input: UpdateBlock2Input,
  output: UpdateBlock2Output,
  func: async ({ wordpress }, data) => {
    return wordpress.call("PATCH", "/blocks/{id}", data) as any
  },
})
