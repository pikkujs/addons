...
export const GetBlocksRevisionInput = z.object({
...
export const GetBlocksRevisionOutput = z.object({
...
export const getBlocksRevision = pikkuSessionlessFunc({
  input: GetBlocksRevisionInput,
  output: GetBlocksRevisionOutput,
  func: async ({ wordpress }, data) => {
    return wordpress.call("GET", "/blocks/{parent}/revisions/{id}", data) as any
  },
})
