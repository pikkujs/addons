...
export const DeleteCommentInput = z.object({
  ...
  password: z.string().optional().describe("The password for the parent post of the comment (if the post is password protected)."),
})
...
export const deleteComment = pikkuSessionlessFunc({
  ...
  func: async ({ wordpress }, data) => {
    return wordpress.call("DELETE", "/comments/{id}", data) as any
  },
})
