...
export const CreateNavigationInput = z.object({
...
export const CreateNavigationOutput = z.object({
  date: z.string().datetime().nullable().optional().describe("The date the post was published, in the site's timezone."),
  date_gmt: z.string().datetime().nullable().optional().describe("The date the post was published, as GMT."),
  guid: z.object({
...
export const createNavigation = pikkuSessionlessFunc({
  input: CreateNavigationInput,
  output: CreateNavigationOutput,
  func: async ({ wordpress }, data) => {
    return wordpress.call("POST", "/navigation", data) as any
  },
})
