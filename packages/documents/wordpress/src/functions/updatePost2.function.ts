...
export const UpdatePost2Input = z.object({
...
export const UpdatePost2Output = z.object({
  date: z.string().datetime().nullable().optional().describe("The date the post was published, in the site's timezone."),
  date_gmt: z.string().datetime().nullable().optional().describe("The date the post was published, as GMT."),
  guid: z.object({
...
export const updatePost2 = pikkuSessionlessFunc({
  input: UpdatePost2Input,
  output: UpdatePost2Output,
  func: async ({ wordpress }, data) => {
    return wordpress.call("PATCH", "/posts/{id}", data) as any
  },
})
