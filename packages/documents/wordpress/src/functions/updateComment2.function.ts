...
export const UpdateComment2Input = z.object({
  ...
  parent: z.number().int().optional().describe("The ID for the parent of the comment."),
  post: z.number().int().optional().describe("The ID of the associated post object."),
...
export const UpdateComment2Output = z.object({
...
export const updateComment2 = pikkuSessionlessFunc({
  input: UpdateComment2Input,
  output: UpdateComment2Output,
  func: async ({ wordpress }, data) => {
    return wordpress.call("PATCH", "/comments/{id}", data) as any
  },
})
