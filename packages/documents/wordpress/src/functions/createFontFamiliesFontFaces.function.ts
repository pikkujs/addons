...
export const CreateFontFamiliesFontFacesInput = z.object({
  ...
  font_face_settings: z.string().describe("font-face declaration in theme.json format, encoded as a string."),
})

export const CreateFontFamiliesFontFacesOutput = z.object({
...
export const createFontFamiliesFontFaces = pikkuSessionlessFunc({
  input: CreateFontFamiliesFontFacesInput,
  output: CreateFontFamiliesFontFacesOutput,
  func: async ({ wordpress }, data) => {
    return wordpress.call("POST", "/font-families/{font_family_id}/font-faces", data) as any
  },
})
