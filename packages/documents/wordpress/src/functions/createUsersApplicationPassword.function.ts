...
export const CreateUsersApplicationPasswordInput = z.object({
  user_id: z.string(),
  uuid: z.string(),
...
export const CreateUsersApplicationPasswordOutput = z.object({
...
export const createUsersApplicationPassword = pikkuSessionlessFunc({
  input: CreateUsersApplicationPasswordInput,
  output: CreateUsersApplicationPasswordOutput,
  func: async ({ wordpress }, data) => {
    return wordpress.call("POST", "/users/{user_id}/application-passwords/{uuid}", data) as any
  },
})
