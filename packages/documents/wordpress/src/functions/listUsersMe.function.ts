...
export const ListUsersMeInput = z.object({
...
export const ListUsersMeOutput = z.object({
...
export const listUsersMe = pikkuSessionlessFunc({
  input: ListUsersMeInput,
  output: ListUsersMeOutput,
  func: async ({ wordpress }, data) => {
    return wordpress.call("GET", "/users/me", data) as any
  },
})
