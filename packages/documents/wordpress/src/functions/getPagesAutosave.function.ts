...
export const GetPagesAutosaveInput = z.object({
...
export const GetPagesAutosaveOutput = z.object({
...
export const getPagesAutosave = pikkuSessionlessFunc({
  input: GetPagesAutosaveInput,
  output: GetPagesAutosaveOutput,
  func: async ({ wordpress }, data) => {
    return wordpress.call("GET", "/pages/{parent}/autosaves/{id}", data) as any
  },
})
