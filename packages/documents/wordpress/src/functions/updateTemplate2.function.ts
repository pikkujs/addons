...
export const UpdateTemplate2Input = z.object({
...
export const UpdateTemplate2Output = z.object({
...
export const updateTemplate2 = pikkuSessionlessFunc({
  input: UpdateTemplate2Input,
  output: UpdateTemplate2Output,
  func: async ({ wordpress }, data) => {
    return wordpress.call("PATCH", "/templates/{id}", data) as any
  },
})
