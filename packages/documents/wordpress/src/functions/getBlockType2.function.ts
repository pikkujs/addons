...
export const GetBlockType2Input = z.object({
  name: z.string().describe("Block name."),
  namespace: z.string().describe("Block namespace."),
...
export const GetBlockType2Output = z.object({
...
export const getBlockType2 = pikkuSessionlessFunc({
  input: GetBlockType2Input,
  output: GetBlockType2Output,
  func: async ({ wordpress }, data) => {
    return wordpress.call("GET", "/block-types/{namespace}/{name}", data) as any
  },
})
