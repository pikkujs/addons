...
export const GetSidebarInput = z.object({
  id: z.string().describe("The id of a registered sidebar"),
...
export const GetSidebarOutput = z.object({
...
export const getSidebar = pikkuSessionlessFunc({
  input: GetSidebarInput,
  output: GetSidebarOutput,
  func: async ({ wordpress }, data) => {
    return wordpress.call("GET", "/sidebars/{id}", data) as any
  },
})
