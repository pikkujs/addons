...
export const UpdateMedia2Input = z.object({
...
export const UpdateMedia2Output = z.object({
  date: z.string().datetime().nullable().optional().describe("The date the post was published, in the site's timezone."),
  date_gmt: z.string().datetime().nullable().optional().describe("The date the post was published, as GMT."),
  guid: z.object({
...
export const updateMedia2 = pikkuSessionlessFunc({
  input: UpdateMedia2Input,
  output: UpdateMedia2Output,
  func: async ({ wordpress }, data) => {
    return wordpress.call("PATCH", "/media/{id}", data) as any
  },
})
