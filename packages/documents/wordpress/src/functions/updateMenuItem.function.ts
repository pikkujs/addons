...
export const UpdateMenuItemOutput = z.object({
  title: z.union([z.string(), z.record(z.string(), z.unknown())]).optional().describe("The title for the object."),
...
export const updateMenuItem = pikkuSessionlessFunc({
  input: UpdateMenuItemInput,
  output: UpdateMenuItemOutput,
  func: async ({ wordpress }, data) => {
    return wordpress.call("PUT", "/menu-items/{id}", data) as any
  },
})
