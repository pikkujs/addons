...
export const CreateTemplatesInput = z.object({
...
export const CreateTemplatesOutput = z.object({
...
export const createTemplates = pikkuSessionlessFunc({
  input: CreateTemplatesInput,
  output: CreateTemplatesOutput,
  func: async ({ wordpress }, data) => {
    return wordpress.call("POST", "/templates", data) as any
  },
})
