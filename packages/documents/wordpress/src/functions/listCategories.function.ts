...
export const ListCategoriesInput = z.object({
  ...
  parent: z.string().optional().describe("Limit result set to terms assigned to a specific parent."),
...
export const ListCategoriesOutput = z.array(z.object({
...
export const listCategories = pikkuSessionlessFunc({
  ...
  func: async ({ wordpress }, data) => {
    return wordpress.call("GET", "/categories", data) as any
  },
})
