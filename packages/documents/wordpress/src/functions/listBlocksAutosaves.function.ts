...
export const ListBlocksAutosavesInput = z.object({
  id: z.string(),
...
export const ListBlocksAutosavesOutput = z.array(z.object({
...
export const listBlocksAutosaves = pikkuSessionlessFunc({
  input: ListBlocksAutosavesInput,
  output: ListBlocksAutosavesOutput,
  func: async ({ wordpress }, data) => {
    return wordpress.call("GET", "/blocks/{id}/autosaves", data) as any
  },
})
