...
export const ListFontFamiliesFontFacesInput = z.object({
...
export const ListFontFamiliesFontFacesOutput = z.array(z.object({
...
export const listFontFamiliesFontFaces = pikkuSessionlessFunc({
  input: ListFontFamiliesFontFacesInput,
  output: ListFontFamiliesFontFacesOutput,
  func: async ({ wordpress }, data) => {
    return wordpress.call("GET", "/font-families/{font_family_id}/font-faces", data) as any
  },
})
