...
export const CreateTemplatesAutosavesInput = z.object({
...
export const CreateTemplatesAutosavesOutput = z.object({
...
export const createTemplatesAutosaves = pikkuSessionlessFunc({
  input: CreateTemplatesAutosavesInput,
  output: CreateTemplatesAutosavesOutput,
  func: async ({ wordpress }, data) => {
    return wordpress.call("POST", "/templates/{id}/autosaves", data) as any
  },
})
