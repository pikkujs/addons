...
export const ListUsersApplicationPasswordsIntrospectInput = z.object({
  user_id: z.string(),
...
export const ListUsersApplicationPasswordsIntrospectOutput = z.object({
...
export const listUsersApplicationPasswordsIntrospect = pikkuSessionlessFunc({
  input: ListUsersApplicationPasswordsIntrospectInput,
  output: ListUsersApplicationPasswordsIntrospectOutput,
  func: async ({ wordpress }, data) => {
    return wordpress.call("GET", "/users/{user_id}/application-passwords/introspect", data) as any
  },
})
