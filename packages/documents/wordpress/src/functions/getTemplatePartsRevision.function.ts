...
export const GetTemplatePartsRevisionInput = z.object({
...
export const GetTemplatePartsRevisionOutput = z.object({
...
export const getTemplatePartsRevision = pikkuSessionlessFunc({
  input: GetTemplatePartsRevisionInput,
  output: GetTemplatePartsRevisionOutput,
  func: async ({ wordpress }, data) => {
    return wordpress.call("GET", "/template-parts/{parent}/revisions/{id}", data) as any
  },
})
