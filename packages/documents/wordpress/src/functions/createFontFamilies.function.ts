...
export const CreateFontFamiliesOutput = z.object({
...
export const createFontFamilies = pikkuSessionlessFunc({
  input: CreateFontFamiliesInput,
  output: CreateFontFamiliesOutput,
  func: async ({ wordpress }, data) => {
    return wordpress.call("POST", "/font-families", data) as any
  },
})
