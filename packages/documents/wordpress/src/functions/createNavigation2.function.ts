...
export const CreateNavigation2Input = z.object({
...
export const CreateNavigation2Output = z.object({
  date: z.string().datetime().nullable().optional().describe("The date the post was published, in the site's timezone."),
  date_gmt: z.string().datetime().nullable().optional().describe("The date the post was published, as GMT."),
  guid: z.object({
...
export const createNavigation2 = pikkuSessionlessFunc({
  input: CreateNavigation2Input,
  output: CreateNavigation2Output,
  func: async ({ wordpress }, data) => {
    return wordpress.call("POST", "/navigation/{id}", data) as any
  },
})
