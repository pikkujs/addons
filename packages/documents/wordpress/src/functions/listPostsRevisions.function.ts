...
export const ListPostsRevisionsInput = z.object({
...
export const ListPostsRevisionsOutput = z.array(z.object({
...
export const listPostsRevisions = pikkuSessionlessFunc({
  input: ListPostsRevisionsInput,
  output: ListPostsRevisionsOutput,
  func: async ({ wordpress }, data) => {
    return wordpress.call("GET", "/posts/{parent}/revisions", data) as any
  },
})
