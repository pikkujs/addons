...
export const GetTypeInput = z.object({
  type: z.string().describe("An alphanumeric identifier for the post type."),
...
export const GetTypeOutput = z.object({
...
export const getType = pikkuSessionlessFunc({
  input: GetTypeInput,
  output: GetTypeOutput,
  func: async ({ wordpress }, data) => {
    return wordpress.call("GET", "/types/{type}", data) as any
  },
})
