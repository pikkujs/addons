...
export const ListTemplatesAutosavesInput = z.object({
...
export const ListTemplatesAutosavesOutput = z.array(z.object({
...
export const listTemplatesAutosaves = pikkuSessionlessFunc({
  input: ListTemplatesAutosavesInput,
  output: ListTemplatesAutosavesOutput,
  func: async ({ wordpress }, data) => {
    return wordpress.call("GET", "/templates/{id}/autosaves", data) as any
  },
})
