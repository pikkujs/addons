...
export const CreateMenuItemOutput = z.object({
  title: z.union([z.string(), z.record(z.string(), z.unknown())]).optional().describe("The title for the object."),
...
export const createMenuItem = pikkuSessionlessFunc({
  input: CreateMenuItemInput,
  output: CreateMenuItemOutput,
  func: async ({ wordpress }, data) => {
    return wordpress.call("POST", "/menu-items/{id}", data) as any
  },
})
