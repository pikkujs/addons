...
export const UpdateFontFamily2Input = z.object({
...
export const UpdateFontFamily2Output = z.object({
...
export const updateFontFamily2 = pikkuSessionlessFunc({
  input: UpdateFontFamily2Input,
  output: UpdateFontFamily2Output,
  func: async ({ wordpress }, data) => {
    return wordpress.call("PATCH", "/font-families/{id}", data) as any
  },
})
