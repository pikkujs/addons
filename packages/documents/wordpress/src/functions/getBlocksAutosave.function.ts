...
export const GetBlocksAutosaveInput = z.object({
...
export const GetBlocksAutosaveOutput = z.object({
...
export const getBlocksAutosave = pikkuSessionlessFunc({
  input: GetBlocksAutosaveInput,
  output: GetBlocksAutosaveOutput,
  func: async ({ wordpress }, data) => {
    return wordpress.call("GET", "/blocks/{parent}/autosaves/{id}", data) as any
  },
})
