...
export const ListWpPatternCategoryInput = z.object({
...
export const ListWpPatternCategoryOutput = z.array(z.object({
...
export const listWpPatternCategory = pikkuSessionlessFunc({
  input: ListWpPatternCategoryInput,
  output: ListWpPatternCategoryOutput,
  func: async ({ wordpress }, data) => {
    return wordpress.call("GET", "/wp_pattern_category", data) as any
  },
})
