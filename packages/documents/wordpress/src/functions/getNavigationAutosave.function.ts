...
export const GetNavigationAutosaveInput = z.object({
...
export const GetNavigationAutosaveOutput = z.object({
...
export const getNavigationAutosave = pikkuSessionlessFunc({
  input: GetNavigationAutosaveInput,
  output: GetNavigationAutosaveOutput,
  func: async ({ wordpress }, data) => {
    return wordpress.call("GET", "/navigation/{parent}/autosaves/{id}", data) as any
  },
})
