...
export const GetFontFamilyInput = z.object({
...
export const GetFontFamilyOutput = z.object({
...
export const getFontFamily = pikkuSessionlessFunc({
  input: GetFontFamilyInput,
  output: GetFontFamilyOutput,
  func: async ({ wordpress }, data) => {
    return wordpress.call("GET", "/font-families/{id}", data) as any
  },
})
