...
export const DeletePostsRevisionInput = z.object({
...
export const DeletePostsRevisionOutput = z.object({
...
export const deletePostsRevision = pikkuSessionlessFunc({
  input: DeletePostsRevisionInput,
  output: DeletePostsRevisionOutput,
  func: async ({ wordpress }, data) => {
    return wordpress.call("DELETE", "/posts/{parent}/revisions/{id}", data) as any
  },
})
