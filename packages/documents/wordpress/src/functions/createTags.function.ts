...
export const CreateTagsInput = z.object({
...
export const CreateTagsOutput = z.object({
...
export const createTags = pikkuSessionlessFunc({
  input: CreateTagsInput,
  output: CreateTagsOutput,
  func: async ({ wordpress }, data) => {
    return wordpress.call("POST", "/tags", data) as any
  },
})
