...
export const CreateFontFamilyInput = z.object({
...
export const CreateFontFamilyOutput = z.object({
...
export const createFontFamily = pikkuSessionlessFunc({
  input: CreateFontFamilyInput,
  output: CreateFontFamilyOutput,
  func: async ({ wordpress }, data) => {
    return wordpress.call("POST", "/font-families/{id}", data) as any
  },
})
