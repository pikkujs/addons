...
export const DeleteNavigationInput = z.object({
...
export const DeleteNavigationOutput = z.object({
...
export const deleteNavigation = pikkuSessionlessFunc({
  input: DeleteNavigationInput,
  output: DeleteNavigationOutput,
  func: async ({ wordpress }, data) => {
    return wordpress.call("DELETE", "/navigation/{id}", data) as any
  },
})
