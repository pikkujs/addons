...
export const CreateMedia2Input = z.object({
...
export const CreateMedia2Output = z.object({
  date: z.string().datetime().nullable().optional().describe("The date the post was published, in the site's timezone."),
  date_gmt: z.string().datetime().nullable().optional().describe("The date the post was published, as GMT."),
  guid: z.object({
...
export const createMedia2 = pikkuSessionlessFunc({
  input: CreateMedia2Input,
  output: CreateMedia2Output,
  func: async ({ wordpress }, data) => {
    return wordpress.call("POST", "/media/{id}", data) as any
  },
})
