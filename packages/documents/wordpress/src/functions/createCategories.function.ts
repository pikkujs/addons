...
export const CreateCategoriesInput = z.object({
...
export const CreateCategoriesOutput = z.object({
...
export const createCategories = pikkuSessionlessFunc({
  input: CreateCategoriesInput,
  output: CreateCategoriesOutput,
  func: async ({ wordpress }, data) => {
    return wordpress.call("POST", "/categories", data) as any
  },
})
