...
export const ListUsersApplicationPasswordsInput = z.object({
  user_id: z.string(),
...
export const ListUsersApplicationPasswordsOutput = z.array(z.object({
...
export const listUsersApplicationPasswords = pikkuSessionlessFunc({
  input: ListUsersApplicationPasswordsInput,
  output: ListUsersApplicationPasswordsOutput,
  func: async ({ wordpress }, data) => {
    return wordpress.call("GET", "/users/{user_id}/application-passwords", data) as any
  },
})
