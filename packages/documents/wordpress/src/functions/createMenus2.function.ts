...
export const CreateMenus2Input = z.object({
...
export const CreateMenus2Output = z.object({
...
export const createMenus2 = pikkuSessionlessFunc({
  input: CreateMenus2Input,
  output: CreateMenus2Output,
  func: async ({ wordpress }, data) => {
    return wordpress.call("POST", "/menus/{id}", data) as any
  },
})
