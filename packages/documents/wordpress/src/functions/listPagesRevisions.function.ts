...
export const ListPagesRevisionsInput = z.object({
...
export const ListPagesRevisionsOutput = z.array(z.object({
...
export const listPagesRevisions = pikkuSessionlessFunc({
  input: ListPagesRevisionsInput,
  output: ListPagesRevisionsOutput,
  func: async ({ wordpress }, data) => {
    return wordpress.call("GET", "/pages/{parent}/revisions", data) as any
  },
})
