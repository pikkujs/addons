...
export const ListPagesAutosavesInput = z.object({
  id: z.string(),
...
export const ListPagesAutosavesOutput = z.array(z.object({
...
export const listPagesAutosaves = pikkuSessionlessFunc({
  input: ListPagesAutosavesInput,
  output: ListPagesAutosavesOutput,
  func: async ({ wordpress }, data) => {
    return wordpress.call("GET", "/pages/{id}/autosaves", data) as any
  },
})
