...
export const GetWidgetInput = z.object({
  id: z.string(),
...
export const GetWidgetOutput = z.object({
...
export const getWidget = pikkuSessionlessFunc({
  input: GetWidgetInput,
  output: GetWidgetOutput,
  func: async ({ wordpress }, data) => {
    return wordpress.call("GET", "/widgets/{id}", data) as any
  },
})
