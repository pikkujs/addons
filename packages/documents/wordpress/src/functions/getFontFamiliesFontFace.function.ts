...
export const GetFontFamiliesFontFaceInput = z.object({
...
export const GetFontFamiliesFontFaceOutput = z.object({
...
export const getFontFamiliesFontFace = pikkuSessionlessFunc({
  input: GetFontFamiliesFontFaceInput,
  output: GetFontFamiliesFontFaceOutput,
  func: async ({ wordpress }, data) => {
    return wordpress.call("GET", "/font-families/{font_family_id}/font-faces/{id}", data) as any
  },
})
