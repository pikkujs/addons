...
export const DeleteMediaOutput = z.object({
...
export const deleteMedia = pikkuSessionlessFunc({
  input: DeleteMediaInput,
  output: DeleteMediaOutput,
  func: async ({ wordpress }, data) => {
    return wordpress.call("DELETE", "/media/{id}", data) as any
  },
})
