...
export const UpdateUsersApplicationPassword2Input = z.object({
  user_id: z.string(),
  uuid: z.string(),
...
export const UpdateUsersApplicationPassword2Output = z.object({
...
export const updateUsersApplicationPassword2 = pikkuSessionlessFunc({
  input: UpdateUsersApplicationPassword2Input,
  output: UpdateUsersApplicationPassword2Output,
  func: async ({ wordpress }, data) => {
    return wordpress.call("PATCH", "/users/{user_id}/application-passwords/{uuid}", data) as any
  },
})
