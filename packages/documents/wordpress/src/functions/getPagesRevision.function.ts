...
export const GetPagesRevisionInput = z.object({
...
export const GetPagesRevisionOutput = z.object({
...
export const getPagesRevision = pikkuSessionlessFunc({
  input: GetPagesRevisionInput,
  output: GetPagesRevisionOutput,
  func: async ({ wordpress }, data) => {
    return wordpress.call("GET", "/pages/{parent}/revisions/{id}", data) as any
  },
})
