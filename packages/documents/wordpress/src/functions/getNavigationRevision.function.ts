...
export const GetNavigationRevisionInput = z.object({
...
export const GetNavigationRevisionOutput = z.object({
...
export const getNavigationRevision = pikkuSessionlessFunc({
  input: GetNavigationRevisionInput,
  output: GetNavigationRevisionOutput,
  func: async ({ wordpress }, data) => {
    return wordpress.call("GET", "/navigation/{parent}/revisions/{id}", data) as any
  },
})
