...
export const DeleteTemplatePartInput = z.object({
...
export const DeleteTemplatePartOutput = z.object({
...
export const deleteTemplatePart = pikkuSessionlessFunc({
  input: DeleteTemplatePartInput,
  output: DeleteTemplatePartOutput,
  func: async ({ wordpress }, data) => {
    return wordpress.call("DELETE", "/template-parts/{id}", data) as any
  },
})
