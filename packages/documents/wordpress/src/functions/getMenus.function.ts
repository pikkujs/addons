...
export const GetMenusInput = z.object({
...
export const GetMenusOutput = z.object({
...
export const getMenus = pikkuSessionlessFunc({
  input: GetMenusInput,
  output: GetMenusOutput,
  func: async ({ wordpress }, data) => {
    return wordpress.call("GET", "/menus/{id}", data) as any
  },
})
