...
export const CreateTemplatePartsOutput = z.object({
...
export const createTemplateParts = pikkuSessionlessFunc({
  input: CreateTemplatePartsInput,
  output: CreateTemplatePartsOutput,
  func: async ({ wordpress }, data) => {
    return wordpress.call("POST", "/template-parts", data) as any
  },
})
