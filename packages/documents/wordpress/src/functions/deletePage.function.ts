...
export const DeletePageOutput = z.object({
...
export const deletePage = pikkuSessionlessFunc({
  input: DeletePageInput,
  output: DeletePageOutput,
  func: async ({ wordpress }, data) => {
    return wordpress.call("DELETE", "/pages/{id}", data) as any
  },
})
