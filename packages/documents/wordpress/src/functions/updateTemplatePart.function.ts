...
export const UpdateTemplatePartInput = z.object({
...
export const UpdateTemplatePartOutput = z.object({
...
export const updateTemplatePart = pikkuSessionlessFunc({
  input: UpdateTemplatePartInput,
  output: UpdateTemplatePartOutput,
  func: async ({ wordpress }, data) => {
    return wordpress.call("PUT", "/template-parts/{id}", data) as any
  },
})
