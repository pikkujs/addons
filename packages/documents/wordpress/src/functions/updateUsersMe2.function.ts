...
export const UpdateUsersMe2Input = z.object({
...
export const UpdateUsersMe2Output = z.object({
...
export const updateUsersMe2 = pikkuSessionlessFunc({
  input: UpdateUsersMe2Input,
  output: UpdateUsersMe2Output,
  func: async ({ wordpress }, data) => {
    return wordpress.call("PATCH", "/users/me", data) as any
  },
})
