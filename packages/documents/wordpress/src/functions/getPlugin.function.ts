...
export const GetPluginInput = z.object({
  plugin: z.string(),
...
export const GetPluginOutput = z.object({
...
export const getPlugin = pikkuSessionlessFunc({
  input: GetPluginInput,
  output: GetPluginOutput,
  func: async ({ wordpress }, data) => {
    return wordpress.call("GET", "/plugins/{plugin}", data) as any
  },
})
