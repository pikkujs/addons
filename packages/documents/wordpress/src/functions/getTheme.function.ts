...
export const GetThemeInput = z.object({
  stylesheet: z.string().describe("The theme's stylesheet. This uniquely identifies the theme."),
})

export const GetThemeOutput = z.object({
...
export const getTheme = pikkuSessionlessFunc({
  input: GetThemeInput,
  output: GetThemeOutput,
  func: async ({ wordpress }, data) => {
    return wordpress.call("GET", "/themes/{stylesheet}", data) as any
  },
})
