...
export const DeleteBlocksRevisionInput = z.object({
...
export const DeleteBlocksRevisionOutput = z.object({
...
export const deleteBlocksRevision = pikkuSessionlessFunc({
  input: DeleteBlocksRevisionInput,
  output: DeleteBlocksRevisionOutput,
  func: async ({ wordpress }, data) => {
    return wordpress.call("DELETE", "/blocks/{parent}/revisions/{id}", data) as any
  },
})
