...
export const DeleteNavigationRevisionInput = z.object({
...
export const DeleteNavigationRevisionOutput = z.object({
...
export const deleteNavigationRevision = pikkuSessionlessFunc({
  input: DeleteNavigationRevisionInput,
  output: DeleteNavigationRevisionOutput,
  func: async ({ wordpress }, data) => {
    return wordpress.call("DELETE", "/navigation/{parent}/revisions/{id}", data) as any
  },
})
