...
export const CreateTemplatePartInput = z.object({
...
export const CreateTemplatePartOutput = z.object({
...
export const createTemplatePart = pikkuSessionlessFunc({
  input: CreateTemplatePartInput,
  output: CreateTemplatePartOutput,
  func: async ({ wordpress }, data) => {
    return wordpress.call("POST", "/template-parts/{id}", data) as any
  },
})
