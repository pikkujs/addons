...
export const ListMenusOutput = z.array(z.object({
...
export const listMenus = pikkuSessionlessFunc({
  input: ListMenusInput,
  output: ListMenusOutput,
  func: async ({ wordpress }, data) => {
    return wordpress.call("GET", "/menus", data) as any
  },
})
