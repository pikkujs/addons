...
export const ListPostsAutosavesInput = z.object({
  id: z.string(),
...
export const ListPostsAutosavesOutput = z.array(z.object({
...
export const listPostsAutosaves = pikkuSessionlessFunc({
  input: ListPostsAutosavesInput,
  output: ListPostsAutosavesOutput,
  func: async ({ wordpress }, data) => {
    return wordpress.call("GET", "/posts/{id}/autosaves", data) as any
  },
})
