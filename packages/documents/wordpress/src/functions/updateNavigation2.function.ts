...
export const UpdateNavigation2Input = z.object({
...
export const UpdateNavigation2Output = z.object({
  date: z.string().datetime().nullable().optional().describe("The date the post was published, in the site's timezone."),
  date_gmt: z.string().datetime().nullable().optional().describe("The date the post was published, as GMT."),
  guid: z.object({
...
export const updateNavigation2 = pikkuSessionlessFunc({
  input: UpdateNavigation2Input,
  output: UpdateNavigation2Output,
  func: async ({ wordpress }, data) => {
    return wordpress.call("PATCH", "/navigation/{id}", data) as any
  },
})
