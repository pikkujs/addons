...
export const GetTemplatesRevisionInput = z.object({
...
export const GetTemplatesRevisionOutput = z.object({
...
export const getTemplatesRevision = pikkuSessionlessFunc({
  input: GetTemplatesRevisionInput,
  output: GetTemplatesRevisionOutput,
  func: async ({ wordpress }, data) => {
    return wordpress.call("GET", "/templates/{parent}/revisions/{id}", data) as any
  },
})
