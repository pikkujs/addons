...
export const GetTemplatePartInput = z.object({
...
export const GetTemplatePartOutput = z.object({
...
export const getTemplatePart = pikkuSessionlessFunc({
  input: GetTemplatePartInput,
  output: GetTemplatePartOutput,
  func: async ({ wordpress }, data) => {
    return wordpress.call("GET", "/template-parts/{id}", data) as any
  },
})
