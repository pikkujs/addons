...
export const GetNavigationInput = z.object({
...
export const GetNavigationOutput = z.object({
...
export const getNavigation = pikkuSessionlessFunc({
  input: GetNavigationInput,
  output: GetNavigationOutput,
  func: async ({ wordpress }, data) => {
    return wordpress.call("GET", "/navigation/{id}", data) as any
  },
})
