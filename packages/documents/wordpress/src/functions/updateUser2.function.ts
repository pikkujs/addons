...
export const UpdateUser2Input = z.object({
...
export const UpdateUser2Output = z.object({
...
export const updateUser2 = pikkuSessionlessFunc({
  input: UpdateUser2Input,
  output: UpdateUser2Output,
  func: async ({ wordpress }, data) => {
    return wordpress.call("PATCH", "/users/{id}", data) as any
  },
})
