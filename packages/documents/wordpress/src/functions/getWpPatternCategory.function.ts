...
export const GetWpPatternCategoryInput = z.object({
...
export const GetWpPatternCategoryOutput = z.object({
...
export const getWpPatternCategory = pikkuSessionlessFunc({
  input: GetWpPatternCategoryInput,
  output: GetWpPatternCategoryOutput,
  func: async ({ wordpress }, data) => {
    return wordpress.call("GET", "/wp_pattern_category/{id}", data) as any
  },
})
