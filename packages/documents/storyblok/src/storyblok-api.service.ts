...
const ROUTES: Record<string, { path: string[], query: string[], headers: string[], errors?: Record<number, string> }> = {
  "GET /v1/spaces/{spaceId}/stories/{storyId}": {
    "path": [
      "spaceId",
      "storyId"
    ],
  ...
  "DELETE /v1/spaces/{spaceId}/stories/{storyId}": {
    "path": [
      "spaceId",
      "storyId"
    ],
  ...
  "GET /v1/spaces/{spaceId}/stories/{storyId}/publish": {
    "path": [
      "spaceId",
      "storyId"
    ],
  ...
  "GET /v1/spaces/{spaceId}/stories/{storyId}/unpublish": {
    "path": [
      "spaceId",
      "storyId"
    ],
...
export class StoryblokService {
  ...
  constructor(private creds: { apiKey: string }, variables: TypedVariablesService) {
    this.baseUrl = variables.get('STORYBLOK_BASE_URL') as string
  }
  ...
  async call<T>(
    ...
    if (!response.ok) {
      ...
      switch (response.status) {
        ...
        default: throw new Error(`Storyblok API error (${response.status}): ${errorText}`)
      }
    }
