...
export const UpdateClientOutput = z.object({
  client: z.object({
...
export const updateClient = pikkuSessionlessFunc({
  description: "#### Allowed for\n * Admins",
  input: UpdateClientInput,
  output: UpdateClientOutput,
  func: async ({ zendesk }, data) => {
    return zendesk.call("PUT", "/api/v2/oauth/clients/{oauth_client_id}", data) as any
  },
})
