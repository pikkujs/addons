...
export const MarkManyTicketsAsSpamInput = z.object({
  ids: z.string().describe("Comma-separated list of ticket ids. Example: \"35436,35437\""),
})

export const MarkManyTicketsAsSpamOutput = z.object({
  job_status: z.object({
...
export const markManyTicketsAsSpam = pikkuSessionlessFunc({
  ...
  input: MarkManyTicketsAsSpamInput,
  output: MarkManyTicketsAsSpamOutput,
  func: async ({ zendesk }, data) => {
    return zendesk.call("PUT", "/api/v2/tickets/mark_many_as_spam", data) as any
  },
})
