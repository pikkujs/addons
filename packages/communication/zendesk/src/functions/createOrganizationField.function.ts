...
export const CreateOrganizationFieldOutput = z.object({
...
export const createOrganizationField = pikkuSessionlessFunc({
  ...
  output: CreateOrganizationFieldOutput,
  func: async ({ zendesk }) => {
    return zendesk.call("POST", "/api/v2/organization_fields") as any
  },
})
