...
export const CreateMacroOutput = z.object({
  macro: z.object({
    actions: z.array(z.object({
      field: z.string().optional().describe("The name of a ticket field to modify"),
      value: z.string().optional().describe("The new value of the field"),
...
export const createMacro = pikkuSessionlessFunc({
  description: "#### Allowed For\n* Agents",
  input: CreateMacroInput,
  output: CreateMacroOutput,
  func: async ({ zendesk }, data) => {
    return zendesk.call("POST", "/api/v2/macros", data) as any
  },
})
