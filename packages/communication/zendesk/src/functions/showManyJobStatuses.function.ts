...
export const ShowManyJobStatusesOutput = z.object({
...
export const showManyJobStatuses = pikkuSessionlessFunc({
  description: "Accepts a comma-separated list of job status ids.\n\n#### Allowed For:\n\n* Agents",
  input: ShowManyJobStatusesInput,
  output: ShowManyJobStatusesOutput,
  func: async ({ zendesk }, data) => {
    return zendesk.call("GET", "/api/v2/job_statuses/show_many", data) as any
  },
})
