...
export const CreateOrganizationMembershipOutput = z.object({
...
export const createOrganizationMembership = pikkuSessionlessFunc({
  ...
  output: CreateOrganizationMembershipOutput,
  func: async ({ zendesk }) => {
    return zendesk.call("POST", "/api/v2/organization_memberships") as any
  },
})
