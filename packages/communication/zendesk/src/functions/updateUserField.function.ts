...
export const updateUserField = pikkuSessionlessFunc({
  ...
  output: UpdateUserFieldOutput,
  func: async ({ zendesk }, data) => {
    return zendesk.call("PUT", "/api/v2/user_fields/{user_field_id}", data) as any
  },
})
