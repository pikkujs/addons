...
export const RedactStringInCommentInput = z.object({
...
export const RedactStringInCommentOutput = z.object({
  comment: z.object({
...
export const redactStringInComment = pikkuSessionlessFunc({
  ...
  input: RedactStringInCommentInput,
  output: RedactStringInCommentOutput,
  func: async ({ zendesk }, data) => {
    return zendesk.call("PUT", "/api/v2/tickets/{ticket_id}/comments/{ticket_comment_id}/redact", data) as any
  },
})
