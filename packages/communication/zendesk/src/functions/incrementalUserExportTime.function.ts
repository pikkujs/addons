...
export const IncrementalUserExportTimeInput = z.object({
...
export const IncrementalUserExportTimeOutput = z.object({
...
export const incrementalUserExportTime = pikkuSessionlessFunc({
  description: "#### Allowed For\n\n * Admins\n\n#### Sideloading\n\nSee [Users sideloads](/documentation/ticketing/using-the-zendesk-api/side_loading/#supported-endpoints).",
  input: IncrementalUserExportTimeInput,
  output: IncrementalUserExportTimeOutput,
  func: async ({ zendesk }, data) => {
    return zendesk.call("GET", "/api/v2/incremental/users", data) as any
  },
})
