...
export const UpdateTicketFormInput = z.object({
  ticket_form_id: z.number().int().describe("The ID of the ticket form. Example: 47"),
})

export const UpdateTicketFormOutput = z.object({
...
export const updateTicketForm = pikkuSessionlessFunc({
  description: "#### Allowed For\n* Admins",
  input: UpdateTicketFormInput,
  output: UpdateTicketFormOutput,
  func: async ({ zendesk }, data) => {
    return zendesk.call("PUT", "/api/v2/ticket_forms/{ticket_form_id}", data) as any
  },
})
