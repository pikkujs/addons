...
export const ShowTicketfieldInput = z.object({
...
export const ShowTicketfieldOutput = z.object({
...
export const showTicketfield = pikkuSessionlessFunc({
  description: "#### Allowed for\n\n* Agents\n\n#### Sideloads\n\nThe following sideloads are supported:\n\n| Name             | Will sideload\n| ---------------- | -------------\n| users            | The user or users that created the ticket field",
  input: ShowTicketfieldInput,
  output: ShowTicketfieldOutput,
  func: async ({ zendesk }, data) => {
    return zendesk.call("GET", "/api/v2/ticket_fields/{ticket_field_id}", data) as any
  },
})
