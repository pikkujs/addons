...
export const ListItamAssetTypesOutput = z.object({
...
export const listItamAssetTypes = pikkuSessionlessFunc({
  description: "Lists all asset types.\n\n#### Allowed For\n\n* Agents",
  output: ListItamAssetTypesOutput,
  func: async ({ zendesk }) => {
    return zendesk.call("GET", "/api/v2/it_asset_management/asset_types") as any
  },
})
