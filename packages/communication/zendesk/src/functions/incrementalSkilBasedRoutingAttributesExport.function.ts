...
export const IncrementalSkilBasedRoutingAttributesExportOutput = z.object({
...
export const incrementalSkilBasedRoutingAttributesExport = pikkuSessionlessFunc({
  ...
  output: IncrementalSkilBasedRoutingAttributesExportOutput,
  func: async ({ zendesk }) => {
    return zendesk.call("GET", "/api/v2/incremental/routing/attributes") as any
  },
})
