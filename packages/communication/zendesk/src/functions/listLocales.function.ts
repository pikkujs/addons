...
export const ListLocalesOutput = z.object({
...
export const listLocales = pikkuSessionlessFunc({
  ...
  output: ListLocalesOutput,
  func: async ({ zendesk }) => {
    return zendesk.call("GET", "/api/v2/locales") as any
  },
})
