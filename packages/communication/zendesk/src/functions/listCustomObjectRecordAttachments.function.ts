...
export const ListCustomObjectRecordAttachmentsInput = z.object({
...
export const ListCustomObjectRecordAttachmentsOutput = z.object({
  custom_object_record_attachments: z.array(z.object({
...
export const listCustomObjectRecordAttachments = pikkuSessionlessFunc({
  description: "Lists all attachments associated with a custom object record.\n\n#### Allowed For\n* Agents",
  input: ListCustomObjectRecordAttachmentsInput,
  output: ListCustomObjectRecordAttachmentsOutput,
  errors: [BadRequestError],
  func: async ({ zendesk }, data) => {
    return zendesk.call("GET", "/api/v2/custom_objects/{custom_object_key}/records/{record_id}/attachments", data) as any
  },
})
