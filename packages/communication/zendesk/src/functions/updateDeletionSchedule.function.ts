...
export const UpdateDeletionScheduleInput = z.object({
...
export const UpdateDeletionScheduleOutput = z.object({
  deletion_schedule: z.object({
    active: z.boolean().optional().describe("Whether the deletion schedule is active"),
    conditions: z.object({
      all: z.array(z.object({
...
export const updateDeletionSchedule = pikkuSessionlessFunc({
  ...
  input: UpdateDeletionScheduleInput,
  output: UpdateDeletionScheduleOutput,
  func: async ({ zendesk }, data) => {
    return zendesk.call("PUT", "/api/v2/deletion_schedules/{deletion_schedule_id}", data) as any
  },
})
