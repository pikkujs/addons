...
export const ListActiveObjectTriggersInput = z.object({
...
export const ListActiveObjectTriggersOutput = z.object({
...
export const listActiveObjectTriggers = pikkuSessionlessFunc({
  ...
  input: ListActiveObjectTriggersInput,
  output: ListActiveObjectTriggersOutput,
  func: async ({ zendesk }, data) => {
    return zendesk.call("GET", "/api/v2/custom_objects/{custom_object_key}/triggers/active", data) as any
  },
})
