...
export const CreateResourceCollectionOutput = z.object({
  job_status: z.object({
...
export const createResourceCollection = pikkuSessionlessFunc({
  ...
  output: CreateResourceCollectionOutput,
  func: async ({ zendesk }) => {
    return zendesk.call("POST", "/api/v2/resource_collections") as any
  },
})
