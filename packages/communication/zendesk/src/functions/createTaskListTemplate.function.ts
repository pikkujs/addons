...
export const CreateTaskListTemplateInput = z.object({
...
export const CreateTaskListTemplateOutput = z.object({
  task_list_template: z.object({
    created_at: z.string().datetime().optional().describe("The time the task list template was created"),
    description: z.string().optional().describe("The description of the task list template"),
    id: z.string().optional().describe("Automatically assigned when the task list template is created"),
...
export const createTaskListTemplate = pikkuSessionlessFunc({
  description: "Creates a task list template.\n\n#### Allowed For\n\n* Admins",
  input: CreateTaskListTemplateInput,
  output: CreateTaskListTemplateOutput,
  func: async ({ zendesk }, data) => {
    return zendesk.call("POST", "/api/v2/task_list_templates", data) as any
  },
})
