...
export const UpdateWorkspaceOutput = z.object({
  workspace: z.object({
...
export const updateWorkspace = pikkuSessionlessFunc({
  description: "#### Allowed For\n* Admins",
  input: UpdateWorkspaceInput,
  output: UpdateWorkspaceOutput,
  func: async ({ zendesk }, data) => {
    return zendesk.call("PUT", "/api/v2/workspaces/{workspace_id}", data) as any
  },
})
