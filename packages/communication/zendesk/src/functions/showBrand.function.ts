...
export const ShowBrandInput = z.object({
  brand_id: z.number().int().describe("The ID of the brand. Example: 360002783572"),
})

export const ShowBrandOutput = z.object({
  brand: z.object({
...
export const showBrand = pikkuSessionlessFunc({
  description: "Returns a brand for your account.\n\n#### Allowed for\n\n* Admins, Agents",
  input: ShowBrandInput,
  output: ShowBrandOutput,
  func: async ({ zendesk }, data) => {
    return zendesk.call("GET", "/api/v2/brands/{brand_id}", data) as any
  },
})
