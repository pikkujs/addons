...
export const ListUserFieldsInput = z.object({
  page: z.object({
...
export const ListUserFieldsOutput = z.object({
...
export const listUserFields = pikkuSessionlessFunc({
  ...
  input: ListUserFieldsInput,
  output: ListUserFieldsOutput,
  func: async ({ zendesk }, data) => {
    return zendesk.call("GET", "/api/v2/user_fields", data) as any
  },
})
