...
export const ShowSuspendedTicketsOutput = z.object({
...
export const showSuspendedTickets = pikkuSessionlessFunc({
  ...
  input: ShowSuspendedTicketsInput,
  output: ShowSuspendedTicketsOutput,
  func: async ({ zendesk }, data) => {
    return zendesk.call("GET", "/api/v2/suspended_tickets/{id}", data) as any
  },
})
