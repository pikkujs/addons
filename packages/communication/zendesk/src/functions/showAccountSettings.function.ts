...
export const ShowAccountSettingsInput = z.object({
  authenticity_token: z.string().optional().describe("Legacy CSRF token. Ignored by API."),
})

export const ShowAccountSettingsOutput = z.object({
  settings: z.object({
...
export const showAccountSettings = pikkuSessionlessFunc({
  description: "Shows the settings that are available for the account.\n\n#### Allowed For\n\n* Agents",
  input: ShowAccountSettingsInput,
  output: ShowAccountSettingsOutput,
  func: async ({ zendesk }, data) => {
    return zendesk.call("GET", "/api/v2/account/settings", data) as any
  },
})
