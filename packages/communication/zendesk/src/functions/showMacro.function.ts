...
export const ShowMacroInput = z.object({
  macro_id: z.number().int().describe("The ID of the macro. Example: 25"),
})

export const ShowMacroOutput = z.object({
  macro: z.object({
...
export const showMacro = pikkuSessionlessFunc({
  description: "#### Allowed For\n* Agents",
  input: ShowMacroInput,
  output: ShowMacroOutput,
  func: async ({ zendesk }, data) => {
    return zendesk.call("GET", "/api/v2/macros/{macro_id}", data) as any
  },
})
