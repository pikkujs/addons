...
export const showUserField = pikkuSessionlessFunc({
  description: "#### Allowed for\n\n* Agents",
  input: ShowUserFieldInput,
  output: ShowUserFieldOutput,
  func: async ({ zendesk }, data) => {
    return zendesk.call("GET", "/api/v2/user_fields/{user_field_id}", data) as any
  },
})
