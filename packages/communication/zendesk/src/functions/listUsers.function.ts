...
export const listUsers = pikkuSessionlessFunc({
  ...
  func: async ({ zendesk }, data) => {
    return zendesk.call("GET", "/api/v2/users", data) as any
  },
})
