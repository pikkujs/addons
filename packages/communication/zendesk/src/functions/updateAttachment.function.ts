...
export const UpdateAttachmentInput = z.object({
  ...
  attachment: z.object({
  malware_access_override: z.boolean().optional().describe("If true, allows access to attachments with detected malware."),
}).optional(),
})
...
export const updateAttachment = pikkuSessionlessFunc({
  ...
  func: async ({ zendesk }, data) => {
    return zendesk.call("PUT", "/api/v2/attachments/{attachment_id}", data) as any
  },
})
