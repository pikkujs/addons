...
export const CreateSLAPolicyOutput = z.object({
  sla_policy: z.object({
...
export const createSLAPolicy = pikkuSessionlessFunc({
  description: "#### Availability\n\n* Accounts on the Support Professional or Suite Growth plan or above\n\n#### Allowed For\n\n* Admins",
  output: CreateSLAPolicyOutput,
  func: async ({ zendesk }) => {
    return zendesk.call("POST", "/api/v2/slas/policies") as any
  },
})
