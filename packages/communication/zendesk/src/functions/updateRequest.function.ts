...
export const UpdateRequestOutput = z.object({
  request: z.object({
...
export const updateRequest = pikkuSessionlessFunc({
  ...
  func: async ({ zendesk }, data) => {
    return zendesk.call("PUT", "/api/v2/requests/{request_id}", data) as any
  },
})
