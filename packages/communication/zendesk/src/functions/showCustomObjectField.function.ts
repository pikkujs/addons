...
export const ShowCustomObjectFieldInput = z.object({
  ...
  include_standard_fields: z.boolean().optional().describe("If true, returns standard fields in addition to custom fields."),
})

export const ShowCustomObjectFieldOutput = z.object({
...
export const showCustomObjectField = pikkuSessionlessFunc({
  description: "Returns a custom field for a specific object using a provided key or id of the field.\n#### Allowed For\n* Agents",
  input: ShowCustomObjectFieldInput,
  output: ShowCustomObjectFieldOutput,
  func: async ({ zendesk }, data) => {
    return zendesk.call("GET", "/api/v2/custom_objects/{custom_object_key}/fields/{custom_object_field_key_or_id}", data) as any
  },
})
