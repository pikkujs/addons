...
export const ShowCurrentLocaleOutput = z.object({
  locale: z.object({
...
export const showCurrentLocale = pikkuSessionlessFunc({
  ...
  output: ShowCurrentLocaleOutput,
  func: async ({ zendesk }) => {
    return zendesk.call("GET", "/api/v2/locales/current") as any
  },
})
