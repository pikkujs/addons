...
export const ListAvailablePublicLocalesOutput = z.object({
...
export const listAvailablePublicLocales = pikkuSessionlessFunc({
  description: "Lists the translation locales that are available to all accounts.\n\n#### Allowed For\n\n* Anyone",
  output: ListAvailablePublicLocalesOutput,
  func: async ({ zendesk }) => {
    return zendesk.call("GET", "/api/v2/locales/public") as any
  },
})
