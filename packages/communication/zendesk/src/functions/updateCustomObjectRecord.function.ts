...
export const UpdateCustomObjectRecordInput = z.object({
...
export const UpdateCustomObjectRecordOutput = z.object({
...
export const updateCustomObjectRecord = pikkuSessionlessFunc({
  ...
  output: UpdateCustomObjectRecordOutput,
  func: async ({ zendesk }, data) => {
    return zendesk.call("PATCH", "/api/v2/custom_objects/{custom_object_key}/records/{custom_object_record_id}", data) as any
  },
})
