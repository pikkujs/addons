...
export const showClient = pikkuSessionlessFunc({
  description: "#### Allowed for\n* Admins",
  input: ShowClientInput,
  output: ShowClientOutput,
  func: async ({ zendesk }, data) => {
    return zendesk.call("GET", "/api/v2/oauth/clients/{oauth_client_id}", data) as any
  },
})
