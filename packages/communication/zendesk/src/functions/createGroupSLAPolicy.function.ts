...
export const CreateGroupSLAPolicyOutput = z.object({
...
export const createGroupSLAPolicy = pikkuSessionlessFunc({
  description: "#### Allowed For\n\n* Admins",
  output: CreateGroupSLAPolicyOutput,
  func: async ({ zendesk }) => {
    return zendesk.call("POST", "/api/v2/group_slas/policies") as any
  },
})
