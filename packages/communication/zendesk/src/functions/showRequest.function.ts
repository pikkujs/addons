...
export const ShowRequestInput = z.object({
  request_id: z.number().int().describe("The ID of the request. Example: 33"),
})

export const ShowRequestOutput = z.object({
  request: z.object({
...
export const showRequest = pikkuSessionlessFunc({
  description: "#### Sideloads\n\nThe following sideloads are supported:\n\n| Name             | Will sideload\n| ---------------- | -------------\n| users            | The email ccs for a request by side-loading users\n\n#### Allowed For\n\n* End Users",
  input: ShowRequestInput,
  output: ShowRequestOutput,
  func: async ({ zendesk }, data) => {
    return zendesk.call("GET", "/api/v2/requests/{request_id}", data) as any
  },
})
