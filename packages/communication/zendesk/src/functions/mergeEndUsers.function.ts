...
export const MergeEndUsersInput = z.object({
...
export const MergeEndUsersOutput = z.object({
  user: z.union([z.object({
...
export const mergeEndUsers = pikkuSessionlessFunc({
  ...
  input: MergeEndUsersInput,
  output: MergeEndUsersOutput,
  func: async ({ zendesk }, data) => {
    return zendesk.call("PUT", "/api/v2/users/{user_id}/merge", data) as any
  },
})
