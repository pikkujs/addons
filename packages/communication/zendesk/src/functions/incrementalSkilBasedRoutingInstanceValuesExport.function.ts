...
export const IncrementalSkilBasedRoutingInstanceValuesExportOutput = z.object({
...
export const incrementalSkilBasedRoutingInstanceValuesExport = pikkuSessionlessFunc({
  ...
  output: IncrementalSkilBasedRoutingInstanceValuesExportOutput,
  func: async ({ zendesk }) => {
    return zendesk.call("GET", "/api/v2/incremental/routing/instance_values") as any
  },
})
