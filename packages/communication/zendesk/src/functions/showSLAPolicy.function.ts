...
export const ShowSLAPolicyOutput = z.object({
  sla_policy: z.object({
...
export const showSLAPolicy = pikkuSessionlessFunc({
  description: "#### Availability\n\n* Accounts on the Support Professional or Suite Growth plan or above\n\n#### Allowed For\n\n* Admins",
  input: ShowSLAPolicyInput,
  output: ShowSLAPolicyOutput,
  func: async ({ zendesk }, data) => {
    return zendesk.call("GET", "/api/v2/slas/policies/{sla_policy_id}", data) as any
  },
})
