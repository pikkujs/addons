...
export const GetSourcesByTargetOutput = z.object({
...
export const getSourcesByTarget = pikkuSessionlessFunc({
  ...
  input: GetSourcesByTargetInput,
  output: GetSourcesByTargetOutput,
  func: async ({ zendesk }, data) => {
    return zendesk.call("GET", "/api/v2/{target_type}/{target_id}/relationship_fields/{field_id}/{source_type}", data) as any
  },
})
