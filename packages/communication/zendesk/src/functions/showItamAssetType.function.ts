...
export const showItamAssetType = pikkuSessionlessFunc({
  description: "Returns an asset type with the specified id.\n\n#### Allowed For\n\n* Agents",
  input: ShowItamAssetTypeInput,
  output: ShowItamAssetTypeOutput,
  func: async ({ zendesk }, data) => {
    return zendesk.call("GET", "/api/v2/it_asset_management/asset_types/{asset_type_id}", data) as any
  },
})
