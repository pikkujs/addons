...
export const CloneTicketFormInput = z.object({
  ticket_form_id: z.number().int().describe("The ID of the ticket form. Example: 47"),
})

export const CloneTicketFormOutput = z.object({
...
export const cloneTicketForm = pikkuSessionlessFunc({
  description: "#### Allowed For\n\n* Admins",
  input: CloneTicketFormInput,
  output: CloneTicketFormOutput,
  func: async ({ zendesk }, data) => {
    return zendesk.call("POST", "/api/v2/ticket_forms/{ticket_form_id}/clone", data) as any
  },
})
