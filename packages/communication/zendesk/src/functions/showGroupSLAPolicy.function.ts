...
export const ShowGroupSLAPolicyInput = z.object({
  group_sla_policy_id: z.number().int().describe("The id of the Group SLA policy. Example: 36"),
})

export const ShowGroupSLAPolicyOutput = z.object({
...
export const showGroupSLAPolicy = pikkuSessionlessFunc({
  description: "#### Allowed For\n\n* Admins",
  input: ShowGroupSLAPolicyInput,
  output: ShowGroupSLAPolicyOutput,
  func: async ({ zendesk }, data) => {
    return zendesk.call("GET", "/api/v2/group_slas/policies/{group_sla_policy_id}", data) as any
  },
})
