...
export const showQueueById = pikkuSessionlessFunc({
  description: "Returns a queue for the given queue id.\n#### Allowed For\n\n* Agents",
  input: ShowQueueByIdInput,
  output: ShowQueueByIdOutput,
  func: async ({ zendesk }, data) => {
    return zendesk.call("GET", "/api/v2/queues/{queue_id}", data) as any
  },
})
