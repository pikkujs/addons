...
export const DeleteResourceCollectionInput = z.object({
  resource_collection_id: z.number().int().describe("The id of the resource collection. Example: 10002"),
})

export const DeleteResourceCollectionOutput = z.object({
  job_status: z.object({
...
export const deleteResourceCollection = pikkuSessionlessFunc({
  ...
  input: DeleteResourceCollectionInput,
  output: DeleteResourceCollectionOutput,
  func: async ({ zendesk }, data) => {
    return zendesk.call("DELETE", "/api/v2/resource_collections/{resource_collection_id}", data) as any
  },
})
