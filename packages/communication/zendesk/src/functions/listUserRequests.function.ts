...
export const ListUserRequestsInput = z.object({
...
export const ListUserRequestsOutput = z.object({
...
export const listUserRequests = pikkuSessionlessFunc({
  description: "Lists requests for the specified user.\n\n#### Allowed for\n\n* End Users",
  input: ListUserRequestsInput,
  output: ListUserRequestsOutput,
  func: async ({ zendesk }, data) => {
    return zendesk.call("GET", "/api/v2/users/{user_id}/requests", data) as any
  },
})
