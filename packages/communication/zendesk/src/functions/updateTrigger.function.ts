...
export const UpdateTriggerInput = z.object({
...
export const UpdateTriggerOutput = z.object({
  trigger: z.object({
    actions: z.array(z.object({
      field: z.string().optional(),
      value: z.union([z.string(), z.number().int(), z.array(z.union([z.string(), z.number().int()]))]).optional(),
...
export const updateTrigger = pikkuSessionlessFunc({
  ...
  func: async ({ zendesk }, data) => {
    return zendesk.call("PUT", "/api/v2/triggers/{trigger_id}", data) as any
  },
})
