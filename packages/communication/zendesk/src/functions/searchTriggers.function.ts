...
export const SearchTriggersInput = z.object({
...
export const SearchTriggersOutput = z.object({
...
export const searchTriggers = pikkuSessionlessFunc({
  ...
  input: SearchTriggersInput,
  output: SearchTriggersOutput,
  func: async ({ zendesk }, data) => {
    return zendesk.call("GET", "/api/v2/triggers/search", data) as any
  },
})
