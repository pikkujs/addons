...
export const ShowUserIdentityInput = z.object({
...
export const ShowUserIdentityOutput = z.object({
  identity: z.object({
...
export const showUserIdentity = pikkuSessionlessFunc({
  ...
  input: ShowUserIdentityInput,
  output: ShowUserIdentityOutput,
  func: async ({ zendesk }, data) => {
    return zendesk.call("GET", "/api/v2/users/{user_id}/identities/{user_identity_id}", data) as any
  },
})
