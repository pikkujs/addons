...
export const DeleteManyOrganizationsInput = z.object({
...
export const DeleteManyOrganizationsOutput = z.object({
  job_status: z.object({
...
export const deleteManyOrganizations = pikkuSessionlessFunc({
  ...
  output: DeleteManyOrganizationsOutput,
  func: async ({ zendesk }, data) => {
    return zendesk.call("DELETE", "/api/v2/organizations/destroy_many", data) as any
  },
})
