...
export const ListActiveMacrosInput = z.object({
...
export const ListActiveMacrosOutput = z.object({
...
export const listActiveMacros = pikkuSessionlessFunc({
  description: "Lists all active shared and personal macros available to the current user.\n\n#### Allowed For\n* Agents",
  input: ListActiveMacrosInput,
  output: ListActiveMacrosOutput,
  func: async ({ zendesk }, data) => {
    return zendesk.call("GET", "/api/v2/macros/active", data) as any
  },
})
