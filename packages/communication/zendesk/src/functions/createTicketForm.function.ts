...
export const CreateTicketFormOutput = z.object({
...
export const createTicketForm = pikkuSessionlessFunc({
  description: "#### Allowed For\n\n* Admins",
  output: CreateTicketFormOutput,
  func: async ({ zendesk }) => {
    return zendesk.call("POST", "/api/v2/ticket_forms") as any
  },
})
