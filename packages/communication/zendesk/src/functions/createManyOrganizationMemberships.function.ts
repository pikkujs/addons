...
export const CreateManyOrganizationMembershipsOutput = z.object({
  job_status: z.object({
...
export const createManyOrganizationMemberships = pikkuSessionlessFunc({
  ...
  output: CreateManyOrganizationMembershipsOutput,
  func: async ({ zendesk }) => {
    return zendesk.call("POST", "/api/v2/organization_memberships/create_many") as any
  },
})
