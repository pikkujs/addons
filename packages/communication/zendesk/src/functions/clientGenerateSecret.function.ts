...
export const ClientGenerateSecretInput = z.object({
  oauth_client_id: z.number().int().describe("The ID of the OAuth client. Example: 223443"),
})

export const ClientGenerateSecretOutput = z.object({
  client: z.object({
...
export const clientGenerateSecret = pikkuSessionlessFunc({
  description: "#### Allowed for\n * Admins",
  input: ClientGenerateSecretInput,
  output: ClientGenerateSecretOutput,
  func: async ({ zendesk }, data) => {
    return zendesk.call("PUT", "/api/v2/oauth/clients/{oauth_client_id}/generate_secret", data) as any
  },
})
