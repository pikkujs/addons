...
export const UpdateCustomObjectInput = z.object({
  custom_object_key: z.string().describe("The key of a custom object. Example: \"car\""),
})

export const UpdateCustomObjectOutput = z.object({
...
export const updateCustomObject = pikkuSessionlessFunc({
  ...
  output: UpdateCustomObjectOutput,
  func: async ({ zendesk }, data) => {
    return zendesk.call("PATCH", "/api/v2/custom_objects/{custom_object_key}", data) as any
  },
})
