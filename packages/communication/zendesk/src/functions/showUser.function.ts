...
export const ShowUserInput = z.object({
...
export const ShowUserOutput = z.object({
...
export const showUser = pikkuSessionlessFunc({
  description: "#### Allowed For\n\n* Agents",
  input: ShowUserInput,
  output: ShowUserOutput,
  func: async ({ zendesk }, data) => {
    return zendesk.call("GET", "/api/v2/users/{user_id}", data) as any
  },
})
