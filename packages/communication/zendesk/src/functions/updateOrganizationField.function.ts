...
export const UpdateOrganizationFieldInput = z.object({
...
export const UpdateOrganizationFieldOutput = z.object({
...
export const updateOrganizationField = pikkuSessionlessFunc({
  ...
  input: UpdateOrganizationFieldInput,
  output: UpdateOrganizationFieldOutput,
  func: async ({ zendesk }, data) => {
    return zendesk.call("PUT", "/api/v2/organization_fields/{organization_field_id}", data) as any
  },
})
