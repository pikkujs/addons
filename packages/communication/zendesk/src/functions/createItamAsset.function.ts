...
export const CreateItamAssetInput = z.object({
  asset: z.object({
...
export const CreateItamAssetOutput = z.object({
  asset: z.object({
    asset_tag: z.string().nullable().optional().describe("The tag for the asset"),
    asset_type_id: z.string().describe("Id of the asset type"),
    created_at: z.string().datetime().optional().describe("The time the asset record was added"),
...
export const createItamAsset = pikkuSessionlessFunc({
  description: "Creates an asset.\n\n#### Allowed For\n\n* Admins",
  input: CreateItamAssetInput,
  output: CreateItamAssetOutput,
  func: async ({ zendesk }, data) => {
    return zendesk.call("POST", "/api/v2/it_asset_management/assets", data) as any
  },
})
