...
export const CreateBrandOutput = z.object({
  brand: z.object({
    active: z.boolean().optional().describe("If the brand is set as active"),
    brand_url: z.string().optional().describe("The url of the brand"),
    created_at: z.string().datetime().optional().describe("The time the brand was created"),
...
export const createBrand = pikkuSessionlessFunc({
  description: "Creates a brand. To attach a logo, make a follow-up request to\n`PUT /api/v2/brands/{brand_id}/logo`.\n\n#### Allowed for\n- Admins",
  input: CreateBrandInput,
  output: CreateBrandOutput,
  func: async ({ zendesk }, data) => {
    return zendesk.call("POST", "/api/v2/brands", data) as any
  },
})
