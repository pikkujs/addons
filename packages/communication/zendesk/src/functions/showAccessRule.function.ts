...
export const ShowAccessRuleInput = z.object({
...
export const ShowAccessRuleOutput = z.object({
...
export const showAccessRule = pikkuSessionlessFunc({
  description: "Returns a specific access rule for a custom object.\n#### Allowed For\n* Admins",
  input: ShowAccessRuleInput,
  output: ShowAccessRuleOutput,
  func: async ({ zendesk }, data) => {
    return zendesk.call("GET", "/api/v2/custom_objects/{custom_object_key}/access_rules/{id}", data) as any
  },
})
