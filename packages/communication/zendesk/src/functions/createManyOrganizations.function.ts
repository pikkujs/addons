...
export const CreateManyOrganizationsOutput = z.object({
  job_status: z.object({
...
export const createManyOrganizations = pikkuSessionlessFunc({
  ...
  output: CreateManyOrganizationsOutput,
  func: async ({ zendesk }) => {
    return zendesk.call("POST", "/api/v2/organizations/create_many") as any
  },
})
