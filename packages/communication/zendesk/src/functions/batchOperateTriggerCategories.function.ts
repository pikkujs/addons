...
export const BatchOperateTriggerCategoriesInput = z.object({
  job: z.object({
...
export const BatchOperateTriggerCategoriesOutput = z.object({
...
export const batchOperateTriggerCategories = pikkuSessionlessFunc({
  description: "Creates a job that performs a batch operation for the given ticket trigger categories.",
  input: BatchOperateTriggerCategoriesInput,
  output: BatchOperateTriggerCategoriesOutput,
  errors: [BadRequestError],
  func: async ({ zendesk }, data) => {
    return zendesk.call("POST", "/api/v2/trigger_categories/jobs", data) as any
  },
})
