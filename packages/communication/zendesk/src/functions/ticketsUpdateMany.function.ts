...
export const TicketsUpdateManyInput = z.any()

export const TicketsUpdateManyOutput = z.object({
  job_status: z.object({
...
export const ticketsUpdateMany = pikkuSessionlessFunc({
  description: "Accepts an array of up to 100 ticket objects, or a comma-separated list of up to 100 ticket ids.",
  input: TicketsUpdateManyInput,
  output: TicketsUpdateManyOutput,
  func: async ({ zendesk }, data) => {
    return zendesk.call("PUT", "/api/v2/tickets/update_many", data) as any
  },
})
