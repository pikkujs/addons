...
export const GetObjectTriggerInput = z.object({
...
export const GetObjectTriggerOutput = z.object({
  trigger: z.object({
...
export const getObjectTrigger = pikkuSessionlessFunc({
  description: "Returns details of a specific object trigger.\n#### Allowed For\n\n* Agents",
  input: GetObjectTriggerInput,
  output: GetObjectTriggerOutput,
  func: async ({ zendesk }, data) => {
    return zendesk.call("GET", "/api/v2/custom_objects/{custom_object_key}/triggers/{trigger_id}", data) as any
  },
})
