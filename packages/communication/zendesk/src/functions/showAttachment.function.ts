...
export const ShowAttachmentInput = z.object({
  attachment_id: z.number().int().describe("The ID of the attachment. Example: 498483"),
})

export const ShowAttachmentOutput = z.object({
  attachment: z.object({
...
export const showAttachment = pikkuSessionlessFunc({
  ...
  input: ShowAttachmentInput,
  output: ShowAttachmentOutput,
  func: async ({ zendesk }, data) => {
    return zendesk.call("GET", "/api/v2/attachments/{attachment_id}", data) as any
  },
})
