...
export const UsergroupsEnableInput = z.object({
  ...
  usergroup: z.string().describe("The encoded ID of the User Group to enable."),
})

export const UsergroupsEnableOutput = z.object({
  ok: z.literal(true),
  usergroup: z.object({
...
}).describe("Schema for successful response from usergroups.enable method")

export const usergroupsEnable = pikkuSessionlessFunc({
  description: "Enable a User Group",
  input: UsergroupsEnableInput,
  output: UsergroupsEnableOutput,
  func: async ({ slack }, data) => {
    return slack.call("POST", "/usergroups.enable", data) as any
  },
})
