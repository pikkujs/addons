...
export const AdminAppsRequestsListInput = z.object({
...
export const AdminAppsRequestsListOutput = z.object({
  ok: z.literal(true),
}).describe("This method either only returns a brief _OK_ response or a verbose schema is not available for this method.")

export const adminAppsRequestsList = pikkuSessionlessFunc({
  description: "List app requests for a team/workspace.",
  input: AdminAppsRequestsListInput,
  output: AdminAppsRequestsListOutput,
  func: async ({ slack }, data) => {
    return slack.call("GET", "/admin.apps.requests.list", data) as any
  },
})
