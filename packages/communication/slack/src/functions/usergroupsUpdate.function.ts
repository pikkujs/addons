...
export const UsergroupsUpdateInput = z.object({
  ...
  name: z.string().optional().describe("A name for the User Group. Must be unique among User Groups."),
  usergroup: z.string().describe("The encoded ID of the User Group to update."),
})

export const UsergroupsUpdateOutput = z.object({
  ok: z.literal(true),
  usergroup: z.object({
...
}).describe("Schema for successful response from usergroups.update method")

export const usergroupsUpdate = pikkuSessionlessFunc({
  description: "Update an existing User Group",
  input: UsergroupsUpdateInput,
  output: UsergroupsUpdateOutput,
  func: async ({ slack }, data) => {
    return slack.call("POST", "/usergroups.update", data) as any
  },
})
