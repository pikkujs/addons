...
export const UpdatePostsPatchInput = z.object({
...
export const UpdatePostsPatchOutput = z.object({
...
export const updatePostsPatch = pikkuSessionlessFunc({
  ...
  input: UpdatePostsPatchInput,
  output: UpdatePostsPatchOutput,
  errors: [BadRequestError, UnauthorizedError, ForbiddenError],
  func: async ({ mattermost }, data) => {
    return mattermost.call("PUT", "/posts/{post_id}/patch", data) as any
  },
})
