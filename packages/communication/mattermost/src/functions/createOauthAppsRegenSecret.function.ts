...
export const CreateOauthAppsRegenSecretInput = z.object({
  app_id: z.string().describe("Application client id"),
})

export const CreateOauthAppsRegenSecretOutput = z.object({
...
export const createOauthAppsRegenSecret = pikkuSessionlessFunc({
  ...
  input: CreateOauthAppsRegenSecretInput,
  output: CreateOauthAppsRegenSecretOutput,
  errors: [BadRequestError, UnauthorizedError, ForbiddenError, NotFoundError],
  func: async ({ mattermost }, data) => {
    return mattermost.call("POST", "/oauth/apps/{app_id}/regen_secret", data) as any
  },
})
