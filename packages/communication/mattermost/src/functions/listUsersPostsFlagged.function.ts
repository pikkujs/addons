...
export const ListUsersPostsFlaggedInput = z.object({
...
export const ListUsersPostsFlaggedOutput = z.array(z.object({
...
export const listUsersPostsFlagged = pikkuSessionlessFunc({
  ...
  input: ListUsersPostsFlaggedInput,
  output: ListUsersPostsFlaggedOutput,
  errors: [BadRequestError, UnauthorizedError, ForbiddenError],
  func: async ({ mattermost }, data) => {
    return mattermost.call("GET", "/users/{user_id}/posts/flagged", data) as any
  },
})
