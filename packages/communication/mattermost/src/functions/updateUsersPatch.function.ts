...
export const UpdateUsersPatchInput = z.object({
...
export const UpdateUsersPatchOutput = z.object({
...
export const updateUsersPatch = pikkuSessionlessFunc({
  ...
  input: UpdateUsersPatchInput,
  output: UpdateUsersPatchOutput,
  errors: [BadRequestError, UnauthorizedError, ForbiddenError],
  func: async ({ mattermost }, data) => {
    return mattermost.call("PUT", "/users/{user_id}/patch", data) as any
  },
})
