...
export const ListTeamsChannelsInput = z.object({
...
export const ListTeamsChannelsOutput = z.array(z.object({
...
export const listTeamsChannels = pikkuSessionlessFunc({
  ...
  output: ListTeamsChannelsOutput,
  errors: [BadRequestError, UnauthorizedError, ForbiddenError, NotFoundError],
  func: async ({ mattermost }, data) => {
    return mattermost.call("GET", "/teams/{team_id}/channels", data) as any
  },
})
