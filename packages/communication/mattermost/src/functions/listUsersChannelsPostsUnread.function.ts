...
export const ListUsersChannelsPostsUnreadInput = z.object({
  user_id: z.string().describe("ID of the user"),
  channel_id: z.string().describe("The channel ID to get the posts for"),
  limit_before: z.string().optional().default("60").describe("Number of posts before the last unread posts"),
  limit_after: z.string().optional().default("60").describe("Number of posts after and including the last unread post"),
})

export const ListUsersChannelsPostsUnreadOutput = z.object({
...
export const listUsersChannelsPostsUnread = pikkuSessionlessFunc({
  ...
  input: ListUsersChannelsPostsUnreadInput,
  output: ListUsersChannelsPostsUnreadOutput,
  errors: [BadRequestError, UnauthorizedError, ForbiddenError],
  func: async ({ mattermost }, data) => {
    return mattermost.call("GET", "/users/{user_id}/channels/{channel_id}/posts/unread", data) as any
  },
})
