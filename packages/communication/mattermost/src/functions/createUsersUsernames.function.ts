...
export const CreateUsersUsernamesInput = z.object({
  body: z.array(z.string()),
})

export const CreateUsersUsernamesOutput = z.array(z.object({
...
export const createUsersUsernames = pikkuSessionlessFunc({
  description: "Get a list of users based on a provided list of usernames.\n##### Permissions\nRequires an active session but no other permissions.",
  input: CreateUsersUsernamesInput,
  output: CreateUsersUsernamesOutput,
  errors: [BadRequestError, UnauthorizedError],
  func: async ({ mattermost }, data) => {
    return mattermost.call("POST", "/users/usernames", data) as any
  },
})
