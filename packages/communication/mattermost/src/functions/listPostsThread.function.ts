...
export const ListPostsThreadInput = z.object({
  post_id: z.string().describe("ID of a post in the thread"),
})

export const ListPostsThreadOutput = z.object({
...
export const listPostsThread = pikkuSessionlessFunc({
  ...
  input: ListPostsThreadInput,
  output: ListPostsThreadOutput,
  errors: [BadRequestError, UnauthorizedError, ForbiddenError],
  func: async ({ mattermost }, data) => {
    return mattermost.call("GET", "/posts/{post_id}/thread", data) as any
  },
})
