...
export const CreateUsersInput = z.object({
  t: z.string().optional().describe("Token id from an email invitation"),
  iid: z.string().optional().describe("Token id from an invitation link"),
  email: z.string(),
  username: z.string(),
  first_name: z.string().optional(),
  last_name: z.string().optional(),
  nickname: z.string().optional(),
  auth_data: z.string().optional().describe("Service-specific authentication data, such as email address."),
  auth_service: z.string().optional().describe("The authentication service, one of \"email\", \"gitlab\", \"ldap\", \"saml\", \"office365\", \"google\", and \"\"."),
...
export const CreateUsersOutput = z.object({
...
export const createUsers = pikkuSessionlessFunc({
  ...
  func: async ({ mattermost }, data) => {
    return mattermost.call("POST", "/users", data) as any
  },
})
