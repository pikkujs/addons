...
export const GetRolesNameOutput = z.object({
...
export const getRolesName = pikkuSessionlessFunc({
  description: "Get a role from the provided role name.\n\n##### Permissions\nRequires an active session but no other permissions.\n\n__Minimum server version__: 4.9",
  input: GetRolesNameInput,
  output: GetRolesNameOutput,
  errors: [UnauthorizedError, NotFoundError],
  func: async ({ mattermost }, data) => {
    return mattermost.call("GET", "/roles/name/{role_name}", data) as any
  },
})
