...
export const ListChannelsPinnedInput = z.object({
  channel_id: z.string().describe("Channel GUID"),
})

export const ListChannelsPinnedOutput = z.object({
...
export const listChannelsPinned = pikkuSessionlessFunc({
  description: "Get a list of pinned posts for channel.",
  input: ListChannelsPinnedInput,
  output: ListChannelsPinnedOutput,
  errors: [BadRequestError, UnauthorizedError, ForbiddenError],
  func: async ({ mattermost }, data) => {
    return mattermost.call("GET", "/channels/{channel_id}/pinned", data) as any
  },
})
