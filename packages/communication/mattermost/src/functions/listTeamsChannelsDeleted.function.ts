...
export const ListTeamsChannelsDeletedInput = z.object({
  team_id: z.string().describe("Team GUID"),
  page: z.string().optional().default("0").describe("The page to select."),
  per_page: z.string().optional().default("60").describe("The number of public channels per page."),
})

export const ListTeamsChannelsDeletedOutput = z.array(z.object({
...
export const listTeamsChannelsDeleted = pikkuSessionlessFunc({
  ...
  input: ListTeamsChannelsDeletedInput,
  output: ListTeamsChannelsDeletedOutput,
  errors: [BadRequestError, UnauthorizedError, ForbiddenError, NotFoundError],
  func: async ({ mattermost }, data) => {
    return mattermost.call("GET", "/teams/{team_id}/channels/deleted", data) as any
  },
})
