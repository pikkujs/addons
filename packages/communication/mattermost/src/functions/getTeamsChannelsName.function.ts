...
export const GetTeamsChannelsNameOutput = z.object({
...
export const getTeamsChannelsName = pikkuSessionlessFunc({
  description: "Gets channel from the provided team id and channel name strings.\n##### Permissions\n`read_channel` permission for the channel.",
  input: GetTeamsChannelsNameInput,
  output: GetTeamsChannelsNameOutput,
  errors: [UnauthorizedError, ForbiddenError, NotFoundError],
  func: async ({ mattermost }, data) => {
    return mattermost.call("GET", "/teams/{team_id}/channels/name/{channel_name}", data) as any
  },
})
