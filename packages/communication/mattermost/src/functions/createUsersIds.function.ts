...
export const CreateUsersIdsInput = z.object({
  body: z.array(z.string()),
})

export const CreateUsersIdsOutput = z.array(z.object({
...
export const createUsersIds = pikkuSessionlessFunc({
  description: "Get a list of users based on a provided list of user ids.\n##### Permissions\nRequires an active session but no other permissions.",
  input: CreateUsersIdsInput,
  output: CreateUsersIdsOutput,
  errors: [BadRequestError, UnauthorizedError],
  func: async ({ mattermost }, data) => {
    return mattermost.call("POST", "/users/ids", data) as any
  },
})
