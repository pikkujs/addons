...
export const CreateUsersGroupChannelsInput = z.object({
  body: z.array(z.string()),
})

export const CreateUsersGroupChannelsOutput = z.object({
  "<CHANNEL_ID>": z.array(z.object({
...
export const createUsersGroupChannels = pikkuSessionlessFunc({
  ...
  input: CreateUsersGroupChannelsInput,
  output: CreateUsersGroupChannelsOutput,
  errors: [BadRequestError, UnauthorizedError],
  func: async ({ mattermost }, data) => {
    return mattermost.call("POST", "/users/group_channels", data) as any
  },
})
