...
export const UpdateChannelInput = z.object({
  ...
  id: z.string().describe("The channel's id, not updatable"),
  ...
  type: z.string().optional().describe("'O' for a public channel, 'P' for a private channel"),
})

export const UpdateChannelOutput = z.object({
...
export const updateChannel = pikkuSessionlessFunc({
  ...
  func: async ({ mattermost }, data) => {
    return mattermost.call("PUT", "/channels/{channel_id}", data) as any
  },
})
