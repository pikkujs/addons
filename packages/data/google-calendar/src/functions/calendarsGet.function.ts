...
export const CalendarsGetInput = z.object({
...
export const CalendarsGetOutput = z.object({
...
export const calendarsGet = pikkuSessionlessFunc({
  description: "Returns metadata for a calendar.",
  input: CalendarsGetInput,
  output: CalendarsGetOutput,
  func: async ({ googleCalendar }, data) => {
    return googleCalendar.call("GET", "/calendars/{calendarId}", data) as any
  },
})
