...
export const DeveloperMetadataSearchInput = z.object({
...
})).optional().describe("The data filters describing the criteria used to determine which DeveloperMetadata entries to return. DeveloperMetadata matching any of the specified filters are included in the response."),
})

export const DeveloperMetadataSearchOutput = z.object({
  matchedDeveloperMetadata: z.array(z.object({
    ...
    })).optional().describe("All filters matching the returned developer metadata."),
    ...
    }).optional().describe("The developer metadata matching the specified filters."),
  })).optional().describe("The metadata matching the criteria of the search request."),
}).describe("A reply to a developer metadata search request.")

export const developerMetadataSearch = pikkuSessionlessFunc({
  ...
  input: DeveloperMetadataSearchInput,
  output: DeveloperMetadataSearchOutput,
  func: async ({ googleSheets }, data) => {
    return googleSheets.call("POST", "/v4/spreadsheets/{spreadsheetId}/developerMetadata:search", data) as any
  },
})
