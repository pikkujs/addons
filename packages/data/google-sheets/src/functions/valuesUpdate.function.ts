...
export const ValuesUpdateInput = z.object({
  spreadsheetId: z.string().describe("The ID of the spreadsheet to update."),
  range: z.string().describe("The [A1 notation](/sheets/api/guides/concepts#cell) of the values to update."),
...
export const ValuesUpdateOutput = z.object({
...
export const valuesUpdate = pikkuSessionlessFunc({
  ...
  output: ValuesUpdateOutput,
  func: async ({ googleSheets }, data) => {
    return googleSheets.call("PUT", "/v4/spreadsheets/{spreadsheetId}/values/{range}", data) as any
  },
})
