...
export const DrivesUnhideInput = z.object({
...
export const DrivesUnhideOutput = z.object({
...
export const drivesUnhide = pikkuSessionlessFunc({
  description: "Restores a shared drive to the default view.",
  input: DrivesUnhideInput,
  output: DrivesUnhideOutput,
  func: async ({ googleDrive }, data) => {
    return googleDrive.call("POST", "/drives/{driveId}/unhide", data) as any
  },
})
