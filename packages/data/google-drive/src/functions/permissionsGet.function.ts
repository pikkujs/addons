...
export const PermissionsGetInput = z.object({
...
export const PermissionsGetOutput = z.object({
...
export const permissionsGet = pikkuSessionlessFunc({
  description: "Gets a permission by ID.",
  input: PermissionsGetInput,
  output: PermissionsGetOutput,
  func: async ({ googleDrive }, data) => {
    return googleDrive.call("GET", "/files/{fileId}/permissions/{permissionId}", data) as any
  },
})
