...
export const RepliesDeleteInput = z.object({
...
export const repliesDelete = pikkuSessionlessFunc({
  description: "Deletes a reply.",
  input: RepliesDeleteInput,
  func: async ({ googleDrive }, data) => {
    return googleDrive.call("DELETE", "/files/{fileId}/comments/{commentId}/replies/{replyId}", data)
  },
})
