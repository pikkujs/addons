...
export const RevisionsDeleteInput = z.object({
...
export const revisionsDelete = pikkuSessionlessFunc({
  ...
  input: RevisionsDeleteInput,
  func: async ({ googleDrive }, data) => {
    return googleDrive.call("DELETE", "/files/{fileId}/revisions/{revisionId}", data)
  },
})
