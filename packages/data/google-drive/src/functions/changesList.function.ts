...
export const ChangesListInput = z.object({
...
export const ChangesListOutput = z.object({
  changes: z.array(z.object({
    changeType: z.string().optional().describe("The type of the change. Possible values are file and drive."),
    drive: z.object({
    ...
    }).optional().describe("The updated state of the shared drive. Present if the changeType is drive, the user is still a member of the shared drive, and the shared drive has not been deleted."),
    driveId: z.string().optional().describe("The ID of the shared drive associated with this change."),
    file: z.object({
    ...
    }).optional().describe("The updated state of the file. Present if the type is file and the file has not been removed from this list of changes."),
    fileId: z.string().optional().describe("The ID of the file which has changed."),
    kind: z.string().optional().default("drive#change").describe("Identifies what kind of resource this is. Value: the fixed string \"drive#change\"."),
    removed: z.boolean().optional().describe("Whether the file or shared drive has been removed from this list of changes, for example by deletion or loss of access."),
    teamDrive: z.object({
      backgroundImageFile: z.object({
    ...
    }).optional().describe("Deprecated - use drive instead."),
    teamDriveId: z.string().optional().describe("Deprecated - use driveId instead."),
    time: z.string().datetime().optional().describe("The time of this change (RFC 3339 date-time)."),
    type: z.string().optional().describe("Deprecated - use changeType instead."),
  })).optional().describe("The list of changes. If nextPageToken is populated, then this list may be incomplete and an additional page of results should be fetched."),
  kind: z.string().optional().default("drive#changeList").describe("Identifies what kind of resource this is. Value: the fixed string \"drive#changeList\"."),
  newStartPageToken: z.string().optional().describe("The starting page token for future changes. This will be present only if the end of the current changes list has been reached."),
  nextPageToken: z.string().optional().describe("The page token for the next page of changes. This will be absent if the end of the changes list has been reached. If the token is rejected for any reason, it should be discarded, and pagination should be restarted from the first page of results."),
}).describe("A list of changes for a user.")

export const changesList = pikkuSessionlessFunc({
  description: "Lists the changes for a user or shared drive.",
  input: ChangesListInput,
  output: ChangesListOutput,
  func: async ({ googleDrive }, data) => {
    return googleDrive.call("GET", "/changes", data) as any
  },
})
