...
export const CommentsGetInput = z.object({
  ...
  includeDeleted: z.boolean().optional().describe("Whether to return deleted comments. Deleted comments will not include their original content."),
})

export const CommentsGetOutput = z.object({
...
export const commentsGet = pikkuSessionlessFunc({
  description: "Gets a comment by ID.",
  input: CommentsGetInput,
  output: CommentsGetOutput,
  func: async ({ googleDrive }, data) => {
    return googleDrive.call("GET", "/files/{fileId}/comments/{commentId}", data) as any
  },
})
