...
export const DrivesGetInput = z.object({
...
export const DrivesGetOutput = z.object({
...
export const drivesGet = pikkuSessionlessFunc({
  description: "Gets a shared drive's metadata by ID.",
  input: DrivesGetInput,
  output: DrivesGetOutput,
  func: async ({ googleDrive }, data) => {
    return googleDrive.call("GET", "/drives/{driveId}", data) as any
  },
})
