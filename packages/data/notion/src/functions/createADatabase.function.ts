...
export const CreateADatabaseInput = z.object({
...
}).describe("An object specifying the parent of the new data source to be created."),
  properties: z.record(z.string(), z.object({
  description: z.union([z.string(), z.unknown()]).optional().describe("The description of the property."),
})).describe("Property schema of data source."),
...
export const CreateADatabaseOutput = z.union([z.object({
...
export const createADatabase = pikkuSessionlessFunc({
  description: "Create a data source",
  input: CreateADatabaseInput,
  output: CreateADatabaseOutput,
  ...
  func: async ({ notion }, data) => {
    return notion.call("POST", "/v1/data_sources", data) as any
  },
})
