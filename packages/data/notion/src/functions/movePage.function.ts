...
export const MovePageInput = z.object({
  page_id: z.string().describe("The ID of the page to move."),
  ...
  page_id: z.string().describe("The ID of the parent page (with or without dashes), for example, 195de9221179449fab8075a27c979105"),
  type: z.string().optional().describe("Always `page_id`"),
}), z.object({
  data_source_id: z.string().describe("The ID of the parent data source (collection), with or without dashes. For example, f336d0bc-b841-465b-8045-024475c079dd"),
  type: z.string().optional().describe("Always `data_source_id`"),
})]).describe("The new parent of the page."),
})

export const MovePageOutput = z.union([z.object({
...
export const movePage = pikkuSessionlessFunc({
  description: "Move a page",
  input: MovePageInput,
  output: MovePageOutput,
  ...
  func: async ({ notion }, data) => {
    return notion.call("POST", "/v1/pages/{page_id}/move", data) as any
  },
})
