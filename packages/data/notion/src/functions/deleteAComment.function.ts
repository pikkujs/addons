...
export const DeleteACommentInput = z.object({
...
export const DeleteACommentOutput = z.union([z.object({
...
export const deleteAComment = pikkuSessionlessFunc({
  description: "Delete a comment",
  input: DeleteACommentInput,
  output: DeleteACommentOutput,
  ...
  func: async ({ notion }, data) => {
    return notion.call("DELETE", "/v1/comments/{comment_id}", data) as any
  },
})
