...
export const CompleteFileUploadInput = z.object({
...
export const CompleteFileUploadOutput = z.object({
...
export const completeFileUpload = pikkuSessionlessFunc({
  description: "Complete a multi-part file upload",
  input: CompleteFileUploadInput,
  output: CompleteFileUploadOutput,
  ...
  func: async ({ notion }, data) => {
    return notion.call("POST", "/v1/file_uploads/{file_upload_id}/complete", data) as any
  },
})
